...
public class Registries {
    ...
    public static final ResourceKey<IRegistry<DataComponentPredicate.b<?>>> DATA_COMPONENT_PREDICATE_TYPE = createRegistryKey("data_component_predicate_type");
    ...
    public static final ResourceKey<IRegistry<MapCodec<? extends SpawnCondition>>> SPAWN_CONDITION_TYPE = createRegistryKey("spawn_condition_type");
    ...
    public static final ResourceKey<IRegistry<MapCodec<? extends TestEnvironmentDefinition>>> TEST_ENVIRONMENT_DEFINITION_TYPE = createRegistryKey("test_environment_definition_type");
    public static final ResourceKey<IRegistry<Consumer<GameTestHarnessHelper>>> TEST_FUNCTION = createRegistryKey("test_function");
    public static final ResourceKey<IRegistry<MapCodec<? extends GameTestInstance>>> TEST_INSTANCE_TYPE = createRegistryKey("test_instance_type");
    public static final ResourceKey<IRegistry<TicketType>> TICKET_TYPE = createRegistryKey("ticket_type");
    ...
    public static final ResourceKey<IRegistry<ChickenVariant>> CHICKEN_VARIANT = createRegistryKey("chicken_variant");
    ...
    public static final ResourceKey<IRegistry<CowVariant>> COW_VARIANT = createRegistryKey("cow_variant");
    ...
    public static final ResourceKey<IRegistry<PigVariant>> PIG_VARIANT = createRegistryKey("pig_variant");
    ...
    public static final ResourceKey<IRegistry<TestEnvironmentDefinition>> TEST_ENVIRONMENT = createRegistryKey("test_environment");
    public static final ResourceKey<IRegistry<GameTestInstance>> TEST_INSTANCE = createRegistryKey("test_instance");
    ...
    public static final ResourceKey<IRegistry<WolfSoundVariant>> WOLF_SOUND_VARIANT = createRegistryKey("wolf_sound_variant");
