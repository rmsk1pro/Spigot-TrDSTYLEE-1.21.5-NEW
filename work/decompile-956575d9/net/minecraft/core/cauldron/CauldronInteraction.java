...
public interface CauldronInteraction {
    ...
    static CauldronInteraction.a newInteractionMap(String s) {
        ...
        object2objectopenhashmap.defaultReturnValue((CauldronInteraction) (iblockdata, world, blockposition, entityhuman, enumhand, itemstack) -> {
    ...
    static void bootStrap() {
        ...
        map.put(Items.POTION, (CauldronInteraction) (iblockdata, world, blockposition, entityhuman, enumhand, itemstack) -> {
        ...
        map1.put(Items.BUCKET, (CauldronInteraction) (iblockdata, world, blockposition, entityhuman, enumhand, itemstack) -> {
        ...
        map1.put(Items.POTION, (CauldronInteraction) (iblockdata, world, blockposition, entityhuman, enumhand, itemstack) -> {
        ...
        map2.put(Items.BUCKET, (CauldronInteraction) (iblockdata, world, blockposition, entityhuman, enumhand, itemstack) -> {
        ...
        map3.put(Items.BUCKET, (CauldronInteraction) (iblockdata, world, blockposition, entityhuman, enumhand, itemstack) -> {
