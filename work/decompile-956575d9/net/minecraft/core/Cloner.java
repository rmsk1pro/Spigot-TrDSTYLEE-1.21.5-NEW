...
public class Cloner<T> {
    ...
    public T clone(T t0, HolderLookup.a holderlookup_a, HolderLookup.a holderlookup_a1) {
        DynamicOps<Object> dynamicops = holderlookup_a.<Object>createSerializationContext(JavaOps.INSTANCE);
        DynamicOps<Object> dynamicops1 = holderlookup_a1.<Object>createSerializationContext(JavaOps.INSTANCE);
