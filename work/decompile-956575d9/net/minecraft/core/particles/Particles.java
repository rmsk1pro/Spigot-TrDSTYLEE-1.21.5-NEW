...
public class Particles {
    ...
    public static final ParticleType PALE_OAK_LEAVES = register("pale_oak_leaves", false);
    public static final Particle<ColorParticleOption> TINTED_LEAVES = register("tinted_leaves", false, ColorParticleOption::codec, ColorParticleOption::streamCodec);
    ...
    public static final Particle<TrailParticleOption> TRAIL = register("trail", false, (particle) -> {
    ...
    public static final Particle<ParticleParamBlock> DUST_PILLAR = register("dust_pillar", false, ParticleParamBlock::codec, ParticleParamBlock::streamCodec);
    ...
    public static final Particle<ParticleParamBlock> BLOCK_CRUMBLE = register("block_crumble", false, ParticleParamBlock::codec, ParticleParamBlock::streamCodec);
    public static final ParticleType FIREFLY = register("firefly", false);
