...
public class NonNullList<E> extends AbstractList<E> {
    ...
    public static <E> NonNullList<E> createWithCapacity(int i) {
        return new NonNullList<E>(Lists.newArrayListWithCapacity(i), (Object) null);
    }
    ...
    public static <E> NonNullList<E> withSize(int i, E e0) {
        ...
        return new NonNullList<E>(Arrays.asList(aobject), e0);
    }

    @SafeVarargs
    public static <E> NonNullList<E> of(E e0, E... ae) {
        return new NonNullList<E>(Arrays.asList(ae), e0);
    }
