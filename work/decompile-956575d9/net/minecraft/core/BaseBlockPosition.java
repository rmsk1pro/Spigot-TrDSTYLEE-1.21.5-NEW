...
public class BaseBlockPosition implements Comparable<BaseBlockPosition> {
    ...
    public static Codec<BaseBlockPosition> offsetCodec(int i) {
        return BaseBlockPosition.CODEC.validate((baseblockposition) -> {
    ...
    public int distChessboard(BaseBlockPosition baseblockposition) {
        int i = Math.abs(this.getX() - baseblockposition.getX());
        int j = Math.abs(this.getY() - baseblockposition.getY());
        int k = Math.abs(this.getZ() - baseblockposition.getZ());
