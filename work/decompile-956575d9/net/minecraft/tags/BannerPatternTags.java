...
public class BannerPatternTags {
    ...
    public static final TagKey<EnumBannerPatternType> PATTERN_ITEM_FLOW = create("pattern_item/flow");
    public static final TagKey<EnumBannerPatternType> PATTERN_ITEM_GUSTER = create("pattern_item/guster");
    public static final TagKey<EnumBannerPatternType> PATTERN_ITEM_FIELD_MASONED = create("pattern_item/field_masoned");
    public static final TagKey<EnumBannerPatternType> PATTERN_ITEM_BORDURE_INDENTED = create("pattern_item/bordure_indented");

    private BannerPatternTags() {}

    private static TagKey<EnumBannerPatternType> create(String s) {
        return TagKey.<EnumBannerPatternType>create(Registries.BANNER_PATTERN, MinecraftKey.withDefaultNamespace(s));
    }
}
