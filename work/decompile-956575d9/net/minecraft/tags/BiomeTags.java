...
public class BiomeTags {
    ...
    public static final TagKey<BiomeBase> HAS_TRIAL_CHAMBERS = create("has_structure/trial_chambers");
    ...
    public static final TagKey<BiomeBase> HAS_TRAIL_RUINS = create("has_structure/trail_ruins");
    ...
    public static final TagKey<BiomeBase> INCREASED_FIRE_BURNOUT = create("increased_fire_burnout");
    public static final TagKey<BiomeBase> SNOW_GOLEM_MELTS = create("snow_golem_melts");
    ...
    public static final TagKey<BiomeBase> SPAWNS_COLD_VARIANT_FARM_ANIMALS = create("spawns_cold_variant_farm_animals");
    public static final TagKey<BiomeBase> SPAWNS_WARM_VARIANT_FARM_ANIMALS = create("spawns_warm_variant_farm_animals");
    public static final TagKey<BiomeBase> SPAWNS_GOLD_RABBITS = create("spawns_gold_rabbits");
    public static final TagKey<BiomeBase> SPAWNS_WHITE_RABBITS = create("spawns_white_rabbits");
    ...
    public static final TagKey<BiomeBase> SPAWNS_SNOW_FOXES = create("spawns_snow_foxes");

    private BiomeTags() {}

    private static TagKey<BiomeBase> create(String s) {
        return TagKey.<BiomeBase>create(Registries.BIOME, MinecraftKey.withDefaultNamespace(s));
    }
}
