...
public interface TagsEntity {
    ...
    TagKey<EntityTypes<?>> BOAT = create("boat");
    TagKey<EntityTypes<?>> CAN_EQUIP_SADDLE = create("can_equip_saddle");
    TagKey<EntityTypes<?>> CAN_WEAR_HORSE_ARMOR = create("can_wear_horse_armor");

    private static TagKey<EntityTypes<?>> create(String s) {
        return TagKey.<EntityTypes<?>>create(Registries.ENTITY_TYPE, MinecraftKey.withDefaultNamespace(s));
    }
}
