...
public class ResourceLocationPattern {
    ...
    private ResourceLocationPattern(Optional<Pattern> optional, Optional<Pattern> optional1) {
        ...
        this.namespacePredicate = (Predicate) optional.map(Pattern::asPredicate).orElse((Predicate) (s) -> {
            return true;
        });
        this.pathPattern = optional1;
        this.pathPredicate = (Predicate) optional1.map(Pattern::asPredicate).orElse((Predicate) (s) -> {
            return true;
        });
