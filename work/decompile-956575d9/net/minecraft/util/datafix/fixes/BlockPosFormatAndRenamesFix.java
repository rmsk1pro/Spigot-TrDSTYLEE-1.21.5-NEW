...
public class BlockPosFormatAndRenamesFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        list.add(this.writeFixAndRead("BlockPos format for map frames", this.getInputSchema().getType(DataConverterTypes.SAVED_DATA_MAP_DATA), this.getOutputSchema().getType(DataConverterTypes.SAVED_DATA_MAP_DATA), (dynamic) -> {
