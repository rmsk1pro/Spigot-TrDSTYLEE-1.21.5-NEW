...
public class DataConverterRegistry {
    ...
    private static void addFixers(DataFixerBuilder datafixerbuilder) {
        ...
        datafixerbuilder.addFixer(new TextComponentStrictJsonFix(schema14));
        ...
        Schema schema83 = datafixerbuilder.addSchema(1925, V1925::new);
        ...
        Schema schema119 = datafixerbuilder.addSchema(2538, DataConverterRegistry.SAME_NAMESPACED);
        ...
        datafixerbuilder.addFixer(new NamespacedTypeRenameFix(schema122, "Nether biome rename", DataConverterTypes.BIOME, createRenamer("minecraft:nether", "minecraft:nether_wastes")));
        Schema schema123 = datafixerbuilder.addSchema(2553, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new NamespacedTypeRenameFix(schema123, "Biomes fix", DataConverterTypes.BIOME, createRenamer(DataConverterBiome.BIOMES)));
        ...
        datafixerbuilder.addFixer(DataConverterBlockRename.create(schema128, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
        ...
        datafixerbuilder.addFixer(DataConverterBlockRename.create(schema133, "Rename copper blocks suffixes", createRenamer(immutablemap1)));
        ...
        datafixerbuilder.addFixer(DataConverterBlockRename.create(schema135, "Renamed grimstone blocks to deepslate", createRenamer(immutablemap2)));
        Schema schema136 = datafixerbuilder.addSchema(2700, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(DataConverterBlockRename.create(schema136, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
        ...
        datafixerbuilder.addFixer(new NamespacedTypeRenameFix(schema147, "Caves and Cliffs biome renames", DataConverterTypes.BIOME, createRenamer(CavesAndCliffsRenames.RENAMES)));
        ...
        datafixerbuilder.addFixer(new NamespacedTypeRenameFix(schema150, "Remove Deep Warm Ocean", DataConverterTypes.BIOME, createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
        ...
        Schema schema164 = datafixerbuilder.addSchema(3090, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EntityFieldsRenameFix(schema164, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
        Schema schema165 = datafixerbuilder.addSchema(3093, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EntityGoatMissingStateFix(schema165));
        Schema schema166 = datafixerbuilder.addSchema(3094, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new GoatHornIdFix(schema166));
        Schema schema167 = datafixerbuilder.addSchema(3097, DataConverterRegistry.SAME_NAMESPACED);
        ...
        datafixerbuilder.addFixer(new VariantRenameFix(schema167, "Rename british shorthair", DataConverterTypes.ENTITY, "minecraft:cat", map));
        datafixerbuilder.addFixer(new CriteriaRenameFix(schema167, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", (s) -> {
            return (String) map.getOrDefault(s, s);
        }));
        Set set = Set.of("minecraft:unemployed", "minecraft:nitwit");

        Objects.requireNonNull(set);
        datafixerbuilder.addFixer(new PoiTypeRemoveFix(schema167, "Remove unpopulated villager PoI types", set::contains));
        Schema schema168 = datafixerbuilder.addSchema(3108, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new BlendingDataRemoveFromNetherEndFix(schema168));
        Schema schema169 = datafixerbuilder.addSchema(3201, DataConverterRegistry.SAME_NAMESPACED);
        ...
        datafixerbuilder.addFixer(new DataConverterAddChoices(schema170, "Added Hanging Sign", DataConverterTypes.BLOCK_ENTITY));
        Schema schema171 = datafixerbuilder.addSchema(3203, V3203::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema171, "Added Camel", DataConverterTypes.ENTITY));
        Schema schema172 = datafixerbuilder.addSchema(3204, V3204::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema172, "Added Chiseled Bookshelf", DataConverterTypes.BLOCK_ENTITY));
        Schema schema173 = datafixerbuilder.addSchema(3209, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new DataConverterFlattenSpawnEgg(schema173, false, "minecraft:pig_spawn_egg"));
        Schema schema174 = datafixerbuilder.addSchema(3214, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new OptionsAmbientOcclusionFix(schema174));
        Schema schema175 = datafixerbuilder.addSchema(3319, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new OptionsAccessibilityOnboardFix(schema175));
        Schema schema176 = datafixerbuilder.addSchema(3322, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EffectDurationFix(schema176));
        Schema schema177 = datafixerbuilder.addSchema(3325, V3325::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema177, "Added displays", DataConverterTypes.ENTITY));
        Schema schema178 = datafixerbuilder.addSchema(3326, V3326::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema178, "Added Sniffer", DataConverterTypes.ENTITY));
        Schema schema179 = datafixerbuilder.addSchema(3327, V3327::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema179, "Archaeology", DataConverterTypes.BLOCK_ENTITY));
        Schema schema180 = datafixerbuilder.addSchema(3328, V3328::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema180, "Added interaction", DataConverterTypes.ENTITY));
        Schema schema181 = datafixerbuilder.addSchema(3438, V3438::new);

        datafixerbuilder.addFixer(BlockEntityRenameFix.create(schema181, "Rename Suspicious Sand to Brushable Block", createRenamer("minecraft:suspicious_sand", "minecraft:brushable_block")));
        datafixerbuilder.addFixer(new EntityBrushableBlockFieldsRenameFix(schema181));
        datafixerbuilder.addFixer(DataConverterItemName.create(schema181, "Pottery shard renaming", createRenamer(ImmutableMap.of("minecraft:pottery_shard_archer", "minecraft:archer_pottery_shard", "minecraft:pottery_shard_prize", "minecraft:prize_pottery_shard", "minecraft:pottery_shard_arms_up", "minecraft:arms_up_pottery_shard", "minecraft:pottery_shard_skull", "minecraft:skull_pottery_shard"))));
        datafixerbuilder.addFixer(new DataConverterAddChoices(schema181, "Added calibrated sculk sensor", DataConverterTypes.BLOCK_ENTITY));
        Schema schema182 = datafixerbuilder.addSchema(3439, V3439::new);
        ...
        Schema schema183 = datafixerbuilder.addSchema(3440, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new NamespacedTypeRenameFix(schema183, "Replace experimental 1.20 overworld", DataConverterTypes.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, createRenamer("minecraft:overworld_update_1_20", "minecraft:overworld")));
        ...
        datafixerbuilder.addFixer(new DropInvalidSignDataFix(schema189, "minecraft:sign"));
        datafixerbuilder.addFixer(new DropInvalidSignDataFix(schema189, "minecraft:hanging_sign"));
        ...
        Schema schema205 = datafixerbuilder.addSchema(3808, 2, V3808_2::new);

        datafixerbuilder.addFixer(new HorseBodyArmorItemFix(schema205, "minecraft:trader_llama", "DecorItem", false));
        Schema schema206 = datafixerbuilder.addSchema(3809, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new ChestedHorsesInventoryZeroIndexingFix(schema206));
        Schema schema207 = datafixerbuilder.addSchema(3812, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new FixWolfHealth(schema207));
        Schema schema208 = datafixerbuilder.addSchema(3813, V3813::new);

        datafixerbuilder.addFixer(new BlockPosFormatAndRenamesFix(schema208));
        Schema schema209 = datafixerbuilder.addSchema(3814, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new DataConverterAttributes(schema209, "Rename jump strength attribute", createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
        Schema schema210 = datafixerbuilder.addSchema(3816, V3816::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema210, "Added Bogged", DataConverterTypes.ENTITY));
        ...
        Schema schema212 = datafixerbuilder.addSchema(3818, 1, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new BannerPatternFormatFix(schema212));
        Schema schema213 = datafixerbuilder.addSchema(3818, 2, DataConverterRegistry.SAME_NAMESPACED);
        ...
        datafixerbuilder.addFixer(new DataConverterShoulderEntity(schema214, "Inject data component types", DataConverterTypes.DATA_COMPONENTS));
        ...
        Schema schema217 = datafixerbuilder.addSchema(3818, 6, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new AreaEffectCloudPotionFix(schema217));
        Schema schema218 = datafixerbuilder.addSchema(3820, DataConverterRegistry.SAME_NAMESPACED);
        ...
        datafixerbuilder.addFixer(new DataConverterAddChoices(schema219, "Added Ominous Item Spawner", DataConverterTypes.ENTITY));
        Schema schema220 = datafixerbuilder.addSchema(3828, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EmptyItemInVillagerTradeFix(schema220));
        Schema schema221 = datafixerbuilder.addSchema(3833, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new RemoveEmptyItemInBrushableBlockFix(schema221));
        Schema schema222 = datafixerbuilder.addSchema(3938, V3938::new);

        datafixerbuilder.addFixer(new ProjectileStoredWeaponFix(schema222));
        Schema schema223 = datafixerbuilder.addSchema(3939, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new FeatureFlagRemoveFix(schema223, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
        Schema schema224 = datafixerbuilder.addSchema(3943, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new OptionsMenuBlurrinessFix(schema224));
        Schema schema225 = datafixerbuilder.addSchema(3945, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new AttributeModifierIdFix(schema225));
        datafixerbuilder.addFixer(new JukeboxTicksSinceSongStartedFix(schema225));
        Schema schema226 = datafixerbuilder.addSchema(4054, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new OminousBannerRarityFix(schema226));
        Schema schema227 = datafixerbuilder.addSchema(4055, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new AttributeIdPrefixFix(schema227));
        Schema schema228 = datafixerbuilder.addSchema(4057, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new CarvingStepRemoveFix(schema228));
        Schema schema229 = datafixerbuilder.addSchema(4059, V4059::new);

        datafixerbuilder.addFixer(new FoodToConsumableFix(schema229));
        Schema schema230 = datafixerbuilder.addSchema(4061, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new TrialSpawnerConfigInRegistryFix(schema230));
        Schema schema231 = datafixerbuilder.addSchema(4064, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new FireResistantToDamageResistantComponentFix(schema231));
        Schema schema232 = datafixerbuilder.addSchema(4067, V4067::new);

        datafixerbuilder.addFixer(new BoatSplitFix(schema232));
        datafixerbuilder.addFixer(new FeatureFlagRemoveFix(schema232, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
        Schema schema233 = datafixerbuilder.addSchema(4068, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new LockComponentPredicateFix(schema233));
        datafixerbuilder.addFixer(new ContainerBlockEntityLockPredicateFix(schema233));
        Schema schema234 = datafixerbuilder.addSchema(4070, V4070::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema234, "Added Pale Oak Boat and Pale Oak Chest Boat", DataConverterTypes.ENTITY));
        Schema schema235 = datafixerbuilder.addSchema(4071, V4071::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema235, "Added Creaking", DataConverterTypes.ENTITY));
        datafixerbuilder.addFixer(new DataConverterAddChoices(schema235, "Added Creaking Heart", DataConverterTypes.BLOCK_ENTITY));
        Schema schema236 = datafixerbuilder.addSchema(4081, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EntitySalmonSizeFix(schema236));
        Schema schema237 = datafixerbuilder.addSchema(4173, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EntityFieldsRenameFix(schema237, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
        Schema schema238 = datafixerbuilder.addSchema(4175, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EquippableAssetRenameFix(schema238));
        datafixerbuilder.addFixer(new CustomModelDataExpandFix(schema238));
        Schema schema239 = datafixerbuilder.addSchema(4176, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new InvalidBlockEntityLockFix(schema239));
        datafixerbuilder.addFixer(new InvalidLockComponentFix(schema239));
        Schema schema240 = datafixerbuilder.addSchema(4180, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new FeatureFlagRemoveFix(schema240, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
        Schema schema241 = datafixerbuilder.addSchema(4181, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema241, "minecraft:furnace"));
        datafixerbuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema241, "minecraft:smoker"));
        datafixerbuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema241, "minecraft:blast_furnace"));
        Schema schema242 = datafixerbuilder.addSchema(4187, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EntityAttributeBaseValueFix(schema242, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (d0) -> {
            return d0 == 48.0D ? 16.0D : d0;
        }));
        datafixerbuilder.addFixer(new EntityAttributeBaseValueFix(schema242, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (d0) -> {
            return d0 == 48.0D ? 16.0D : d0;
        }));
        datafixerbuilder.addFixer(new EntityAttributeBaseValueFix(schema242, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (d0) -> {
            return d0 == 48.0D ? 16.0D : d0;
        }));
        datafixerbuilder.addFixer(new EntityAttributeBaseValueFix(schema242, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (d0) -> {
            return d0 == 40.0D ? 16.0D : d0;
        }));
        datafixerbuilder.addFixer(new EntityAttributeBaseValueFix(schema242, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (d0) -> {
            return d0 == 16.0D ? 12.0D : d0;
        }));
        datafixerbuilder.addFixer(new EntityAttributeBaseValueFix(schema242, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (d0) -> {
            return d0 == 16.0D ? 24.0D : d0;
        }));
        Schema schema243 = datafixerbuilder.addSchema(4290, V4290::new);

        datafixerbuilder.addFixer(new UnflattenTextComponentFix(schema243));
        Schema schema244 = datafixerbuilder.addSchema(4291, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new LegacyHoverEventFix(schema244));
        datafixerbuilder.addFixer(new TextComponentStringifiedFlagsFix(schema244));
        Schema schema245 = datafixerbuilder.addSchema(4292, V4292::new);

        datafixerbuilder.addFixer(new TextComponentHoverAndClickEventFix(schema245));
        Schema schema246 = datafixerbuilder.addSchema(4293, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new DropChancesFormatFix(schema246));
        Schema schema247 = datafixerbuilder.addSchema(4294, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new BlockPropertyRenameAndFix(schema247, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", (s) -> {
            return s.equals("true") ? "awake" : "uprooted";
        }));
        Schema schema248 = datafixerbuilder.addSchema(4295, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new BlendingDataFix(schema248));
        Schema schema249 = datafixerbuilder.addSchema(4296, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new AreaEffectCloudDurationScaleFix(schema249));
        Schema schema250 = datafixerbuilder.addSchema(4297, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new ForcedChunkToTicketFix(schema250));
        Schema schema251 = datafixerbuilder.addSchema(4299, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EntitySpawnerItemVariantComponentFix(schema251));
        Schema schema252 = datafixerbuilder.addSchema(4300, V4300::new);

        datafixerbuilder.addFixer(new SaddleEquipmentSlotFix(schema252));
        Schema schema253 = datafixerbuilder.addSchema(4301, V4301::new);

        datafixerbuilder.addFixer(new EquipmentFormatFix(schema253));
        Schema schema254 = datafixerbuilder.addSchema(4302, V4302::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema254, "Added Test and Test Instance Block Entities", DataConverterTypes.BLOCK_ENTITY));
        Schema schema255 = datafixerbuilder.addSchema(4303, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema255, DataConverterTypes.ENTITY));
        datafixerbuilder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema255, DataConverterTypes.PLAYER));
        Schema schema256 = datafixerbuilder.addSchema(4305, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new BlockPropertyRenameAndFix(schema256, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", (s) -> {
            return s;
        }));
        Schema schema257 = datafixerbuilder.addSchema(4306, V4306::new);

        datafixerbuilder.addFixer(new ThrownPotionSplitFix(schema257));
        Schema schema258 = datafixerbuilder.addSchema(4307, V4307::new);

        datafixerbuilder.addFixer(new TooltipDisplayComponentFix(schema258));
        Schema schema259 = datafixerbuilder.addSchema(4309, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new RaidRenamesDataFix(schema259));
        datafixerbuilder.addFixer(new ChunkTicketUnpackPosFix(schema259));
        Schema schema260 = datafixerbuilder.addSchema(4311, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new DataConverterAdvancementBase(schema260, false, "Use lodestone category change", createRenamer("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")));
        Schema schema261 = datafixerbuilder.addSchema(4312, V4312::new);

        datafixerbuilder.addFixer(new PlayerEquipmentFix(schema261));
        Schema schema262 = datafixerbuilder.addSchema(4314, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new InlineBlockPosFormatFix(schema262));
    }
