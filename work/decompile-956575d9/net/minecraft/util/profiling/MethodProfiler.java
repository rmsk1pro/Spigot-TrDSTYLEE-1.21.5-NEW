...
public class MethodProfiler implements GameProfilerFillerActive {
    ...
    public MethodProfiler(LongSupplier longsupplier, IntSupplier intsupplier, BooleanSupplier booleansupplier) {
    ...
    public void pop() {
        if (!this.started) {
            ...
            if (k > MethodProfiler.WARNING_TIME_NANOS && !this.suppressWarnings.getAsBoolean()) {
