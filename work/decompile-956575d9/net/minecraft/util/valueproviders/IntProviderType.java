...
public interface IntProviderType<P extends IntProvider> {
    ...
    static <P extends IntProvider> IntProviderType<P> register(String s, MapCodec<P> mapcodec) {
        return (IntProviderType) IRegistry.register(BuiltInRegistries.INT_PROVIDER_TYPE, s, (IntProviderType) () -> {
            return mapcodec;
        });
    }
}
