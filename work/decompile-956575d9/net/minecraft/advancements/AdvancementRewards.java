...
public record AdvancementRewards(int experience, List<ResourceKey<LootTable>> loot, List<ResourceKey<IRecipe<?>>> recipes, Optional<CacheableFunction> function) {
    ...
    public static final Codec<AdvancementRewards> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(Codec.INT.optionalFieldOf("experience", 0).forGetter(AdvancementRewards::experience), LootTable.KEY_CODEC.listOf().optionalFieldOf("loot", List.of()).forGetter(AdvancementRewards::loot), IRecipe.KEY_CODEC.listOf().optionalFieldOf("recipes", List.of()).forGetter(AdvancementRewards::recipes), CacheableFunction.CODEC.optionalFieldOf("function").forGetter(AdvancementRewards::function)).apply(instance, AdvancementRewards::new);
    });
    ...
    public static class a {
        ...
        public static AdvancementRewards.a recipe(ResourceKey<IRecipe<?>> resourcekey) {
            return (new AdvancementRewards.a()).addRecipe(resourcekey);
        }

        public AdvancementRewards.a addRecipe(ResourceKey<IRecipe<?>> resourcekey) {
