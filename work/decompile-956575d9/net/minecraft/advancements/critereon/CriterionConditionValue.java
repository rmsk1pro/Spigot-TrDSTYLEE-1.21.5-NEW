...
public interface CriterionConditionValue<T extends Number> {
    ...
    static <B extends ByteBuf, T extends Number, R extends CriterionConditionValue<T>> StreamCodec<B, R> createStreamCodec(final StreamCodec<B, T> streamcodec, final CriterionConditionValue.a<T, R> criterionconditionvalue_a) {
        return new StreamCodec<B, R>() {
            private static final int MIN_FLAG = 1;
            public static final int MAX_FLAG = 2;

            public R decode(B b0) {
                byte b1 = b0.readByte();
                ...
                return criterionconditionvalue_a.create(optional, optional1);
            }

            public void encode(B b0, R r0) {
                Optional<T> optional = r0.min();
                Optional<T> optional1 = r0.max();
    ...
    public static record IntegerRange(Optional<Integer> min, Optional<Integer> max, Optional<Long> minSq, Optional<Long> maxSq) implements CriterionConditionValue<Integer> {
        ...
        public static final StreamCodec<ByteBuf, CriterionConditionValue.IntegerRange> STREAM_CODEC = CriterionConditionValue.createStreamCodec(ByteBufCodecs.INT, CriterionConditionValue.IntegerRange::new);
    ...
    public static record DoubleRange(Optional<Double> min, Optional<Double> max, Optional<Double> minSq, Optional<Double> maxSq) implements CriterionConditionValue<Double> {
        ...
        public static final StreamCodec<ByteBuf, CriterionConditionValue.DoubleRange> STREAM_CODEC = CriterionConditionValue.createStreamCodec(ByteBufCodecs.DOUBLE, CriterionConditionValue.DoubleRange::new);
