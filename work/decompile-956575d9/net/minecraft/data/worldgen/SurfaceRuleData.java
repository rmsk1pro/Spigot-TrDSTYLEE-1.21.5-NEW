...
public class SurfaceRuleData {
    ...
    public static SurfaceRules.o overworldLike(boolean flag, boolean flag1, boolean flag2) {
        ...
        ImmutableList.Builder<SurfaceRules.o> immutablelist_builder = ImmutableList.builder();

        if (flag1) {
            immutablelist_builder.add(SurfaceRules.ifTrue(SurfaceRules.not(SurfaceRules.verticalGradient("bedrock_roof", VerticalAnchor.belowTop(5), VerticalAnchor.top())), SurfaceRuleData.BEDROCK));
        }

        if (flag2) {
            immutablelist_builder.add(SurfaceRules.ifTrue(SurfaceRules.verticalGradient("bedrock_floor", VerticalAnchor.bottom(), VerticalAnchor.aboveBottom(5)), SurfaceRuleData.BEDROCK));
        }

        SurfaceRules.o surfacerules_o9 = SurfaceRules.ifTrue(SurfaceRules.abovePreliminarySurface(), surfacerules_o8);

        immutablelist_builder.add(flag ? surfacerules_o9 : surfacerules_o8);
        immutablelist_builder.add(SurfaceRules.ifTrue(SurfaceRules.verticalGradient("deepslate", VerticalAnchor.absolute(0), VerticalAnchor.absolute(8)), SurfaceRuleData.DEEPSLATE));
        return SurfaceRules.sequence((SurfaceRules.o[]) immutablelist_builder.build().toArray((i) -> {
