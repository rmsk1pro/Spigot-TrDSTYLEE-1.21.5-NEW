...
public class BiomeSettings {
    ...
    public static void addDefaultOres(BiomeSettingsGeneration.a biomesettingsgeneration_a, boolean flag) {
        ...
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.UNDERGROUND_ORES, OrePlacements.ORE_DIAMOND_MEDIUM);
    ...
    public static void addBushes(BiomeSettingsGeneration.a biomesettingsgeneration_a) {
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_BUSH);
    }
    ...
    public static void addOtherBirchTrees(BiomeSettingsGeneration.a biomesettingsgeneration_a) {
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.TREES_BIRCH_AND_OAK_LEAF_LITTER);
    }
    ...
    public static void addBirchForestFlowers(BiomeSettingsGeneration.a biomesettingsgeneration_a) {
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.WILDFLOWERS_BIRCH_FOREST);
    }
    ...
    public static void addBadlandGrass(BiomeSettingsGeneration.a biomesettingsgeneration_a) {
        ...
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_DRY_GRASS_BADLANDS);
    ...
    public static void addDesertVegetation(BiomeSettingsGeneration.a biomesettingsgeneration_a) {
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_DRY_GRASS_DESERT);
    ...
    public static void addMeadowVegetation(BiomeSettingsGeneration.a biomesettingsgeneration_a) {
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_GRASS_MEADOW);
        ...
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.WILDFLOWERS_MEADOW);
    }
    ...
    public static void addDefaultExtraVegetation(BiomeSettingsGeneration.a biomesettingsgeneration_a, boolean flag) {
        ...
        if (flag) {
            ...
            biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_FIREFLY_BUSH_NEAR_WATER);
        }

    }

    public static void addLeafLitterPatch(BiomeSettingsGeneration.a biomesettingsgeneration_a) {
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_LEAF_LITTER);
    }
    ...
    public static void addSwampExtraVegetation(BiomeSettingsGeneration.a biomesettingsgeneration_a) {
        ...
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_FIREFLY_BUSH_SWAMP);
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_FIREFLY_BUSH_NEAR_WATER_SWAMP);
    }

    public static void addMangroveSwampExtraVegetation(BiomeSettingsGeneration.a biomesettingsgeneration_a) {
    ...
    public static void farmAnimals(BiomeSettingsMobs.a biomesettingsmobs_a) {
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 12, new BiomeSettingsMobs.c(EntityTypes.SHEEP, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 10, new BiomeSettingsMobs.c(EntityTypes.PIG, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 10, new BiomeSettingsMobs.c(EntityTypes.CHICKEN, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.COW, 4, 4));
    }

    public static void caveSpawns(BiomeSettingsMobs.a biomesettingsmobs_a) {
        biomesettingsmobs_a.addSpawn(EnumCreatureType.AMBIENT, 10, new BiomeSettingsMobs.c(EntityTypes.BAT, 8, 8));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.UNDERGROUND_WATER_CREATURE, 10, new BiomeSettingsMobs.c(EntityTypes.GLOW_SQUID, 4, 6));
    }

    public static void commonSpawns(BiomeSettingsMobs.a biomesettingsmobs_a) {
        commonSpawns(biomesettingsmobs_a, 100);
    }

    public static void commonSpawns(BiomeSettingsMobs.a biomesettingsmobs_a, int i) {
        caveSpawns(biomesettingsmobs_a);
        monsters(biomesettingsmobs_a, 95, 5, i, false);
    }

    public static void oceanSpawns(BiomeSettingsMobs.a biomesettingsmobs_a, int i, int j, int k) {
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_CREATURE, i, new BiomeSettingsMobs.c(EntityTypes.SQUID, 1, j));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_AMBIENT, k, new BiomeSettingsMobs.c(EntityTypes.COD, 3, 6));
    ...
    public static void warmOceanSpawns(BiomeSettingsMobs.a biomesettingsmobs_a, int i, int j) {
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_CREATURE, i, new BiomeSettingsMobs.c(EntityTypes.SQUID, j, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_AMBIENT, 25, new BiomeSettingsMobs.c(EntityTypes.TROPICAL_FISH, 8, 8));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_CREATURE, 2, new BiomeSettingsMobs.c(EntityTypes.DOLPHIN, 1, 2));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 5, new BiomeSettingsMobs.c(EntityTypes.DROWNED, 1, 1));
        commonSpawns(biomesettingsmobs_a);
    }
    ...
    public static void plainsSpawns(BiomeSettingsMobs.a biomesettingsmobs_a) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 5, new BiomeSettingsMobs.c(EntityTypes.HORSE, 2, 6));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.DONKEY, 1, 3));
        commonSpawns(biomesettingsmobs_a);
    }

    public static void snowySpawns(BiomeSettingsMobs.a biomesettingsmobs_a) {
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 10, new BiomeSettingsMobs.c(EntityTypes.RABBIT, 2, 3));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.POLAR_BEAR, 1, 2));
        caveSpawns(biomesettingsmobs_a);
        monsters(biomesettingsmobs_a, 95, 5, 20, false);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 80, new BiomeSettingsMobs.c(EntityTypes.STRAY, 4, 4));
    }

    public static void desertSpawns(BiomeSettingsMobs.a biomesettingsmobs_a) {
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 12, new BiomeSettingsMobs.c(EntityTypes.RABBIT, 2, 3));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.CAMEL, 1, 1));
        caveSpawns(biomesettingsmobs_a);
        monsters(biomesettingsmobs_a, 19, 1, 100, false);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 80, new BiomeSettingsMobs.c(EntityTypes.HUSK, 4, 4));
    }
    ...
    public static void dripstoneCavesSpawns(BiomeSettingsMobs.a biomesettingsmobs_a) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 95, new BiomeSettingsMobs.c(EntityTypes.DROWNED, 4, 4));
    }

    public static void monsters(BiomeSettingsMobs.a biomesettingsmobs_a, int i, int j, int k, boolean flag) {
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 100, new BiomeSettingsMobs.c(EntityTypes.SPIDER, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, i, new BiomeSettingsMobs.c(flag ? EntityTypes.DROWNED : EntityTypes.ZOMBIE, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, j, new BiomeSettingsMobs.c(EntityTypes.ZOMBIE_VILLAGER, 1, 1));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, k, new BiomeSettingsMobs.c(EntityTypes.SKELETON, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 100, new BiomeSettingsMobs.c(EntityTypes.CREEPER, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 100, new BiomeSettingsMobs.c(EntityTypes.SLIME, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 10, new BiomeSettingsMobs.c(EntityTypes.ENDERMAN, 1, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 5, new BiomeSettingsMobs.c(EntityTypes.WITCH, 1, 1));
    }

    public static void mooshroomSpawns(BiomeSettingsMobs.a biomesettingsmobs_a) {
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.MOOSHROOM, 4, 8));
        caveSpawns(biomesettingsmobs_a);
    }
    ...
    public static void endSpawns(BiomeSettingsMobs.a biomesettingsmobs_a) {
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 10, new BiomeSettingsMobs.c(EntityTypes.ENDERMAN, 4, 4));
    }
}
