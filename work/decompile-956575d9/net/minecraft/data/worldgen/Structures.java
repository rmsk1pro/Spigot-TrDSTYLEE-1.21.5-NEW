...
public class Structures {
    ...
    public static void bootstrap(BootstrapContext<Structure> bootstrapcontext) {
        HolderGetter<BiomeBase> holdergetter = bootstrapcontext.<BiomeBase>lookup(Registries.BIOME);
        ...
        bootstrapcontext.register(BuiltinStructures.PILLAGER_OUTPOST, new JigsawStructure((new Structure.c.a(holdergetter.getOrThrow(BiomeTags.HAS_PILLAGER_OUTPOST))).spawnOverrides(Map.of(EnumCreatureType.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.a.STRUCTURE, WeightedList.of(new BiomeSettingsMobs.c(EntityTypes.PILLAGER, 1, 1))))).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(), holdergetter1.getOrThrow(WorldGenFeaturePillagerOutpostPieces.START), 7, ConstantHeight.of(VerticalAnchor.absolute(0)), true, HeightMap.Type.WORLD_SURFACE_WG));
        ...
        bootstrapcontext.register(BuiltinStructures.SWAMP_HUT, new SwampHutStructure((new Structure.c.a(holdergetter.getOrThrow(BiomeTags.HAS_SWAMP_HUT))).spawnOverrides(Map.of(EnumCreatureType.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.a.PIECE, WeightedList.of(new BiomeSettingsMobs.c(EntityTypes.WITCH, 1, 1))), EnumCreatureType.CREATURE, new StructureSpawnOverride(StructureSpawnOverride.a.PIECE, WeightedList.of(new BiomeSettingsMobs.c(EntityTypes.CAT, 1, 1))))).build()));
        ...
        bootstrapcontext.register(BuiltinStructures.OCEAN_MONUMENT, new OceanMonumentStructure((new Structure.c.a(holdergetter.getOrThrow(BiomeTags.HAS_OCEAN_MONUMENT))).spawnOverrides(Map.of(EnumCreatureType.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.a.STRUCTURE, WeightedList.of(new BiomeSettingsMobs.c(EntityTypes.GUARDIAN, 2, 4))), EnumCreatureType.UNDERGROUND_WATER_CREATURE, new StructureSpawnOverride(StructureSpawnOverride.a.STRUCTURE, BiomeSettingsMobs.EMPTY_MOB_LIST), EnumCreatureType.AXOLOTLS, new StructureSpawnOverride(StructureSpawnOverride.a.STRUCTURE, BiomeSettingsMobs.EMPTY_MOB_LIST))).build()));
        ...
        bootstrapcontext.register(BuiltinStructures.ANCIENT_CITY, new JigsawStructure((new Structure.c.a(holdergetter.getOrThrow(BiomeTags.HAS_ANCIENT_CITY))).spawnOverrides((Map) Arrays.stream(EnumCreatureType.values()).collect(Collectors.toMap((enumcreaturetype) -> {
            ...
            return new StructureSpawnOverride(StructureSpawnOverride.a.STRUCTURE, WeightedList.of());
        ...
        bootstrapcontext.register(BuiltinStructures.TRIAL_CHAMBERS, new JigsawStructure((new Structure.c.a(holdergetter.getOrThrow(BiomeTags.HAS_TRIAL_CHAMBERS))).generationStep(WorldGenStage.Decoration.UNDERGROUND_STRUCTURES).terrainAdapation(TerrainAdjustment.ENCAPSULATE).spawnOverrides((Map) Arrays.stream(EnumCreatureType.values()).collect(Collectors.toMap((enumcreaturetype) -> {
            ...
            return new StructureSpawnOverride(StructureSpawnOverride.a.PIECE, WeightedList.of());
