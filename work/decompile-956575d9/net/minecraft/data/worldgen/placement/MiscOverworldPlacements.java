...
public class MiscOverworldPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> bootstrapcontext) {
        ...
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.ICE_SPIKE, holder, CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.ICE_PATCH, holder1, CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, RandomOffsetPlacement.vertical(ConstantInt.of(-1)), BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(Blocks.SNOW_BLOCK)), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.FOREST_ROCK, holder2, CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.ICEBERG_BLUE, holder4, RarityFilter.onAverageOnceEvery(200), InSquarePlacement.spread(), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.ICEBERG_PACKED, holder3, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.BLUE_ICE, holder5, CountPlacement.of(UniformInt.of(0, 19)), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(30), VerticalAnchor.absolute(61)), BiomeFilter.biome());
        ...
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.LAKE_LAVA_SURFACE, holder6, RarityFilter.onAverageOnceEvery(200), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.DISK_CLAY, holder7, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BlockPredicateFilter.forPredicate(BlockPredicate.matchesFluids(FluidTypes.WATER)), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.DISK_GRAVEL, holder8, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BlockPredicateFilter.forPredicate(BlockPredicate.matchesFluids(FluidTypes.WATER)), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.DISK_SAND, holder9, CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BlockPredicateFilter.forPredicate(BlockPredicate.matchesFluids(FluidTypes.WATER)), BiomeFilter.biome());
        ...
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.FREEZE_TOP_LAYER, holder11, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.VOID_START_PLATFORM, holder12, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.DESERT_WELL, holder13, RarityFilter.onAverageOnceEvery(1000), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.SPRING_LAVA, holder14, CountPlacement.of(20), InSquarePlacement.spread(), HeightRangePlacement.of(VeryBiasedToBottomHeight.of(VerticalAnchor.bottom(), VerticalAnchor.belowTop(8), 8)), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.SPRING_LAVA_FROZEN, holder15, CountPlacement.of(20), InSquarePlacement.spread(), HeightRangePlacement.of(VeryBiasedToBottomHeight.of(VerticalAnchor.bottom(), VerticalAnchor.belowTop(8), 8)), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, MiscOverworldPlacements.SPRING_WATER, holder16, CountPlacement.of(25), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(192)), BiomeFilter.biome());
    }
}
