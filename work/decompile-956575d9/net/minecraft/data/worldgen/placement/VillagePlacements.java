...
public class VillagePlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> bootstrapcontext) {
        ...
        PlacementUtils.register(bootstrapcontext, VillagePlacements.PILE_HAY_VILLAGE, holder);
        PlacementUtils.register(bootstrapcontext, VillagePlacements.PILE_MELON_VILLAGE, holder1);
        PlacementUtils.register(bootstrapcontext, VillagePlacements.PILE_SNOW_VILLAGE, holder2);
        PlacementUtils.register(bootstrapcontext, VillagePlacements.PILE_ICE_VILLAGE, holder3);
        PlacementUtils.register(bootstrapcontext, VillagePlacements.PILE_PUMPKIN_VILLAGE, holder4);
        PlacementUtils.register(bootstrapcontext, VillagePlacements.OAK_VILLAGE, holder5, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(bootstrapcontext, VillagePlacements.ACACIA_VILLAGE, holder6, PlacementUtils.filteredByBlockSurvival(Blocks.ACACIA_SAPLING));
        PlacementUtils.register(bootstrapcontext, VillagePlacements.SPRUCE_VILLAGE, holder7, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(bootstrapcontext, VillagePlacements.PINE_VILLAGE, holder8, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(bootstrapcontext, VillagePlacements.PATCH_CACTUS_VILLAGE, holder9);
        PlacementUtils.register(bootstrapcontext, VillagePlacements.FLOWER_PLAIN_VILLAGE, holder10);
        PlacementUtils.register(bootstrapcontext, VillagePlacements.PATCH_TAIGA_GRASS_VILLAGE, holder11);
        PlacementUtils.register(bootstrapcontext, VillagePlacements.PATCH_BERRY_BUSH_VILLAGE, holder12);
    }
}
