...
public class AquaticPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> bootstrapcontext) {
        ...
        Holder.c<WorldGenFeatureConfigured<?, ?>> holder_c4 = holdergetter.getOrThrow(AquaticFeatures.SEA_PICKLE);
        Holder.c<WorldGenFeatureConfigured<?, ?>> holder_c5 = holdergetter.getOrThrow(AquaticFeatures.KELP);
        Holder.c<WorldGenFeatureConfigured<?, ?>> holder_c6 = holdergetter.getOrThrow(AquaticFeatures.WARM_OCEAN_VEGETATION);

        PlacementUtils.register(bootstrapcontext, AquaticPlacements.SEAGRASS_WARM, holder_c, seagrassPlacement(80));
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.SEAGRASS_NORMAL, holder_c, seagrassPlacement(48));
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.SEAGRASS_COLD, holder_c, seagrassPlacement(32));
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.SEAGRASS_RIVER, holder_c1, seagrassPlacement(48));
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.SEAGRASS_SWAMP, holder_c2, seagrassPlacement(64));
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.SEAGRASS_DEEP_WARM, holder_c3, seagrassPlacement(80));
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.SEAGRASS_DEEP, holder_c3, seagrassPlacement(48));
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.SEAGRASS_DEEP_COLD, holder_c3, seagrassPlacement(40));
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.SEA_PICKLE, holder_c4, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.KELP_COLD, holder_c5, NoiseBasedCountPlacement.of(120, 80.0D, 0.0D), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.KELP_WARM, holder_c5, NoiseBasedCountPlacement.of(80, 80.0D, 0.0D), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, AquaticPlacements.WARM_OCEAN_VEGETATION, holder_c6, NoiseBasedCountPlacement.of(20, 400.0D, 0.0D), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
    }
}
