...
public class TerrainProvider {
    ...
    public static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> overworldOffset(I i0, I i1, I i2, boolean flag) {
        ...
        return CubicSpline.<C, I>builder(i0, tofloatfunction).addPoint(-1.1F, 0.044F).addPoint(-1.02F, -0.2222F).addPoint(-0.51F, -0.2222F).addPoint(-0.44F, -0.12F).addPoint(-0.18F, -0.12F).addPoint(-0.16F, cubicspline).addPoint(-0.15F, cubicspline).addPoint(-0.1F, cubicspline1).addPoint(0.25F, cubicspline2).addPoint(1.0F, cubicspline3).build();
    }
    ...
    public static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> overworldJaggedness(I i0, I i1, I i2, I i3, boolean flag) {
        ...
        return CubicSpline.<C, I>builder(i0, tofloatfunction).addPoint(-0.11F, 0.0F).addPoint(0.03F, buildErosionJaggednessSpline(i1, i2, i3, 1.0F, 0.5F, 0.0F, 0.0F, tofloatfunction)).addPoint(0.65F, buildErosionJaggednessSpline(i1, i2, i3, 1.0F, 1.0F, 1.0F, 0.0F, tofloatfunction)).build();
    }
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildErosionJaggednessSpline(I i0, I i1, I i2, float f, float f1, float f2, float f3, ToFloatFunction<Float> tofloatfunction) {
        ...
        return CubicSpline.<C, I>builder(i0, tofloatfunction).addPoint(-1.0F, cubicspline).addPoint(-0.78F, cubicspline1).addPoint(-0.5775F, cubicspline1).addPoint(-0.375F, 0.0F).build();
    }
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildRidgeJaggednessSpline(I i0, I i1, float f, float f1, ToFloatFunction<Float> tofloatfunction) {
        ...
        float f4 = (f2 + f3) / 2.0F;
        CubicSpline.b<C, I> cubicspline_b = CubicSpline.<C, I>builder(i1, tofloatfunction);
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildWeirdnessJaggednessSpline(I i0, float f, ToFloatFunction<Float> tofloatfunction) {
        ...
        return CubicSpline.<C, I>builder(i0, tofloatfunction).addPoint(-0.01F, f1).addPoint(0.01F, f2).build();
    }
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> getErosionFactor(I i0, I i1, I i2, float f, boolean flag, ToFloatFunction<Float> tofloatfunction) {
        CubicSpline<C, I> cubicspline = CubicSpline.<C, I>builder(i1, tofloatfunction).addPoint(-0.2F, 6.3F).addPoint(0.2F, f).build();
        CubicSpline.b<C, I> cubicspline_b = CubicSpline.<C, I>builder(i0, tofloatfunction).addPoint(-0.6F, cubicspline).addPoint(-0.5F, CubicSpline.builder(i1, tofloatfunction).addPoint(-0.05F, 6.3F).addPoint(0.05F, 2.67F).build()).addPoint(-0.35F, cubicspline).addPoint(-0.25F, cubicspline).addPoint(-0.1F, CubicSpline.builder(i1, tofloatfunction).addPoint(-0.05F, 2.67F).addPoint(0.05F, 6.3F).build()).addPoint(0.03F, cubicspline);

        if (flag) {
            CubicSpline<C, I> cubicspline1 = CubicSpline.<C, I>builder(i1, tofloatfunction).addPoint(0.0F, f).addPoint(0.1F, 0.625F).build();
            CubicSpline<C, I> cubicspline2 = CubicSpline.<C, I>builder(i2, tofloatfunction).addPoint(-0.9F, f).addPoint(-0.69F, cubicspline1).build();

            cubicspline_b.addPoint(0.35F, f).addPoint(0.45F, cubicspline2).addPoint(0.55F, cubicspline2).addPoint(0.62F, f);
        } else {
            CubicSpline<C, I> cubicspline3 = CubicSpline.<C, I>builder(i2, tofloatfunction).addPoint(-0.7F, cubicspline).addPoint(-0.15F, 1.37F).build();
            CubicSpline<C, I> cubicspline4 = CubicSpline.<C, I>builder(i2, tofloatfunction).addPoint(0.45F, cubicspline).addPoint(0.7F, 1.56F).build();

            cubicspline_b.addPoint(0.05F, cubicspline4).addPoint(0.4F, cubicspline4).addPoint(0.45F, cubicspline3).addPoint(0.55F, cubicspline3).addPoint(0.58F, f);
        }
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildMountainRidgeSplineWithPoints(I i0, float f, boolean flag, ToFloatFunction<Float> tofloatfunction) {
        CubicSpline.b<C, I> cubicspline_b = CubicSpline.<C, I>builder(i0, tofloatfunction);
        float f1 = -0.7F;
        float f2 = -1.0F;
        ...
        if (-0.65F < f6 && f6 < 1.0F) {
            ...
            if (flag) {
                ...
                cubicspline_b.addPoint(0.0F, MathHelper.lerp(0.5F, f3, f5), f15);
            } else {
                cubicspline_b.addPoint(-1.0F, f3, f15);
            }

            cubicspline_b.addPoint(1.0F, f5, f15);
        }
    ...
    public static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildErosionOffsetSpline(I i0, I i1, float f, float f1, float f2, float f3, float f4, float f5, boolean flag, boolean flag1, ToFloatFunction<Float> tofloatfunction) {
        ...
        CubicSpline<C, I> cubicspline7 = CubicSpline.<C, I>builder(i1, tofloatfunction).addPoint(-1.0F, f).addPoint(-0.4F, cubicspline5).addPoint(0.0F, f2 + 0.07F).build();
        CubicSpline<C, I> cubicspline8 = ridgeSpline(i1, -0.02F, f5, f5, f1, f2, 0.0F, tofloatfunction);
        CubicSpline.b<C, I> cubicspline_b = CubicSpline.<C, I>builder(i0, tofloatfunction).addPoint(-0.85F, cubicspline).addPoint(-0.7F, cubicspline1).addPoint(-0.4F, cubicspline2).addPoint(-0.35F, cubicspline3).addPoint(-0.1F, cubicspline4).addPoint(0.2F, cubicspline5);
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> ridgeSpline(I i0, float f, float f1, float f2, float f3, float f4, float f5, ToFloatFunction<Float> tofloatfunction) {
        ...
        return CubicSpline.<C, I>builder(i0, tofloatfunction).addPoint(-1.0F, f, f6).addPoint(-0.4F, f1, Math.min(f6, f7)).addPoint(0.0F, f2, f7).addPoint(0.4F, f3, 2.0F * (f3 - f2)).addPoint(1.0F, f4, 0.7F * (f4 - f3)).build();
    }
}
