...
public class OverworldBiomes {
    ...
    private static BiomeBase biome(boolean flag, float f, float f1, BiomeSettingsMobs.a biomesettingsmobs_a, BiomeSettingsGeneration.a biomesettingsgeneration_a, @Nullable Music music) {
        return biome(flag, f, f1, 4159204, 329011, (Integer) null, (Integer) null, (Integer) null, biomesettingsmobs_a, biomesettingsgeneration_a, music);
    }

    private static BiomeBase biome(boolean flag, float f, float f1, int i, int j, @Nullable Integer integer, @Nullable Integer integer1, @Nullable Integer integer2, BiomeSettingsMobs.a biomesettingsmobs_a, BiomeSettingsGeneration.a biomesettingsgeneration_a, @Nullable Music music) {
        ...
        if (integer2 != null) {
            biomefog_a.dryFoliageColorOverride(integer2);
        }
    ...
    public static BiomeBase oldGrowthTaiga(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.WOLF, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 4, new BiomeSettingsMobs.c(EntityTypes.RABBIT, 2, 3));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.FOX, 2, 4));
        if (flag) {
        ...
        BiomeSettings.addDefaultExtraVegetation(biomesettingsgeneration_a, true);
    ...
    public static BiomeBase sparseJungle(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.WOLF, 2, 4));
    ...
    public static BiomeBase jungle(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        BiomeSettings.baseJungleSpawns(biomesettingsmobs_a);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 40, new BiomeSettingsMobs.c(EntityTypes.PARROT, 1, 2)).addSpawn(EnumCreatureType.MONSTER, 2, new BiomeSettingsMobs.c(EntityTypes.OCELOT, 1, 3)).addSpawn(EnumCreatureType.CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.PANDA, 1, 2));
    ...
    public static BiomeBase bambooJungle(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        BiomeSettings.baseJungleSpawns(biomesettingsmobs_a);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 40, new BiomeSettingsMobs.c(EntityTypes.PARROT, 1, 2)).addSpawn(EnumCreatureType.CREATURE, 80, new BiomeSettingsMobs.c(EntityTypes.PANDA, 1, 2)).addSpawn(EnumCreatureType.MONSTER, 2, new BiomeSettingsMobs.c(EntityTypes.OCELOT, 1, 1));
    ...
    public static BiomeBase windsweptHills(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        ...
        BiomeSettings.farmAnimals(biomesettingsmobs_a);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 5, new BiomeSettingsMobs.c(EntityTypes.LLAMA, 4, 6));
        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        BiomeSettingsGeneration.a biomesettingsgeneration_a = new BiomeSettingsGeneration.a(holdergetter, holdergetter1);
        ...
        BiomeSettings.addBushes(biomesettingsgeneration_a);
        BiomeSettings.addDefaultFlowers(biomesettingsgeneration_a);
    ...
    public static BiomeBase savanna(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag, boolean flag1) {
        ...
        BiomeSettings.farmAnimals(biomesettingsmobs_a);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.HORSE, 2, 6)).addSpawn(EnumCreatureType.CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.DONKEY, 1, 1)).addSpawn(EnumCreatureType.CREATURE, 10, new BiomeSettingsMobs.c(EntityTypes.ARMADILLO, 2, 3));
        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        if (flag1) {
            biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.LLAMA, 4, 4));
            biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.WOLF, 4, 8));
        }
    ...
    public static BiomeBase badlands(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        ...
        BiomeSettings.farmAnimals(biomesettingsmobs_a);
        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 6, new BiomeSettingsMobs.c(EntityTypes.ARMADILLO, 1, 2));
        biomesettingsmobs_a.creatureGenerationProbability(0.03F);
        if (flag) {
            biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 2, new BiomeSettingsMobs.c(EntityTypes.WOLF, 4, 8));
    ...
    private static BiomeBase baseOcean(BiomeSettingsMobs.a biomesettingsmobs_a, int i, int j, BiomeSettingsGeneration.a biomesettingsgeneration_a) {
        return biome(true, 0.5F, 0.5F, i, j, (Integer) null, (Integer) null, (Integer) null, biomesettingsmobs_a, biomesettingsgeneration_a, OverworldBiomes.NORMAL_MUSIC);
    }
    ...
    public static BiomeBase coldOcean(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_AMBIENT, 15, new BiomeSettingsMobs.c(EntityTypes.SALMON, 1, 5));
    ...
    public static BiomeBase ocean(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.DOLPHIN, 1, 2));
        BiomeSettingsGeneration.a biomesettingsgeneration_a = baseOceanGeneration(holdergetter, holdergetter1);
    ...
    public static BiomeBase lukeWarmOcean(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_AMBIENT, 5, new BiomeSettingsMobs.c(EntityTypes.PUFFERFISH, 1, 3)).addSpawn(EnumCreatureType.WATER_AMBIENT, 25, new BiomeSettingsMobs.c(EntityTypes.TROPICAL_FISH, 8, 8)).addSpawn(EnumCreatureType.WATER_CREATURE, 2, new BiomeSettingsMobs.c(EntityTypes.DOLPHIN, 1, 2));
        BiomeSettingsGeneration.a biomesettingsgeneration_a = baseOceanGeneration(holdergetter, holdergetter1);
    ...
    public static BiomeBase warmOcean(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        BiomeSettingsMobs.a biomesettingsmobs_a = (new BiomeSettingsMobs.a()).addSpawn(EnumCreatureType.WATER_AMBIENT, 15, new BiomeSettingsMobs.c(EntityTypes.PUFFERFISH, 1, 3));
    ...
    public static BiomeBase frozenOcean(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        BiomeSettingsMobs.a biomesettingsmobs_a = (new BiomeSettingsMobs.a()).addSpawn(EnumCreatureType.WATER_CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.SQUID, 1, 4)).addSpawn(EnumCreatureType.WATER_AMBIENT, 15, new BiomeSettingsMobs.c(EntityTypes.SALMON, 1, 5)).addSpawn(EnumCreatureType.CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.POLAR_BEAR, 1, 2));

        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 5, new BiomeSettingsMobs.c(EntityTypes.DROWNED, 1, 1));
    ...
    public static BiomeBase forest(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag, boolean flag1, boolean flag2) {
        ...
        if (flag2) {
            ...
            if (flag) {
                BiomeSettings.addBirchForestFlowers(biomesettingsgeneration_a);
                if (flag1) {
        ...
        if (flag2) {
            ...
            biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 5, new BiomeSettingsMobs.c(EntityTypes.WOLF, 4, 4));
        }
    ...
    public static BiomeBase taiga(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        ...
        BiomeSettings.farmAnimals(biomesettingsmobs_a);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.WOLF, 4, 4)).addSpawn(EnumCreatureType.CREATURE, 4, new BiomeSettingsMobs.c(EntityTypes.RABBIT, 2, 3)).addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.FOX, 2, 4));
        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        ...
        return biome(true, f, flag ? 0.4F : 0.8F, flag ? 4020182 : 4159204, 329011, (Integer) null, (Integer) null, (Integer) null, biomesettingsmobs_a, biomesettingsgeneration_a, OverworldBiomes.NORMAL_MUSIC);
    }

    public static BiomeBase darkForest(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        BiomeSettingsMobs.a biomesettingsmobs_a = new BiomeSettingsMobs.a();
        ...
        globalOverworldGeneration(biomesettingsgeneration_a);
        biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, flag ? VegetationPlacements.PALE_GARDEN_VEGETATION : VegetationPlacements.DARK_FOREST_VEGETATION);
        if (!flag) {
            BiomeSettings.addForestFlowers(biomesettingsgeneration_a);
        } else {
            biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PALE_MOSS_PATCH);
            biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.PALE_GARDEN_FLOWERS);
        }
        ...
        if (!flag) {
            ...
            biomesettingsgeneration_a.addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, VegetationPlacements.FLOWER_PALE_GARDEN);
        }

        BiomeSettings.addForestGrass(biomesettingsgeneration_a);
        if (!flag) {
            BiomeSettings.addDefaultMushrooms(biomesettingsgeneration_a);
            BiomeSettings.addLeafLitterPatch(biomesettingsgeneration_a);
        }

        BiomeSettings.addDefaultExtraVegetation(biomesettingsgeneration_a, true);
        return (new BiomeBase.a()).hasPrecipitation(true).temperature(0.7F).downfall(0.8F).specialEffects(flag ? (new BiomeFog.a()).waterColor(7768221).waterFogColor(5597568).fogColor(8484720).skyColor(12171705).grassColorOverride(7832178).foliageColorOverride(8883574).dryFoliageColorOverride(10528412).ambientMoodSound(CaveSoundSettings.LEGACY_CAVE_SETTINGS).silenceAllBackgroundMusic().build() : (new BiomeFog.a()).waterColor(4159204).waterFogColor(329011).fogColor(12638463).skyColor(calculateSkyColor(0.7F)).dryFoliageColorOverride(8082228).grassColorModifier(BiomeFog.GrassColor.DARK_FOREST).ambientMoodSound(CaveSoundSettings.LEGACY_CAVE_SETTINGS).backgroundMusic(Musics.createGameMusic(SoundEffects.MUSIC_BIOME_FOREST)).build()).mobSpawnSettings(biomesettingsmobs_a.build()).generationSettings(biomesettingsgeneration_a.build()).build();
    }

    public static BiomeBase swamp(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        BiomeSettingsMobs.a biomesettingsmobs_a = new BiomeSettingsMobs.a();

        BiomeSettings.farmAnimals(biomesettingsmobs_a);
        BiomeSettings.commonSpawns(biomesettingsmobs_a, 70);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 1, new BiomeSettingsMobs.c(EntityTypes.SLIME, 1, 1));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 30, new BiomeSettingsMobs.c(EntityTypes.BOGGED, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 10, new BiomeSettingsMobs.c(EntityTypes.FROG, 2, 5));
        BiomeSettingsGeneration.a biomesettingsgeneration_a = new BiomeSettingsGeneration.a(holdergetter, holdergetter1);
    ...
    public static BiomeBase mangroveSwamp(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, 30, new BiomeSettingsMobs.c(EntityTypes.BOGGED, 4, 4));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 10, new BiomeSettingsMobs.c(EntityTypes.FROG, 2, 5));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_AMBIENT, 25, new BiomeSettingsMobs.c(EntityTypes.TROPICAL_FISH, 8, 8));
        BiomeSettingsGeneration.a biomesettingsgeneration_a = new BiomeSettingsGeneration.a(holdergetter, holdergetter1);
        ...
        BiomeSettings.addMangroveSwampExtraVegetation(biomesettingsgeneration_a);
        Music music = Musics.createGameMusic(SoundEffects.MUSIC_BIOME_SWAMP);
    ...
    public static BiomeBase river(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        BiomeSettingsMobs.a biomesettingsmobs_a = (new BiomeSettingsMobs.a()).addSpawn(EnumCreatureType.WATER_CREATURE, 2, new BiomeSettingsMobs.c(EntityTypes.SQUID, 1, 4)).addSpawn(EnumCreatureType.WATER_AMBIENT, 5, new BiomeSettingsMobs.c(EntityTypes.SALMON, 1, 5));

        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        biomesettingsmobs_a.addSpawn(EnumCreatureType.MONSTER, flag ? 1 : 100, new BiomeSettingsMobs.c(EntityTypes.DROWNED, 1, 1));
        BiomeSettingsGeneration.a biomesettingsgeneration_a = new BiomeSettingsGeneration.a(holdergetter, holdergetter1);
        ...
        return biome(true, f, 0.5F, flag ? 3750089 : 4159204, 329011, (Integer) null, (Integer) null, (Integer) null, biomesettingsmobs_a, biomesettingsgeneration_a, OverworldBiomes.NORMAL_MUSIC);
    }
    ...
    public static BiomeBase beach(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag, boolean flag1) {
        ...
        if (flag2) {
            biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 5, new BiomeSettingsMobs.c(EntityTypes.TURTLE, 2, 5));
        }
        ...
        return biome(true, f, flag2 ? 0.4F : 0.3F, flag ? 4020182 : 4159204, 329011, (Integer) null, (Integer) null, (Integer) null, biomesettingsmobs_a, biomesettingsgeneration_a, OverworldBiomes.NORMAL_MUSIC);
    }
    ...
    public static BiomeBase meadowOrCherryGrove(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, boolean flag) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 1, new BiomeSettingsMobs.c(flag ? EntityTypes.PIG : EntityTypes.DONKEY, 1, 2)).addSpawn(EnumCreatureType.CREATURE, 2, new BiomeSettingsMobs.c(EntityTypes.RABBIT, 2, 6)).addSpawn(EnumCreatureType.CREATURE, 2, new BiomeSettingsMobs.c(EntityTypes.SHEEP, 2, 4));
        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        globalOverworldGeneration(biomesettingsgeneration_a);
        BiomeSettings.addPlainGrass(biomesettingsgeneration_a);
        BiomeSettings.addDefaultOres(biomesettingsgeneration_a);
        ...
        return flag ? biome(true, 0.5F, 0.8F, 6141935, 6141935, 11983713, 11983713, (Integer) null, biomesettingsmobs_a, biomesettingsgeneration_a, music) : biome(true, 0.5F, 0.8F, 937679, 329011, (Integer) null, (Integer) null, (Integer) null, biomesettingsmobs_a, biomesettingsgeneration_a, music);
    }
    ...
    public static BiomeBase frozenPeaks(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 5, new BiomeSettingsMobs.c(EntityTypes.GOAT, 1, 3));
        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        globalOverworldGeneration(biomesettingsgeneration_a);
    ...
    public static BiomeBase snowySlopes(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 4, new BiomeSettingsMobs.c(EntityTypes.RABBIT, 2, 3)).addSpawn(EnumCreatureType.CREATURE, 5, new BiomeSettingsMobs.c(EntityTypes.GOAT, 1, 3));
        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        globalOverworldGeneration(biomesettingsgeneration_a);
        BiomeSettings.addFrozenSprings(biomesettingsgeneration_a);
        BiomeSettings.addDefaultOres(biomesettingsgeneration_a);
        BiomeSettings.addDefaultSoftDisks(biomesettingsgeneration_a);
        BiomeSettings.addDefaultExtraVegetation(biomesettingsgeneration_a, false);
        BiomeSettings.addExtraEmeralds(biomesettingsgeneration_a);
        BiomeSettings.addInfestedStone(biomesettingsgeneration_a);
    ...
    public static BiomeBase grove(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.CREATURE, 1, new BiomeSettingsMobs.c(EntityTypes.WOLF, 1, 1)).addSpawn(EnumCreatureType.CREATURE, 8, new BiomeSettingsMobs.c(EntityTypes.RABBIT, 2, 3)).addSpawn(EnumCreatureType.CREATURE, 4, new BiomeSettingsMobs.c(EntityTypes.FOX, 2, 4));
        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        globalOverworldGeneration(biomesettingsgeneration_a);
        BiomeSettings.addFrozenSprings(biomesettingsgeneration_a);
        BiomeSettings.addDefaultOres(biomesettingsgeneration_a);
    ...
    public static BiomeBase lushCaves(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        biomesettingsmobs_a.addSpawn(EnumCreatureType.AXOLOTLS, 10, new BiomeSettingsMobs.c(EntityTypes.AXOLOTL, 4, 6));
        biomesettingsmobs_a.addSpawn(EnumCreatureType.WATER_AMBIENT, 25, new BiomeSettingsMobs.c(EntityTypes.TROPICAL_FISH, 8, 8));
        BiomeSettings.commonSpawns(biomesettingsmobs_a);
        BiomeSettingsGeneration.a biomesettingsgeneration_a = new BiomeSettingsGeneration.a(holdergetter, holdergetter1);
    ...
    public static BiomeBase deepDark(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        biomesettingsgeneration_a.addCarver(WorldGenCarvers.CAVE);
        biomesettingsgeneration_a.addCarver(WorldGenCarvers.CAVE_EXTRA_UNDERGROUND);
        biomesettingsgeneration_a.addCarver(WorldGenCarvers.CANYON);
        BiomeSettings.addDefaultCrystalFormations(biomesettingsgeneration_a);
        BiomeSettings.addDefaultMonsterRoom(biomesettingsgeneration_a);
        BiomeSettings.addDefaultUndergroundVariety(biomesettingsgeneration_a);
        BiomeSettings.addSurfaceFreezing(biomesettingsgeneration_a);
