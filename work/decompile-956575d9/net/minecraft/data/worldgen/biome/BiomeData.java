...
public abstract class BiomeData {
    ...
    public static void bootstrap(BootstrapContext<BiomeBase> bootstrapcontext) {
        HolderGetter<PlacedFeature> holdergetter = bootstrapcontext.<PlacedFeature>lookup(Registries.PLACED_FEATURE);
        HolderGetter<WorldGenCarverWrapper<?>> holdergetter1 = bootstrapcontext.<WorldGenCarverWrapper<?>>lookup(Registries.CONFIGURED_CARVER);
        ...
        bootstrapcontext.register(Biomes.SWAMP, OverworldBiomes.swamp(holdergetter, holdergetter1));
        bootstrapcontext.register(Biomes.MANGROVE_SWAMP, OverworldBiomes.mangroveSwamp(holdergetter, holdergetter1));
        ...
        bootstrapcontext.register(Biomes.DARK_FOREST, OverworldBiomes.darkForest(holdergetter, holdergetter1, false));
        bootstrapcontext.register(Biomes.PALE_GARDEN, OverworldBiomes.darkForest(holdergetter, holdergetter1, true));
