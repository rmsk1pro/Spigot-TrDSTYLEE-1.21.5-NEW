...
public class NetherBiomes {
    ...
    public static BiomeBase netherWastes(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        BiomeSettingsMobs biomesettingsmobs = (new BiomeSettingsMobs.a()).addSpawn(EnumCreatureType.MONSTER, 50, new BiomeSettingsMobs.c(EntityTypes.GHAST, 4, 4)).addSpawn(EnumCreatureType.MONSTER, 100, new BiomeSettingsMobs.c(EntityTypes.ZOMBIFIED_PIGLIN, 4, 4)).addSpawn(EnumCreatureType.MONSTER, 2, new BiomeSettingsMobs.c(EntityTypes.MAGMA_CUBE, 4, 4)).addSpawn(EnumCreatureType.MONSTER, 1, new BiomeSettingsMobs.c(EntityTypes.ENDERMAN, 4, 4)).addSpawn(EnumCreatureType.MONSTER, 15, new BiomeSettingsMobs.c(EntityTypes.PIGLIN, 4, 4)).addSpawn(EnumCreatureType.CREATURE, 60, new BiomeSettingsMobs.c(EntityTypes.STRIDER, 1, 2)).build();
        BiomeSettingsGeneration.a biomesettingsgeneration_a = (new BiomeSettingsGeneration.a(holdergetter, holdergetter1)).addCarver(WorldGenCarvers.NETHER_CAVE).addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, MiscOverworldPlacements.SPRING_LAVA);
    ...
    public static BiomeBase basaltDeltas(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        BiomeSettingsMobs biomesettingsmobs = (new BiomeSettingsMobs.a()).addSpawn(EnumCreatureType.MONSTER, 40, new BiomeSettingsMobs.c(EntityTypes.GHAST, 1, 1)).addSpawn(EnumCreatureType.MONSTER, 100, new BiomeSettingsMobs.c(EntityTypes.MAGMA_CUBE, 2, 5)).addSpawn(EnumCreatureType.CREATURE, 60, new BiomeSettingsMobs.c(EntityTypes.STRIDER, 1, 2)).build();
        BiomeSettingsGeneration.a biomesettingsgeneration_a = (new BiomeSettingsGeneration.a(holdergetter, holdergetter1)).addCarver(WorldGenCarvers.NETHER_CAVE).addFeature(WorldGenStage.Decoration.SURFACE_STRUCTURES, NetherPlacements.DELTA).addFeature(WorldGenStage.Decoration.SURFACE_STRUCTURES, NetherPlacements.SMALL_BASALT_COLUMNS).addFeature(WorldGenStage.Decoration.SURFACE_STRUCTURES, NetherPlacements.LARGE_BASALT_COLUMNS).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, NetherPlacements.BASALT_BLOBS).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, NetherPlacements.BLACKSTONE_BLOBS).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, NetherPlacements.SPRING_DELTA).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, NetherPlacements.PATCH_FIRE).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, NetherPlacements.PATCH_SOUL_FIRE).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, NetherPlacements.GLOWSTONE_EXTRA).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, NetherPlacements.GLOWSTONE).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, VegetationPlacements.BROWN_MUSHROOM_NETHER).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, VegetationPlacements.RED_MUSHROOM_NETHER).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, OrePlacements.ORE_MAGMA).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, NetherPlacements.SPRING_CLOSED_DOUBLE).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, OrePlacements.ORE_GOLD_DELTAS).addFeature(WorldGenStage.Decoration.UNDERGROUND_DECORATION, OrePlacements.ORE_QUARTZ_DELTAS);
    ...
    public static BiomeBase crimsonForest(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        BiomeSettingsMobs biomesettingsmobs = (new BiomeSettingsMobs.a()).addSpawn(EnumCreatureType.MONSTER, 1, new BiomeSettingsMobs.c(EntityTypes.ZOMBIFIED_PIGLIN, 2, 4)).addSpawn(EnumCreatureType.MONSTER, 9, new BiomeSettingsMobs.c(EntityTypes.HOGLIN, 3, 4)).addSpawn(EnumCreatureType.MONSTER, 5, new BiomeSettingsMobs.c(EntityTypes.PIGLIN, 3, 4)).addSpawn(EnumCreatureType.CREATURE, 60, new BiomeSettingsMobs.c(EntityTypes.STRIDER, 1, 2)).build();
        BiomeSettingsGeneration.a biomesettingsgeneration_a = (new BiomeSettingsGeneration.a(holdergetter, holdergetter1)).addCarver(WorldGenCarvers.NETHER_CAVE).addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, MiscOverworldPlacements.SPRING_LAVA);
    ...
    public static BiomeBase warpedForest(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        BiomeSettingsMobs biomesettingsmobs = (new BiomeSettingsMobs.a()).addSpawn(EnumCreatureType.MONSTER, 1, new BiomeSettingsMobs.c(EntityTypes.ENDERMAN, 4, 4)).addSpawn(EnumCreatureType.CREATURE, 60, new BiomeSettingsMobs.c(EntityTypes.STRIDER, 1, 2)).addMobCharge(EntityTypes.ENDERMAN, 1.0D, 0.12D).build();
        BiomeSettingsGeneration.a biomesettingsgeneration_a = (new BiomeSettingsGeneration.a(holdergetter, holdergetter1)).addCarver(WorldGenCarvers.NETHER_CAVE).addFeature(WorldGenStage.Decoration.VEGETAL_DECORATION, MiscOverworldPlacements.SPRING_LAVA);
