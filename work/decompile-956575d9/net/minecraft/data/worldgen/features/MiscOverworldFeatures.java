...
public class MiscOverworldFeatures {
    ...
    public static void bootstrap(BootstrapContext<WorldGenFeatureConfigured<?, ?>> bootstrapcontext) {
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.ICE_SPIKE, WorldGenerator.ICE_SPIKE);
        ...
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.FOREST_ROCK, WorldGenerator.FOREST_ROCK, new WorldGenFeatureLakeConfiguration(Blocks.MOSSY_COBBLESTONE.defaultBlockState()));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.ICEBERG_PACKED, WorldGenerator.ICEBERG, new WorldGenFeatureLakeConfiguration(Blocks.PACKED_ICE.defaultBlockState()));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.ICEBERG_BLUE, WorldGenerator.ICEBERG, new WorldGenFeatureLakeConfiguration(Blocks.BLUE_ICE.defaultBlockState()));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.BLUE_ICE, WorldGenerator.BLUE_ICE);
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.LAKE_LAVA, WorldGenerator.LAKE, new WorldGenLakes.a(WorldGenFeatureStateProvider.simple(Blocks.LAVA.defaultBlockState()), WorldGenFeatureStateProvider.simple(Blocks.STONE.defaultBlockState())));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.DISK_CLAY, WorldGenerator.DISK, new WorldGenFeatureCircleConfiguration(RuleBasedBlockStateProvider.simple(Blocks.CLAY), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.CLAY)), UniformInt.of(2, 3), 1));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.DISK_GRAVEL, WorldGenerator.DISK, new WorldGenFeatureCircleConfiguration(RuleBasedBlockStateProvider.simple(Blocks.GRAVEL), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(2, 5), 2));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.DISK_SAND, WorldGenerator.DISK, new WorldGenFeatureCircleConfiguration(new RuleBasedBlockStateProvider(WorldGenFeatureStateProvider.simple(Blocks.SAND), List.of(new RuleBasedBlockStateProvider.a(BlockPredicate.matchesBlocks(EnumDirection.DOWN.getUnitVec3i(), Blocks.AIR), WorldGenFeatureStateProvider.simple(Blocks.SANDSTONE)))), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(2, 6), 2));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.FREEZE_TOP_LAYER, WorldGenerator.FREEZE_TOP_LAYER);
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.DISK_GRASS, WorldGenerator.DISK, new WorldGenFeatureCircleConfiguration(new RuleBasedBlockStateProvider(WorldGenFeatureStateProvider.simple(Blocks.DIRT), List.of(new RuleBasedBlockStateProvider.a(BlockPredicate.not(BlockPredicate.anyOf(BlockPredicate.solid(EnumDirection.UP.getUnitVec3i()), BlockPredicate.matchesFluids(EnumDirection.UP.getUnitVec3i(), FluidTypes.WATER))), WorldGenFeatureStateProvider.simple(Blocks.GRASS_BLOCK)))), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.MUD)), UniformInt.of(2, 6), 2));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.BONUS_CHEST, WorldGenerator.BONUS_CHEST);
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.VOID_START_PLATFORM, WorldGenerator.VOID_START_PLATFORM);
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.DESERT_WELL, WorldGenerator.DESERT_WELL);
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.SPRING_LAVA_OVERWORLD, WorldGenerator.SPRING, new WorldGenFeatureHellFlowingLavaConfiguration(FluidTypes.LAVA.defaultFluidState(), true, 4, 1, HolderSet.direct(Block::builtInRegistryHolder, Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.DEEPSLATE, Blocks.TUFF, Blocks.CALCITE, Blocks.DIRT)));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.SPRING_LAVA_FROZEN, WorldGenerator.SPRING, new WorldGenFeatureHellFlowingLavaConfiguration(FluidTypes.LAVA.defaultFluidState(), true, 4, 1, HolderSet.direct(Block::builtInRegistryHolder, Blocks.SNOW_BLOCK, Blocks.POWDER_SNOW, Blocks.PACKED_ICE)));
        FeatureUtils.register(bootstrapcontext, MiscOverworldFeatures.SPRING_WATER, WorldGenerator.SPRING, new WorldGenFeatureHellFlowingLavaConfiguration(FluidTypes.WATER.defaultFluidState(), true, 4, 1, HolderSet.direct(Block::builtInRegistryHolder, Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.DEEPSLATE, Blocks.TUFF, Blocks.CALCITE, Blocks.DIRT, Blocks.SNOW_BLOCK, Blocks.POWDER_SNOW, Blocks.PACKED_ICE)));
    }
}
