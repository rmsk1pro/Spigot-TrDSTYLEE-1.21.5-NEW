...
public class CaveFeatures {
    ...
    private static Holder<PlacedFeature> makeDripleaf(EnumDirection enumdirection) {
        return PlacementUtils.inlinePlaced(WorldGenerator.BLOCK_COLUMN, new BlockColumnConfiguration(List.of(BlockColumnConfiguration.layer(new WeightedListInt(WeightedList.builder().add(UniformInt.of(0, 4), 2).add(ConstantInt.of(0), 1).build()), WorldGenFeatureStateProvider.simple((IBlockData) Blocks.BIG_DRIPLEAF_STEM.defaultBlockState().setValue(BlockProperties.HORIZONTAL_FACING, enumdirection))), BlockColumnConfiguration.layer(ConstantInt.of(1), WorldGenFeatureStateProvider.simple((IBlockData) Blocks.BIG_DRIPLEAF.defaultBlockState().setValue(BlockProperties.HORIZONTAL_FACING, enumdirection)))), EnumDirection.UP, BlockPredicate.ONLY_IN_AIR_OR_WATER_PREDICATE, true));
    }

    private static Holder<PlacedFeature> makeSmallDripleaf() {
        return PlacementUtils.inlinePlaced(WorldGenerator.SIMPLE_BLOCK, new WorldGenFeatureBlockConfiguration(new WorldGenFeatureStateProviderWeighted(WeightedList.builder().add((IBlockData) Blocks.SMALL_DRIPLEAF.defaultBlockState().setValue(SmallDripleafBlock.FACING, EnumDirection.EAST), 1).add((IBlockData) Blocks.SMALL_DRIPLEAF.defaultBlockState().setValue(SmallDripleafBlock.FACING, EnumDirection.WEST), 1).add((IBlockData) Blocks.SMALL_DRIPLEAF.defaultBlockState().setValue(SmallDripleafBlock.FACING, EnumDirection.NORTH), 1).add((IBlockData) Blocks.SMALL_DRIPLEAF.defaultBlockState().setValue(SmallDripleafBlock.FACING, EnumDirection.SOUTH), 1))));
    }
    ...
    public static void bootstrap(BootstrapContext<WorldGenFeatureConfigured<?, ?>> bootstrapcontext) {
        ...
        HolderGetter<ProcessorList> holdergetter1 = bootstrapcontext.<ProcessorList>lookup(Registries.PROCESSOR_LIST);

        FeatureUtils.register(bootstrapcontext, CaveFeatures.MONSTER_ROOM, WorldGenerator.MONSTER_ROOM);
        List<MinecraftKey> list = List.of(MinecraftKey.withDefaultNamespace("fossil/spine_1"), MinecraftKey.withDefaultNamespace("fossil/spine_2"), MinecraftKey.withDefaultNamespace("fossil/spine_3"), MinecraftKey.withDefaultNamespace("fossil/spine_4"), MinecraftKey.withDefaultNamespace("fossil/skull_1"), MinecraftKey.withDefaultNamespace("fossil/skull_2"), MinecraftKey.withDefaultNamespace("fossil/skull_3"), MinecraftKey.withDefaultNamespace("fossil/skull_4"));
        List<MinecraftKey> list1 = List.of(MinecraftKey.withDefaultNamespace("fossil/spine_1_coal"), MinecraftKey.withDefaultNamespace("fossil/spine_2_coal"), MinecraftKey.withDefaultNamespace("fossil/spine_3_coal"), MinecraftKey.withDefaultNamespace("fossil/spine_4_coal"), MinecraftKey.withDefaultNamespace("fossil/skull_1_coal"), MinecraftKey.withDefaultNamespace("fossil/skull_2_coal"), MinecraftKey.withDefaultNamespace("fossil/skull_3_coal"), MinecraftKey.withDefaultNamespace("fossil/skull_4_coal"));
        ...
        FeatureUtils.register(bootstrapcontext, CaveFeatures.GLOW_LICHEN, WorldGenerator.MULTIFACE_GROWTH, new MultifaceGrowthConfiguration(multifacespreadeableblock, 20, false, true, true, 0.5F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.STONE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRANITE, Blocks.DRIPSTONE_BLOCK, Blocks.CALCITE, Blocks.TUFF, Blocks.DEEPSLATE)));
        FeatureUtils.register(bootstrapcontext, CaveFeatures.ROOTED_AZALEA_TREE, WorldGenerator.ROOT_SYSTEM, new RootSystemConfiguration(PlacementUtils.inlinePlaced(holdergetter.getOrThrow(TreeFeatures.AZALEA_TREE)), 3, 3, TagsBlock.AZALEA_ROOT_REPLACEABLE, WorldGenFeatureStateProvider.simple(Blocks.ROOTED_DIRT), 20, 100, 3, 2, WorldGenFeatureStateProvider.simple(Blocks.HANGING_ROOTS), 20, 2, BlockPredicate.allOf(BlockPredicate.anyOf(BlockPredicate.matchesBlocks(List.of(Blocks.AIR, Blocks.CAVE_AIR, Blocks.VOID_AIR)), BlockPredicate.matchesTag(TagsBlock.REPLACEABLE_BY_TREES)), BlockPredicate.matchesTag(EnumDirection.DOWN.getUnitVec3i(), TagsBlock.AZALEA_GROWS_ON))));
        WorldGenFeatureStateProviderWeighted worldgenfeaturestateproviderweighted = new WorldGenFeatureStateProviderWeighted(WeightedList.builder().add(Blocks.CAVE_VINES_PLANT.defaultBlockState(), 4).add((IBlockData) Blocks.CAVE_VINES_PLANT.defaultBlockState().setValue(CaveVines.BERRIES, true), 1));
        RandomizedIntStateProvider randomizedintstateprovider = new RandomizedIntStateProvider(new WorldGenFeatureStateProviderWeighted(WeightedList.builder().add(Blocks.CAVE_VINES.defaultBlockState(), 4).add((IBlockData) Blocks.CAVE_VINES.defaultBlockState().setValue(CaveVines.BERRIES, true), 1)), CaveVinesBlock.AGE, UniformInt.of(23, 25));

        FeatureUtils.register(bootstrapcontext, CaveFeatures.CAVE_VINE, WorldGenerator.BLOCK_COLUMN, new BlockColumnConfiguration(List.of(BlockColumnConfiguration.layer(new WeightedListInt(WeightedList.builder().add(UniformInt.of(0, 19), 2).add(UniformInt.of(0, 2), 3).add(UniformInt.of(0, 6), 10).build()), worldgenfeaturestateproviderweighted), BlockColumnConfiguration.layer(ConstantInt.of(1), randomizedintstateprovider)), EnumDirection.DOWN, BlockPredicate.ONLY_IN_AIR_PREDICATE, true));
        FeatureUtils.register(bootstrapcontext, CaveFeatures.CAVE_VINE_IN_MOSS, WorldGenerator.BLOCK_COLUMN, new BlockColumnConfiguration(List.of(BlockColumnConfiguration.layer(new WeightedListInt(WeightedList.builder().add(UniformInt.of(0, 3), 5).add(UniformInt.of(1, 7), 1).build()), worldgenfeaturestateproviderweighted), BlockColumnConfiguration.layer(ConstantInt.of(1), randomizedintstateprovider)), EnumDirection.DOWN, BlockPredicate.ONLY_IN_AIR_PREDICATE, true));
        FeatureUtils.register(bootstrapcontext, CaveFeatures.MOSS_VEGETATION, WorldGenerator.SIMPLE_BLOCK, new WorldGenFeatureBlockConfiguration(new WorldGenFeatureStateProviderWeighted(WeightedList.builder().add(Blocks.FLOWERING_AZALEA.defaultBlockState(), 4).add(Blocks.AZALEA.defaultBlockState(), 7).add(Blocks.MOSS_CARPET.defaultBlockState(), 25).add(Blocks.SHORT_GRASS.defaultBlockState(), 50).add(Blocks.TALL_GRASS.defaultBlockState(), 10))));
        ...
        FeatureUtils.register(bootstrapcontext, CaveFeatures.SCULK_VEIN, WorldGenerator.MULTIFACE_GROWTH, new MultifaceGrowthConfiguration(multifacespreadeableblock1, 20, true, true, true, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.STONE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRANITE, Blocks.DRIPSTONE_BLOCK, Blocks.CALCITE, Blocks.TUFF, Blocks.DEEPSLATE)));
    }
}
