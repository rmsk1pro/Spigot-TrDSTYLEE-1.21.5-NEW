...
public class TreeFeatures {
    ...
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> PALE_OAK = FeatureUtils.createKey("pale_oak");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> PALE_OAK_BONEMEAL = FeatureUtils.createKey("pale_oak_bonemeal");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> PALE_OAK_CREAKING = FeatureUtils.createKey("pale_oak_creaking");
    ...
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> OAK_BEES_0002_LEAF_LITTER = FeatureUtils.createKey("oak_bees_0002_leaf_litter");
    ...
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> BIRCH_BEES_0002_LEAF_LITTER = FeatureUtils.createKey("birch_bees_0002_leaf_litter");
    ...
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> FANCY_OAK_BEES_0002_LEAF_LITTER = FeatureUtils.createKey("fancy_oak_bees_0002_leaf_litter");
    ...
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> OAK_LEAF_LITTER = FeatureUtils.createKey("oak_leaf_litter");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> DARK_OAK_LEAF_LITTER = FeatureUtils.createKey("dark_oak_leaf_litter");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> BIRCH_LEAF_LITTER = FeatureUtils.createKey("birch_leaf_litter");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> FANCY_OAK_LEAF_LITTER = FeatureUtils.createKey("fancy_oak_leaf_litter");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> FALLEN_OAK_TREE = FeatureUtils.createKey("fallen_oak_tree");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> FALLEN_JUNGLE_TREE = FeatureUtils.createKey("fallen_jungle_tree");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> FALLEN_SPRUCE_TREE = FeatureUtils.createKey("fallen_spruce_tree");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> FALLEN_BIRCH_TREE = FeatureUtils.createKey("fallen_birch_tree");
    public static final ResourceKey<WorldGenFeatureConfigured<?, ?>> FALLEN_SUPER_BIRCH_TREE = FeatureUtils.createKey("fallen_super_birch_tree");
    ...
    private static WorldGenFeatureTreeConfiguration.a createDarkOak() {
        return new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.DARK_OAK_LOG), new TrunkPlacerDarkOak(6, 2, 1), WorldGenFeatureStateProvider.simple(Blocks.DARK_OAK_LEAVES), new WorldGenFoilagePlacerDarkOak(ConstantInt.of(0), ConstantInt.of(0)), new FeatureSizeThreeLayers(1, 1, 0, 1, 2, OptionalInt.empty()));
    }

    private static FallenTreeConfiguration.a createFallenOak() {
        return createFallenTrees(Blocks.OAK_LOG, 4, 7).stumpDecorators(ImmutableList.of(WorldGenFeatureTreeVineTrunk.INSTANCE));
    }

    private static FallenTreeConfiguration.a createFallenBirch(int i) {
        return createFallenTrees(Blocks.BIRCH_LOG, 5, i);
    }

    private static FallenTreeConfiguration.a createFallenJungle() {
        return createFallenTrees(Blocks.JUNGLE_LOG, 4, 11).stumpDecorators(ImmutableList.of(WorldGenFeatureTreeVineTrunk.INSTANCE));
    }

    private static FallenTreeConfiguration.a createFallenSpruce() {
        return createFallenTrees(Blocks.SPRUCE_LOG, 6, 10);
    }

    private static FallenTreeConfiguration.a createFallenTrees(Block block, int i, int j) {
        return (new FallenTreeConfiguration.a(WorldGenFeatureStateProvider.simple(block), UniformInt.of(i, j))).logDecorators(ImmutableList.of(new AttachedToLogsDecorator(0.1F, new WorldGenFeatureStateProviderWeighted(WeightedList.builder().add(Blocks.RED_MUSHROOM.defaultBlockState(), 2).add(Blocks.BROWN_MUSHROOM.defaultBlockState(), 1)), List.of(EnumDirection.UP))));
    }
    ...
    public static void bootstrap(BootstrapContext<WorldGenFeatureConfigured<?, ?>> bootstrapcontext) {
        ...
        FeatureUtils.register(bootstrapcontext, TreeFeatures.CRIMSON_FUNGUS, WorldGenerator.HUGE_FUNGUS, new WorldGenFeatureHugeFungiConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), blockpredicate, false));
        FeatureUtils.register(bootstrapcontext, TreeFeatures.CRIMSON_FUNGUS_PLANTED, WorldGenerator.HUGE_FUNGUS, new WorldGenFeatureHugeFungiConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), blockpredicate, true));
        FeatureUtils.register(bootstrapcontext, TreeFeatures.WARPED_FUNGUS, WorldGenerator.HUGE_FUNGUS, new WorldGenFeatureHugeFungiConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), blockpredicate, false));
        FeatureUtils.register(bootstrapcontext, TreeFeatures.WARPED_FUNGUS_PLANTED, WorldGenerator.HUGE_FUNGUS, new WorldGenFeatureHugeFungiConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), blockpredicate, true));
        FeatureUtils.register(bootstrapcontext, TreeFeatures.HUGE_BROWN_MUSHROOM, WorldGenerator.HUGE_BROWN_MUSHROOM, new WorldGenFeatureMushroomConfiguration(WorldGenFeatureStateProvider.simple((IBlockData) ((IBlockData) Blocks.BROWN_MUSHROOM_BLOCK.defaultBlockState().setValue(BlockHugeMushroom.UP, true)).setValue(BlockHugeMushroom.DOWN, false)), WorldGenFeatureStateProvider.simple((IBlockData) ((IBlockData) Blocks.MUSHROOM_STEM.defaultBlockState().setValue(BlockHugeMushroom.UP, false)).setValue(BlockHugeMushroom.DOWN, false)), 3));
        FeatureUtils.register(bootstrapcontext, TreeFeatures.HUGE_RED_MUSHROOM, WorldGenerator.HUGE_RED_MUSHROOM, new WorldGenFeatureMushroomConfiguration(WorldGenFeatureStateProvider.simple((IBlockData) Blocks.RED_MUSHROOM_BLOCK.defaultBlockState().setValue(BlockHugeMushroom.DOWN, false)), WorldGenFeatureStateProvider.simple((IBlockData) ((IBlockData) Blocks.MUSHROOM_STEM.defaultBlockState().setValue(BlockHugeMushroom.UP, false)).setValue(BlockHugeMushroom.DOWN, false)), 2));
        ...
        PlaceOnGroundDecorator placeongrounddecorator = new PlaceOnGroundDecorator(96, 4, 2, new WorldGenFeatureStateProviderWeighted(VegetationFeatures.leafLitterPatchBuilder(1, 3)));
        PlaceOnGroundDecorator placeongrounddecorator1 = new PlaceOnGroundDecorator(150, 2, 2, new WorldGenFeatureStateProviderWeighted(VegetationFeatures.leafLitterPatchBuilder(1, 4)));

        FeatureUtils.register(bootstrapcontext, TreeFeatures.OAK, WorldGenerator.TREE, createOak().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.DARK_OAK, WorldGenerator.TREE, createDarkOak().ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.PALE_OAK, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.PALE_OAK_LOG), new TrunkPlacerDarkOak(6, 2, 1), WorldGenFeatureStateProvider.simple(Blocks.PALE_OAK_LEAVES), new WorldGenFoilagePlacerDarkOak(ConstantInt.of(0), ConstantInt.of(0)), new FeatureSizeThreeLayers(1, 1, 0, 1, 2, OptionalInt.empty()))).decorators(ImmutableList.of(new PaleMossDecorator(0.15F, 0.4F, 0.8F))).ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.PALE_OAK_BONEMEAL, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.PALE_OAK_LOG), new TrunkPlacerDarkOak(6, 2, 1), WorldGenFeatureStateProvider.simple(Blocks.PALE_OAK_LEAVES), new WorldGenFoilagePlacerDarkOak(ConstantInt.of(0), ConstantInt.of(0)), new FeatureSizeThreeLayers(1, 1, 0, 1, 2, OptionalInt.empty()))).ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.PALE_OAK_CREAKING, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.PALE_OAK_LOG), new TrunkPlacerDarkOak(6, 2, 1), WorldGenFeatureStateProvider.simple(Blocks.PALE_OAK_LEAVES), new WorldGenFoilagePlacerDarkOak(ConstantInt.of(0), ConstantInt.of(0)), new FeatureSizeThreeLayers(1, 1, 0, 1, 2, OptionalInt.empty()))).decorators(ImmutableList.of(new PaleMossDecorator(0.15F, 0.4F, 0.8F), new CreakingHeartDecorator(1.0F))).ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.BIRCH, WorldGenerator.TREE, createBirch().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.ACACIA, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.ACACIA_LOG), new TrunkPlacerForking(5, 2, 2), WorldGenFeatureStateProvider.simple(Blocks.ACACIA_LEAVES), new WorldGenFoilagePlacerAcacia(ConstantInt.of(2), ConstantInt.of(0)), new FeatureSizeTwoLayers(1, 0, 2))).ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.CHERRY, WorldGenerator.TREE, cherry().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.CHERRY_BEES_005, WorldGenerator.TREE, cherry().decorators(List.of(worldgenfeaturetreebeehive3)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.SPRUCE, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.SPRUCE_LOG), new TrunkPlacerStraight(5, 2, 1), WorldGenFeatureStateProvider.simple(Blocks.SPRUCE_LEAVES), new WorldGenFoilagePlacerSpruce(UniformInt.of(2, 3), UniformInt.of(0, 2), UniformInt.of(1, 2)), new FeatureSizeTwoLayers(2, 0, 2))).ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.PINE, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.SPRUCE_LOG), new TrunkPlacerStraight(6, 4, 0), WorldGenFeatureStateProvider.simple(Blocks.SPRUCE_LEAVES), new WorldGenFoilagePlacerPine(ConstantInt.of(1), ConstantInt.of(1), UniformInt.of(3, 4)), new FeatureSizeTwoLayers(2, 0, 2))).ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.JUNGLE_TREE, WorldGenerator.TREE, createJungleTree().decorators(ImmutableList.of(new WorldGenFeatureTreeCocoa(0.2F), WorldGenFeatureTreeVineTrunk.INSTANCE, new WorldGenFeatureTreeVineLeaves(0.25F))).ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FANCY_OAK, WorldGenerator.TREE, createFancyOak().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.JUNGLE_TREE_NO_VINE, WorldGenerator.TREE, createJungleTree().ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.MEGA_JUNGLE_TREE, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.JUNGLE_LOG), new TrunkPlacerMegaJungle(10, 2, 19), WorldGenFeatureStateProvider.simple(Blocks.JUNGLE_LEAVES), new WorldGenFoilagePlacerJungle(ConstantInt.of(2), ConstantInt.of(0), 2), new FeatureSizeTwoLayers(1, 1, 2))).decorators(ImmutableList.of(WorldGenFeatureTreeVineTrunk.INSTANCE, new WorldGenFeatureTreeVineLeaves(0.25F))).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.MEGA_SPRUCE, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.SPRUCE_LOG), new TrunkPlacerGiant(13, 2, 14), WorldGenFeatureStateProvider.simple(Blocks.SPRUCE_LEAVES), new WorldGenFoilagePlacerMegaPine(ConstantInt.of(0), ConstantInt.of(0), UniformInt.of(13, 17)), new FeatureSizeTwoLayers(1, 1, 2))).decorators(ImmutableList.of(new WorldGenFeatureTreeAlterGround(WorldGenFeatureStateProvider.simple(Blocks.PODZOL)))).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.MEGA_PINE, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.SPRUCE_LOG), new TrunkPlacerGiant(13, 2, 14), WorldGenFeatureStateProvider.simple(Blocks.SPRUCE_LEAVES), new WorldGenFoilagePlacerMegaPine(ConstantInt.of(0), ConstantInt.of(0), UniformInt.of(3, 7)), new FeatureSizeTwoLayers(1, 1, 2))).decorators(ImmutableList.of(new WorldGenFeatureTreeAlterGround(WorldGenFeatureStateProvider.simple(Blocks.PODZOL)))).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.SUPER_BIRCH_BEES_0002, WorldGenerator.TREE, createSuperBirch().decorators(ImmutableList.of(worldgenfeaturetreebeehive)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.SUPER_BIRCH_BEES, WorldGenerator.TREE, createSuperBirch().decorators(ImmutableList.of(worldgenfeaturetreebeehive4)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.SWAMP_OAK, WorldGenerator.TREE, createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(ImmutableList.of(new WorldGenFeatureTreeVineLeaves(0.25F))).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.JUNGLE_BUSH, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.JUNGLE_LOG), new TrunkPlacerStraight(1, 0, 0), WorldGenFeatureStateProvider.simple(Blocks.OAK_LEAVES), new WorldGenFoilagePlacerBush(ConstantInt.of(2), ConstantInt.of(1), 2), new FeatureSizeTwoLayers(0, 0, 0))).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.AZALEA_TREE, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.OAK_LOG), new BendingTrunkPlacer(4, 2, 0, 3, UniformInt.of(1, 2)), new WorldGenFeatureStateProviderWeighted(WeightedList.builder().add(Blocks.AZALEA_LEAVES.defaultBlockState(), 3).add(Blocks.FLOWERING_AZALEA_LEAVES.defaultBlockState(), 1)), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 50), new FeatureSizeTwoLayers(1, 0, 1))).dirt(WorldGenFeatureStateProvider.simple(Blocks.ROOTED_DIRT)).forceDirt().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.MANGROVE, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(2, 1, 4, UniformInt.of(1, 4), 0.5F, UniformInt.of(0, 1), holdergetter.getOrThrow(TagsBlock.MANGROVE_LOGS_CAN_GROW_THROUGH)), WorldGenFeatureStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(UniformInt.of(1, 3), WorldGenFeatureStateProvider.simple(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(WorldGenFeatureStateProvider.simple(Blocks.MOSS_CARPET), 0.5F)), new MangroveRootPlacement(holdergetter.getOrThrow(TagsBlock.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), WorldGenFeatureStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2F))), new FeatureSizeTwoLayers(2, 0, 2))).decorators(List.of(new WorldGenFeatureTreeVineLeaves(0.125F), new AttachedToLeavesDecorator(0.14F, 1, 0, new RandomizedIntStateProvider(WorldGenFeatureStateProvider.simple((IBlockData) Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, UniformInt.of(0, 4)), 2, List.of(EnumDirection.DOWN)), worldgenfeaturetreebeehive1)).ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.TALL_MANGROVE, WorldGenerator.TREE, (new WorldGenFeatureTreeConfiguration.a(WorldGenFeatureStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(4, 1, 9, UniformInt.of(1, 6), 0.5F, UniformInt.of(0, 1), holdergetter.getOrThrow(TagsBlock.MANGROVE_LOGS_CAN_GROW_THROUGH)), WorldGenFeatureStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(UniformInt.of(3, 7), WorldGenFeatureStateProvider.simple(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(WorldGenFeatureStateProvider.simple(Blocks.MOSS_CARPET), 0.5F)), new MangroveRootPlacement(holdergetter.getOrThrow(TagsBlock.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), WorldGenFeatureStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2F))), new FeatureSizeTwoLayers(3, 0, 2))).decorators(List.of(new WorldGenFeatureTreeVineLeaves(0.125F), new AttachedToLeavesDecorator(0.14F, 1, 0, new RandomizedIntStateProvider(WorldGenFeatureStateProvider.simple((IBlockData) Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, UniformInt.of(0, 4)), 2, List.of(EnumDirection.DOWN)), worldgenfeaturetreebeehive1)).ignoreVines().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.OAK_BEES_0002_LEAF_LITTER, WorldGenerator.TREE, createOak().decorators(List.of(worldgenfeaturetreebeehive, placeongrounddecorator, placeongrounddecorator1)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.OAK_BEES_002, WorldGenerator.TREE, createOak().decorators(List.of(worldgenfeaturetreebeehive2)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.OAK_BEES_005, WorldGenerator.TREE, createOak().decorators(List.of(worldgenfeaturetreebeehive3)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.BIRCH_BEES_0002, WorldGenerator.TREE, createBirch().decorators(List.of(worldgenfeaturetreebeehive)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.BIRCH_BEES_0002_LEAF_LITTER, WorldGenerator.TREE, createBirch().decorators(List.of(worldgenfeaturetreebeehive, placeongrounddecorator, placeongrounddecorator1)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.BIRCH_BEES_002, WorldGenerator.TREE, createBirch().decorators(List.of(worldgenfeaturetreebeehive2)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.BIRCH_BEES_005, WorldGenerator.TREE, createBirch().decorators(List.of(worldgenfeaturetreebeehive3)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FANCY_OAK_BEES_0002_LEAF_LITTER, WorldGenerator.TREE, createFancyOak().decorators(List.of(worldgenfeaturetreebeehive, placeongrounddecorator, placeongrounddecorator1)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FANCY_OAK_BEES_002, WorldGenerator.TREE, createFancyOak().decorators(List.of(worldgenfeaturetreebeehive2)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FANCY_OAK_BEES_005, WorldGenerator.TREE, createFancyOak().decorators(List.of(worldgenfeaturetreebeehive3)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FANCY_OAK_BEES, WorldGenerator.TREE, createFancyOak().decorators(List.of(worldgenfeaturetreebeehive4)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.OAK_LEAF_LITTER, WorldGenerator.TREE, createOak().decorators(ImmutableList.of(placeongrounddecorator, placeongrounddecorator1)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.DARK_OAK_LEAF_LITTER, WorldGenerator.TREE, createDarkOak().ignoreVines().decorators(ImmutableList.of(placeongrounddecorator, placeongrounddecorator1)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.BIRCH_LEAF_LITTER, WorldGenerator.TREE, createBirch().decorators(ImmutableList.of(placeongrounddecorator, placeongrounddecorator1)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FANCY_OAK_LEAF_LITTER, WorldGenerator.TREE, createFancyOak().decorators(List.of(placeongrounddecorator, placeongrounddecorator1)).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FALLEN_OAK_TREE, WorldGenerator.FALLEN_TREE, createFallenOak().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FALLEN_BIRCH_TREE, WorldGenerator.FALLEN_TREE, createFallenBirch(8).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FALLEN_SUPER_BIRCH_TREE, WorldGenerator.FALLEN_TREE, createFallenBirch(15).build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FALLEN_JUNGLE_TREE, WorldGenerator.FALLEN_TREE, createFallenJungle().build());
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FALLEN_SPRUCE_TREE, WorldGenerator.FALLEN_TREE, createFallenSpruce().build());
    }
}
