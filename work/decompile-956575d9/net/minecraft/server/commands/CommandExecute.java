...
public class CommandExecute {
    ...
    private static final SuggestionProvider<CommandListenerWrapper> SUGGEST_PREDICATE = (commandcontext, suggestionsbuilder) -> {
        ReloadableServerRegistries.a reloadableserverregistries_a = ((CommandListenerWrapper) commandcontext.getSource()).getServer().reloadableRegistries();

        return ICompletionProvider.suggestResource(reloadableserverregistries_a.getKeys(Registries.PREDICATE), suggestionsbuilder);
    };
    ...
    public static void register(CommandDispatcher<CommandListenerWrapper> commanddispatcher, CommandBuildContext commandbuildcontext) {
        ...
        commanddispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) net.minecraft.commands.CommandDispatcher.literal("execute").requires((commandlistenerwrapper) -> {
            ...
            for (Entity entity : ArgumentEntity.getOptionalEntities(commandcontext, "targets")) {
    ...
    private static ArgumentBuilder<CommandListenerWrapper, ?> wrapStores(LiteralCommandNode<CommandListenerWrapper> literalcommandnode, LiteralArgumentBuilder<CommandListenerWrapper> literalargumentbuilder, boolean flag) {
        ...
        for (CommandData.c commanddata_c : CommandData.TARGET_PROVIDERS) {
    ...
    private static ArgumentBuilder<CommandListenerWrapper, ?> addConditionals(CommandNode<CommandListenerWrapper> commandnode, LiteralArgumentBuilder<CommandListenerWrapper> literalargumentbuilder, boolean flag, CommandBuildContext commandbuildcontext) {
        ...
        for (CommandData.c commanddata_c : CommandData.SOURCE_PROVIDERS) {
    ...
    private static boolean checkScore(CommandContext<CommandListenerWrapper> commandcontext, CommandExecute.d commandexecute_d) throws CommandSyntaxException {
        ...
        ReadOnlyScoreInfo readonlyscoreinfo1 = scoreboard.getPlayerScoreInfo(scoreholder1, scoreboardobjective1);

        return readonlyscoreinfo != null && readonlyscoreinfo1 != null ? commandexecute_d.test(readonlyscoreinfo.value(), readonlyscoreinfo1.value()) : false;
    }
    ...
    private static boolean checkCustomPredicate(CommandListenerWrapper commandlistenerwrapper, Holder<LootItemCondition> holder) {
        ...
        loottableinfo.pushVisitedElement(LootTableInfo.createVisitedEntry(holder.value()));
    ...
    private static Collection<CommandListenerWrapper> expect(CommandContext<CommandListenerWrapper> commandcontext, boolean flag, boolean flag1) {
        return (Collection<CommandListenerWrapper>) (flag1 == flag ? Collections.singleton((CommandListenerWrapper) commandcontext.getSource()) : Collections.emptyList());
    }
    ...
    public static <T extends ExecutionCommandSource<T>> void scheduleFunctionConditionsAndTest(T t0, List<T> list, Function<T, T> function, IntPredicate intpredicate, ContextChain<T> contextchain, @Nullable NBTTagCompound nbttagcompound, ExecutionControl<T> executioncontrol, InCommandFunction<CommandContext<T>, Collection<net.minecraft.commands.functions.CommandFunction<T>>> incommandfunction, ChainModifiers chainmodifiers) {
        List<T> list1 = new ArrayList(list.size());

        Collection<net.minecraft.commands.functions.CommandFunction<T>> collection;

        try {
            collection = incommandfunction.apply(contextchain.getTopContext().copyFor(t0));
        } catch (CommandSyntaxException commandsyntaxexception) {
        ...
        if (i != 0) {
            ...
            try {
                for (net.minecraft.commands.functions.CommandFunction<T> net_minecraft_commands_functions_commandfunction : collection) {
                    try {
            ...
            for (T t1 : list) {
                T t2 = (T) (function.apply(t1.clearCallbacks()));
    ...
    private static class c implements CustomModifierExecutor.a<CommandListenerWrapper> {
