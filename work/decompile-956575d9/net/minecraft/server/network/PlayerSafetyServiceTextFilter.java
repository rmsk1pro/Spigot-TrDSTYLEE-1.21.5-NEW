    ...
    protected FilteredText filterText(String s, ServerTextFilter.a servertextfilter_a, JsonObject jsonobject) {
        ...
        if (jsonobject1 == null) {
            ...
            if (!flag) {
                ...
                for (JsonElement jsonelement : ChatDeserializer.getAsJsonArray(jsonobject1, "events", new JsonArray())) {
                    JsonObject jsonobject2 = jsonelement.getAsJsonObject();
                    String s1 = ChatDeserializer.getAsString(jsonobject2, "id", "");
                ...
                JsonArray jsonarray = ChatDeserializer.getAsJsonArray(jsonobject1, "redactedTextIndex", new JsonArray());

                return new FilteredText(s, this.parseMask(s, jsonarray, servertextfilter_a));
            }
        }
    }
