...
class LinkFSPath implements Path {
    ...
    public File toFile() {
        ...
        if (pathcontents instanceof PathContents.b pathcontents_b) {
    ...
    public WatchKey register(WatchService watchservice, WatchEvent.Kind<?>[] awatchevent_kind, Modifier... amodifier) {
    ...
    public PathContents.a getDirectoryContents() {
        ...
        if (pathcontents instanceof PathContents.a pathcontents_a1) {
