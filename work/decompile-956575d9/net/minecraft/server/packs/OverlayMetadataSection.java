...
public record OverlayMetadataSection(List<OverlayMetadataSection.a> overlays) {
    ...
    public static final MetadataSectionType<OverlayMetadataSection> TYPE = new MetadataSectionType<OverlayMetadataSection>("overlays", OverlayMetadataSection.CODEC);
