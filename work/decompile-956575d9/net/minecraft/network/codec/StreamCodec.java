...
public interface StreamCodec<B, V> extends StreamDecoder<B, V>, StreamEncoder<B, V> {
    ...
    default <O> StreamCodec<B, O> map(final Function<? super V, ? extends O> function, final Function<? super O, ? extends V> function1) {
        return new StreamCodec<B, O>() {
            ...
            public O decode(B b0) {
                return (O) function.apply(StreamCodec.this.decode(b0));
            }
    ...
    default <U> StreamCodec<B, U> dispatch(final Function<? super U, ? extends V> function, final Function<? super V, ? extends StreamCodec<? super B, ? extends U>> function1) {
        return new StreamCodec<B, U>() {
            ...
            public U decode(B b0) {
                V v0 = (V) StreamCodec.this.decode(b0);
    ...
    static <B, C, T1> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final Function<T1, C> function1) {
        return new StreamCodec<B, C>() {
            ...
            public C decode(B b0) {
                T1 t1 = (T1) streamcodec.decode(b0);

                return (C) function1.apply(t1);
            }
    ...
    static <B, C, T1, T2> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final StreamCodec<? super B, T2> streamcodec1, final Function<C, T2> function1, final BiFunction<T1, T2, C> bifunction) {
        return new StreamCodec<B, C>() {
            ...
            public C decode(B b0) {
                T1 t1 = (T1) streamcodec.decode(b0);
                T2 t2 = (T2) streamcodec1.decode(b0);

                return (C) bifunction.apply(t1, t2);
            }
    ...
    static <B, C, T1, T2, T3> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final StreamCodec<? super B, T2> streamcodec1, final Function<C, T2> function1, final StreamCodec<? super B, T3> streamcodec2, final Function<C, T3> function2, final Function3<T1, T2, T3, C> function3) {
        return new StreamCodec<B, C>() {
            ...
            public C decode(B b0) {
                T1 t1 = (T1) streamcodec.decode(b0);
                T2 t2 = (T2) streamcodec1.decode(b0);
                T3 t3 = (T3) streamcodec2.decode(b0);

                return (C) function3.apply(t1, t2, t3);
            }
    ...
    static <B, C, T1, T2, T3, T4> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final StreamCodec<? super B, T2> streamcodec1, final Function<C, T2> function1, final StreamCodec<? super B, T3> streamcodec2, final Function<C, T3> function2, final StreamCodec<? super B, T4> streamcodec3, final Function<C, T4> function3, final Function4<T1, T2, T3, T4, C> function4) {
        return new StreamCodec<B, C>() {
            ...
            public C decode(B b0) {
                ...
                T2 t2 = (T2) streamcodec1.decode(b0);
                T3 t3 = (T3) streamcodec2.decode(b0);
                T4 t4 = (T4) streamcodec3.decode(b0);

                return (C) function4.apply(t1, t2, t3, t4);
            }
    ...
    static <B, C, T1, T2, T3, T4, T5> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final StreamCodec<? super B, T2> streamcodec1, final Function<C, T2> function1, final StreamCodec<? super B, T3> streamcodec2, final Function<C, T3> function2, final StreamCodec<? super B, T4> streamcodec3, final Function<C, T4> function3, final StreamCodec<? super B, T5> streamcodec4, final Function<C, T5> function4, final Function5<T1, T2, T3, T4, T5, C> function5) {
        return new StreamCodec<B, C>() {
            ...
            public C decode(B b0) {
                ...
                T3 t3 = (T3) streamcodec2.decode(b0);
                T4 t4 = (T4) streamcodec3.decode(b0);
                T5 t5 = (T5) streamcodec4.decode(b0);

                return (C) function5.apply(t1, t2, t3, t4, t5);
            }
    ...
    static <B, C, T1, T2, T3, T4, T5, T6> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final StreamCodec<? super B, T2> streamcodec1, final Function<C, T2> function1, final StreamCodec<? super B, T3> streamcodec2, final Function<C, T3> function2, final StreamCodec<? super B, T4> streamcodec3, final Function<C, T4> function3, final StreamCodec<? super B, T5> streamcodec4, final Function<C, T5> function4, final StreamCodec<? super B, T6> streamcodec5, final Function<C, T6> function5, final Function6<T1, T2, T3, T4, T5, T6, C> function6) {
        return new StreamCodec<B, C>() {
            ...
            public C decode(B b0) {
                ...
                T4 t4 = (T4) streamcodec3.decode(b0);
                T5 t5 = (T5) streamcodec4.decode(b0);
                T6 t6 = (T6) streamcodec5.decode(b0);

                return (C) function6.apply(t1, t2, t3, t4, t5, t6);
            }
    ...
    static <B, C, T1, T2, T3, T4, T5, T6, T7> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final StreamCodec<? super B, T2> streamcodec1, final Function<C, T2> function1, final StreamCodec<? super B, T3> streamcodec2, final Function<C, T3> function2, final StreamCodec<? super B, T4> streamcodec3, final Function<C, T4> function3, final StreamCodec<? super B, T5> streamcodec4, final Function<C, T5> function4, final StreamCodec<? super B, T6> streamcodec5, final Function<C, T6> function5, final StreamCodec<? super B, T7> streamcodec6, final Function<C, T7> function6, final Function7<T1, T2, T3, T4, T5, T6, T7, C> function7) {
        return new StreamCodec<B, C>() {
            @Override
            public C decode(B b0) {
                T1 t1 = (T1) streamcodec.decode(b0);
                ...
                T5 t5 = (T5) streamcodec4.decode(b0);
                T6 t6 = (T6) streamcodec5.decode(b0);
                T7 t7 = (T7) streamcodec6.decode(b0);

                return (C) function7.apply(t1, t2, t3, t4, t5, t6, t7);
            }
            ...
            public void encode(B b0, C c0) {
                ...
                streamcodec4.encode(b0, function4.apply(c0));
                streamcodec5.encode(b0, function5.apply(c0));
                streamcodec6.encode(b0, function6.apply(c0));
            }
        };
    }

    static <B, C, T1, T2, T3, T4, T5, T6, T7, T8> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final StreamCodec<? super B, T2> streamcodec1, final Function<C, T2> function1, final StreamCodec<? super B, T3> streamcodec2, final Function<C, T3> function2, final StreamCodec<? super B, T4> streamcodec3, final Function<C, T4> function3, final StreamCodec<? super B, T5> streamcodec4, final Function<C, T5> function4, final StreamCodec<? super B, T6> streamcodec5, final Function<C, T6> function5, final StreamCodec<? super B, T7> streamcodec6, final Function<C, T7> function6, final StreamCodec<? super B, T8> streamcodec7, final Function<C, T8> function7, final Function8<T1, T2, T3, T4, T5, T6, T7, T8, C> function8) {
        return new StreamCodec<B, C>() {
            @Override
            public C decode(B b0) {
                T1 t1 = (T1) streamcodec.decode(b0);
                ...
                T6 t6 = (T6) streamcodec5.decode(b0);
                T7 t7 = (T7) streamcodec6.decode(b0);
                T8 t8 = (T8) streamcodec7.decode(b0);

                return (C) function8.apply(t1, t2, t3, t4, t5, t6, t7, t8);
            }
            ...
            public void encode(B b0, C c0) {
                ...
                streamcodec5.encode(b0, function5.apply(c0));
                streamcodec6.encode(b0, function6.apply(c0));
                streamcodec7.encode(b0, function7.apply(c0));
            }
        };
    }

    static <B, C, T1, T2, T3, T4, T5, T6, T7, T8, T9> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final StreamCodec<? super B, T2> streamcodec1, final Function<C, T2> function1, final StreamCodec<? super B, T3> streamcodec2, final Function<C, T3> function2, final StreamCodec<? super B, T4> streamcodec3, final Function<C, T4> function3, final StreamCodec<? super B, T5> streamcodec4, final Function<C, T5> function4, final StreamCodec<? super B, T6> streamcodec5, final Function<C, T6> function5, final StreamCodec<? super B, T7> streamcodec6, final Function<C, T7> function6, final StreamCodec<? super B, T8> streamcodec7, final Function<C, T8> function7, final StreamCodec<? super B, T9> streamcodec8, final Function<C, T9> function8, final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, C> function9) {
        return new StreamCodec<B, C>() {
            @Override
            public C decode(B b0) {
                T1 t1 = (T1) streamcodec.decode(b0);
                ...
                T7 t7 = (T7) streamcodec6.decode(b0);
                T8 t8 = (T8) streamcodec7.decode(b0);
                T9 t9 = (T9) streamcodec8.decode(b0);

                return (C) function9.apply(t1, t2, t3, t4, t5, t6, t7, t8, t9);
            }
            ...
            public void encode(B b0, C c0) {
                ...
                streamcodec6.encode(b0, function6.apply(c0));
                streamcodec7.encode(b0, function7.apply(c0));
                streamcodec8.encode(b0, function8.apply(c0));
            }
        };
    }
