...
public record ClientboundPongResponsePacket(long time) implements Packet<ClientPongPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundPongResponsePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundPongResponsePacket>codec(ClientboundPongResponsePacket::write, ClientboundPongResponsePacket::new);
