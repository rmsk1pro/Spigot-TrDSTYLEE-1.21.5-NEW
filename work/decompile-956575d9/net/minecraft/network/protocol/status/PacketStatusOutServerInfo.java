...
public record PacketStatusOutServerInfo(ServerPing status) implements Packet<PacketStatusOutListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketStatusOutServerInfo> STREAM_CODEC = Packet.<PacketDataSerializer, PacketStatusOutServerInfo>codec(PacketStatusOutServerInfo::write, PacketStatusOutServerInfo::new);
