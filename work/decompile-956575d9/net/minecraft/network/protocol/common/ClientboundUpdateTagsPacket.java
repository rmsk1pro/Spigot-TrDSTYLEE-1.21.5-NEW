...
public class ClientboundUpdateTagsPacket implements Packet<ClientCommonPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundUpdateTagsPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundUpdateTagsPacket>codec(ClientboundUpdateTagsPacket::write, ClientboundUpdateTagsPacket::new);
    ...
    private ClientboundUpdateTagsPacket(PacketDataSerializer packetdataserializer) {
        this.tags = packetdataserializer.<ResourceKey<? extends IRegistry<?>>, TagNetworkSerialization.a>readMap(PacketDataSerializer::readRegistryKey, TagNetworkSerialization.a::read);
    }
