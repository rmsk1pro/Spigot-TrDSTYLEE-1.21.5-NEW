...
public record ServerboundResourcePackPacket(UUID id, ServerboundResourcePackPacket.a action) implements Packet<ServerCommonPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundResourcePackPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundResourcePackPacket>codec(ServerboundResourcePackPacket::write, ServerboundResourcePackPacket::new);
