...
public class ServerboundKeepAlivePacket implements Packet<ServerCommonPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundKeepAlivePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundKeepAlivePacket>codec(ServerboundKeepAlivePacket::write, ServerboundKeepAlivePacket::new);
