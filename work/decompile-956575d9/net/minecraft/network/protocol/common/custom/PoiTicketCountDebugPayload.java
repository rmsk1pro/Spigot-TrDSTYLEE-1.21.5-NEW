...
public record PoiTicketCountDebugPayload(BlockPosition pos, int freeTicketCount) implements CustomPacketPayload {
    ...
    public static final CustomPacketPayload.b<PoiTicketCountDebugPayload> TYPE = CustomPacketPayload.<PoiTicketCountDebugPayload>createType("debug/poi_ticket_count");
