...
public record GameTestClearMarkersDebugPayload() implements CustomPacketPayload {
    ...
    public static final CustomPacketPayload.b<GameTestClearMarkersDebugPayload> TYPE = CustomPacketPayload.<GameTestClearMarkersDebugPayload>createType("debug/game_test_clear");
