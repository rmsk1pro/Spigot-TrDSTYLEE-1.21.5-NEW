...
public record NeighborUpdatesDebugPayload(long time, BlockPosition pos) implements CustomPacketPayload {
    ...
    public static final CustomPacketPayload.b<NeighborUpdatesDebugPayload> TYPE = CustomPacketPayload.<NeighborUpdatesDebugPayload>createType("debug/neighbors_update");
