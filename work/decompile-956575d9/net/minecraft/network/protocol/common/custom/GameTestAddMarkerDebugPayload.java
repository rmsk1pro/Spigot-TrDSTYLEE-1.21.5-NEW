...
public record GameTestAddMarkerDebugPayload(BlockPosition pos, int color, String text, int durationMs) implements CustomPacketPayload {
    ...
    public static final CustomPacketPayload.b<GameTestAddMarkerDebugPayload> TYPE = CustomPacketPayload.<GameTestAddMarkerDebugPayload>createType("debug/game_test_add_marker");
