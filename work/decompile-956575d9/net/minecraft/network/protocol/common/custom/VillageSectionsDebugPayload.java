...
public record VillageSectionsDebugPayload(Set<SectionPosition> villageChunks, Set<SectionPosition> notVillageChunks) implements CustomPacketPayload {
    ...
    public static final CustomPacketPayload.b<VillageSectionsDebugPayload> TYPE = CustomPacketPayload.<VillageSectionsDebugPayload>createType("debug/village_sections");
