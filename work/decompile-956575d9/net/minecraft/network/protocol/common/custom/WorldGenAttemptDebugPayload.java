...
public record WorldGenAttemptDebugPayload(BlockPosition pos, float scale, float red, float green, float blue, float alpha) implements CustomPacketPayload {
    ...
    public static final CustomPacketPayload.b<WorldGenAttemptDebugPayload> TYPE = CustomPacketPayload.<WorldGenAttemptDebugPayload>createType("debug/worldgen_attempt");
