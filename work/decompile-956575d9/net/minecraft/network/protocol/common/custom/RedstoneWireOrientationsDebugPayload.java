...
public record RedstoneWireOrientationsDebugPayload(long time, List<RedstoneWireOrientationsDebugPayload.a> wires) implements CustomPacketPayload {
    ...
    public static final CustomPacketPayload.b<RedstoneWireOrientationsDebugPayload> TYPE = CustomPacketPayload.<RedstoneWireOrientationsDebugPayload>createType("debug/redstone_update_order");
