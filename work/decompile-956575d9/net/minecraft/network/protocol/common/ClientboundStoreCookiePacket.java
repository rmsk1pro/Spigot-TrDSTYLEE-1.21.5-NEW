...
public record ClientboundStoreCookiePacket(MinecraftKey key, byte[] payload) implements Packet<ClientCommonPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundStoreCookiePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundStoreCookiePacket>codec(ClientboundStoreCookiePacket::write, ClientboundStoreCookiePacket::new);
