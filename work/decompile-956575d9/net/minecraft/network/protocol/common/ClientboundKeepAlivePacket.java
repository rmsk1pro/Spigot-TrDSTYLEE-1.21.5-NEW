...
public class ClientboundKeepAlivePacket implements Packet<ClientCommonPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundKeepAlivePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundKeepAlivePacket>codec(ClientboundKeepAlivePacket::write, ClientboundKeepAlivePacket::new);
