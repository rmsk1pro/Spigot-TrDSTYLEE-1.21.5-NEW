...
public class ServerboundPongPacket implements Packet<ServerCommonPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundPongPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundPongPacket>codec(ServerboundPongPacket::write, ServerboundPongPacket::new);
