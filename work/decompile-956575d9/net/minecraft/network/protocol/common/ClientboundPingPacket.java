...
public class ClientboundPingPacket implements Packet<ClientCommonPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundPingPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundPingPacket>codec(ClientboundPingPacket::write, ClientboundPingPacket::new);
