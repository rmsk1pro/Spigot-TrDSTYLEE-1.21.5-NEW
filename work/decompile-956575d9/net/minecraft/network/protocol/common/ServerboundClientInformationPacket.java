...
public record ServerboundClientInformationPacket(ClientInformation information) implements Packet<ServerCommonPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundClientInformationPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundClientInformationPacket>codec(ServerboundClientInformationPacket::write, ServerboundClientInformationPacket::new);
