...
public record ClientboundResourcePackPopPacket(Optional<UUID> id) implements Packet<ClientCommonPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundResourcePackPopPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundResourcePackPopPacket>codec(ClientboundResourcePackPopPacket::write, ClientboundResourcePackPopPacket::new);
