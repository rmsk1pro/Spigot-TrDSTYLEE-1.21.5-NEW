...
public class ProtocolCodecBuilder<B extends ByteBuf, L extends PacketListener> {
    ...
    private final IdDispatchCodec.a<B, Packet<? super L>, PacketType<? extends Packet<? super L>>> dispatchBuilder = IdDispatchCodec.<B, Packet<? super L>, PacketType<? extends Packet<? super L>>>builder(Packet::type);
