...
public class ConfigurationProtocols {
    ...
    public static final SimpleUnboundProtocol<ServerConfigurationPacketListener, PacketDataSerializer> SERVERBOUND_TEMPLATE = ProtocolInfoBuilder.<ServerConfigurationPacketListener, PacketDataSerializer>serverboundProtocol(EnumProtocol.CONFIGURATION, (protocolinfobuilder) -> {
    ...
    public static final ProtocolInfo<ServerConfigurationPacketListener> SERVERBOUND = ConfigurationProtocols.SERVERBOUND_TEMPLATE.bind(PacketDataSerializer::new);
    public static final SimpleUnboundProtocol<ClientConfigurationPacketListener, PacketDataSerializer> CLIENTBOUND_TEMPLATE = ProtocolInfoBuilder.<ClientConfigurationPacketListener, PacketDataSerializer>clientboundProtocol(EnumProtocol.CONFIGURATION, (protocolinfobuilder) -> {
    ...
    public static final ProtocolInfo<ClientConfigurationPacketListener> CLIENTBOUND = ConfigurationProtocols.CLIENTBOUND_TEMPLATE.bind(PacketDataSerializer::new);
