...
public record ClientboundUpdateEnabledFeaturesPacket(Set<MinecraftKey> features) implements Packet<ClientConfigurationPacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundUpdateEnabledFeaturesPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundUpdateEnabledFeaturesPacket>codec(ClientboundUpdateEnabledFeaturesPacket::write, ClientboundUpdateEnabledFeaturesPacket::new);
