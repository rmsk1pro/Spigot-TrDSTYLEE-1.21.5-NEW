...
public record PacketHandshakingInSetProtocol(int protocolVersion, String hostName, int port, ClientIntent intention) implements Packet<PacketHandshakingInListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketHandshakingInSetProtocol> STREAM_CODEC = Packet.<PacketDataSerializer, PacketHandshakingInSetProtocol>codec(PacketHandshakingInSetProtocol::write, PacketHandshakingInSetProtocol::new);
