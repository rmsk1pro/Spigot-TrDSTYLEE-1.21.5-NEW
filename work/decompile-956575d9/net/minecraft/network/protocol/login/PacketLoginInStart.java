...
public record PacketLoginInStart(String name, UUID profileId) implements Packet<PacketLoginInListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketLoginInStart> STREAM_CODEC = Packet.<PacketDataSerializer, PacketLoginInStart>codec(PacketLoginInStart::write, PacketLoginInStart::new);
