...
public record ServerboundCustomQueryAnswerPacket(int transactionId, @Nullable CustomQueryAnswerPayload payload) implements Packet<PacketLoginInListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundCustomQueryAnswerPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundCustomQueryAnswerPacket>codec(ServerboundCustomQueryAnswerPacket::write, ServerboundCustomQueryAnswerPacket::read);
