...
public class PacketLoginInEncryptionBegin implements Packet<PacketLoginInListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketLoginInEncryptionBegin> STREAM_CODEC = Packet.<PacketDataSerializer, PacketLoginInEncryptionBegin>codec(PacketLoginInEncryptionBegin::write, PacketLoginInEncryptionBegin::new);
