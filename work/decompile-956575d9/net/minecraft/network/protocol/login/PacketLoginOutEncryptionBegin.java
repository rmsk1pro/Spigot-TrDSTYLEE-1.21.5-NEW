...
public class PacketLoginOutEncryptionBegin implements Packet<PacketLoginOutListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketLoginOutEncryptionBegin> STREAM_CODEC = Packet.<PacketDataSerializer, PacketLoginOutEncryptionBegin>codec(PacketLoginOutEncryptionBegin::write, PacketLoginOutEncryptionBegin::new);
