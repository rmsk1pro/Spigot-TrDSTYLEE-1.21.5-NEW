...
public record PacketLoginOutCustomPayload(int transactionId, CustomQueryPayload payload) implements Packet<PacketLoginOutListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketLoginOutCustomPayload> STREAM_CODEC = Packet.<PacketDataSerializer, PacketLoginOutCustomPayload>codec(PacketLoginOutCustomPayload::write, PacketLoginOutCustomPayload::new);
