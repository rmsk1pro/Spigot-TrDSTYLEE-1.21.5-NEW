...
public class PacketLoginOutSetCompression implements Packet<PacketLoginOutListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketLoginOutSetCompression> STREAM_CODEC = Packet.<PacketDataSerializer, PacketLoginOutSetCompression>codec(PacketLoginOutSetCompression::write, PacketLoginOutSetCompression::new);
