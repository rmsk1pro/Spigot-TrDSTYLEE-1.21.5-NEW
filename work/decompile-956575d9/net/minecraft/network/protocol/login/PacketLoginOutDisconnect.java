...
public class PacketLoginOutDisconnect implements Packet<PacketLoginOutListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketLoginOutDisconnect> STREAM_CODEC = Packet.<PacketDataSerializer, PacketLoginOutDisconnect>codec(PacketLoginOutDisconnect::write, PacketLoginOutDisconnect::new);
