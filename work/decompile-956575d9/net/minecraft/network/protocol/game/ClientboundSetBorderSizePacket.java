...
public class ClientboundSetBorderSizePacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundSetBorderSizePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundSetBorderSizePacket>codec(ClientboundSetBorderSizePacket::write, ClientboundSetBorderSizePacket::new);
