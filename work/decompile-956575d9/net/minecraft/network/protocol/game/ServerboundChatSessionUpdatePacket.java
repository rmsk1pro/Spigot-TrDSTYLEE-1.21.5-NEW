...
public record ServerboundChatSessionUpdatePacket(RemoteChatSession.a chatSession) implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundChatSessionUpdatePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundChatSessionUpdatePacket>codec(ServerboundChatSessionUpdatePacket::write, ServerboundChatSessionUpdatePacket::new);
