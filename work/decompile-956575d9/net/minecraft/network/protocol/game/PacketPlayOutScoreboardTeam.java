...
public class PacketPlayOutScoreboardTeam implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, PacketPlayOutScoreboardTeam> STREAM_CODEC = Packet.<RegistryFriendlyByteBuf, PacketPlayOutScoreboardTeam>codec(PacketPlayOutScoreboardTeam::write, PacketPlayOutScoreboardTeam::new);
    ...
    private PacketPlayOutScoreboardTeam(RegistryFriendlyByteBuf registryfriendlybytebuf) {
        ...
        if (shouldHavePlayerList(this.method)) {
            this.players = registryfriendlybytebuf.<String>readList(PacketDataSerializer::readUtf);
        } else {
    ...
    public static class b {
        ...
        private final ScoreboardTeamBase.EnumNameTagVisibility nametagVisibility;
        private final ScoreboardTeamBase.EnumTeamPush collisionRule;
        ...
        public b(ScoreboardTeam scoreboardteam) {
            ...
            this.nametagVisibility = scoreboardteam.getNameTagVisibility();
            this.collisionRule = scoreboardteam.getCollisionRule();
        ...
        public b(RegistryFriendlyByteBuf registryfriendlybytebuf) {
            ...
            this.nametagVisibility = (ScoreboardTeamBase.EnumNameTagVisibility) ScoreboardTeamBase.EnumNameTagVisibility.STREAM_CODEC.decode(registryfriendlybytebuf);
            this.collisionRule = (ScoreboardTeamBase.EnumTeamPush) ScoreboardTeamBase.EnumTeamPush.STREAM_CODEC.decode(registryfriendlybytebuf);
        ...
        public void write(RegistryFriendlyByteBuf registryfriendlybytebuf) {
            ...
            ScoreboardTeamBase.EnumNameTagVisibility.STREAM_CODEC.encode(registryfriendlybytebuf, this.nametagVisibility);
            ScoreboardTeamBase.EnumTeamPush.STREAM_CODEC.encode(registryfriendlybytebuf, this.collisionRule);
