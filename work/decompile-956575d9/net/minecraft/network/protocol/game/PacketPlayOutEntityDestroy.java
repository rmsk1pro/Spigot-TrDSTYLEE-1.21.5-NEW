...
public class PacketPlayOutEntityDestroy implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutEntityDestroy> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutEntityDestroy>codec(PacketPlayOutEntityDestroy::write, PacketPlayOutEntityDestroy::new);
