...
public class PacketPlayInBlockPlace implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInBlockPlace> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInBlockPlace>codec(PacketPlayInBlockPlace::write, PacketPlayInBlockPlace::new);
