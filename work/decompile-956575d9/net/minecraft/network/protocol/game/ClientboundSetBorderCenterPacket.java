...
public class ClientboundSetBorderCenterPacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundSetBorderCenterPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundSetBorderCenterPacket>codec(ClientboundSetBorderCenterPacket::write, ClientboundSetBorderCenterPacket::new);
