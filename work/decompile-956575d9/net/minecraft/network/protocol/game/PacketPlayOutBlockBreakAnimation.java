...
public class PacketPlayOutBlockBreakAnimation implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutBlockBreakAnimation> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutBlockBreakAnimation>codec(PacketPlayOutBlockBreakAnimation::write, PacketPlayOutBlockBreakAnimation::new);
