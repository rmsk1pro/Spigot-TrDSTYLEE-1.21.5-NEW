...
public record PacketPlayOutUnloadChunk(ChunkCoordIntPair pos) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutUnloadChunk> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutUnloadChunk>codec(PacketPlayOutUnloadChunk::write, PacketPlayOutUnloadChunk::new);
