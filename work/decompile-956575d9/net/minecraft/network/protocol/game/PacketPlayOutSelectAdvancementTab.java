...
public class PacketPlayOutSelectAdvancementTab implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutSelectAdvancementTab> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutSelectAdvancementTab>codec(PacketPlayOutSelectAdvancementTab::write, PacketPlayOutSelectAdvancementTab::new);
    @Nullable
