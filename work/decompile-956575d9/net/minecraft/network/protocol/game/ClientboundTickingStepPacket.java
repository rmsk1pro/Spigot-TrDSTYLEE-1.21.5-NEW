...
public record ClientboundTickingStepPacket(int tickSteps) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundTickingStepPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundTickingStepPacket>codec(ClientboundTickingStepPacket::write, ClientboundTickingStepPacket::new);
