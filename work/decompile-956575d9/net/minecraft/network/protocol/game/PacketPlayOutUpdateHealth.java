...
public class PacketPlayOutUpdateHealth implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutUpdateHealth> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutUpdateHealth>codec(PacketPlayOutUpdateHealth::write, PacketPlayOutUpdateHealth::new);
