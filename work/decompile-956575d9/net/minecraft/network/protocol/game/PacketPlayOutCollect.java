...
public class PacketPlayOutCollect implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutCollect> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutCollect>codec(PacketPlayOutCollect::write, PacketPlayOutCollect::new);
