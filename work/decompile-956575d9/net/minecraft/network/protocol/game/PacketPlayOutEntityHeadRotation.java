...
public class PacketPlayOutEntityHeadRotation implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutEntityHeadRotation> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutEntityHeadRotation>codec(PacketPlayOutEntityHeadRotation::write, PacketPlayOutEntityHeadRotation::new);
