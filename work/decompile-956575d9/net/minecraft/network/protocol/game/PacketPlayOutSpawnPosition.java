...
public class PacketPlayOutSpawnPosition implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutSpawnPosition> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutSpawnPosition>codec(PacketPlayOutSpawnPosition::write, PacketPlayOutSpawnPosition::new);
