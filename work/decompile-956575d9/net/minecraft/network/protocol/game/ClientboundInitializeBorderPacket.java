...
public class ClientboundInitializeBorderPacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundInitializeBorderPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundInitializeBorderPacket>codec(ClientboundInitializeBorderPacket::write, ClientboundInitializeBorderPacket::new);
