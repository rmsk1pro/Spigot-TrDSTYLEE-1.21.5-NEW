...
public record ClientboundDebugSamplePacket(long[] sample, RemoteDebugSampleType debugSampleType) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundDebugSamplePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundDebugSamplePacket>codec(ClientboundDebugSamplePacket::write, ClientboundDebugSamplePacket::new);
