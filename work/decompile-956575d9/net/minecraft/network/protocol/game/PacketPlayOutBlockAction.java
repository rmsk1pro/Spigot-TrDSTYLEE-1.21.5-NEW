...
public class PacketPlayOutBlockAction implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, PacketPlayOutBlockAction> STREAM_CODEC = Packet.<RegistryFriendlyByteBuf, PacketPlayOutBlockAction>codec(PacketPlayOutBlockAction::write, PacketPlayOutBlockAction::new);
