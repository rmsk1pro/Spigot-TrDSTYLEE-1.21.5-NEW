...
public class PacketPlayInBlockDig implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInBlockDig> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInBlockDig>codec(PacketPlayInBlockDig::write, PacketPlayInBlockDig::new);
