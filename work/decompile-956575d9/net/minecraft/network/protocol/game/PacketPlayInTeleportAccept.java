...
public class PacketPlayInTeleportAccept implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInTeleportAccept> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInTeleportAccept>codec(PacketPlayInTeleportAccept::write, PacketPlayInTeleportAccept::new);
