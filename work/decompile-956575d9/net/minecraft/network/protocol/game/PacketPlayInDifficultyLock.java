...
public class PacketPlayInDifficultyLock implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInDifficultyLock> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInDifficultyLock>codec(PacketPlayInDifficultyLock::write, PacketPlayInDifficultyLock::new);
