...
public record ClientboundHurtAnimationPacket(int id, float yaw) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundHurtAnimationPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundHurtAnimationPacket>codec(ClientboundHurtAnimationPacket::write, ClientboundHurtAnimationPacket::new);
