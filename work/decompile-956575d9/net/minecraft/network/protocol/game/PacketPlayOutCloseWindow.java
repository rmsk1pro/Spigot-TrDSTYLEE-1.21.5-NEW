...
public class PacketPlayOutCloseWindow implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutCloseWindow> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutCloseWindow>codec(PacketPlayOutCloseWindow::write, PacketPlayOutCloseWindow::new);
