...
public abstract class PacketPlayOutEntity implements Packet<PacketListenerPlayOut> {
    ...
    public static class PacketPlayOutRelEntityMoveLook extends PacketPlayOutEntity {
        ...
        public static final StreamCodec<PacketDataSerializer, PacketPlayOutEntity.PacketPlayOutRelEntityMoveLook> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutEntity.PacketPlayOutRelEntityMoveLook>codec(PacketPlayOutEntity.PacketPlayOutRelEntityMoveLook::write, PacketPlayOutEntity.PacketPlayOutRelEntityMoveLook::read);
    ...
    public static class PacketPlayOutRelEntityMove extends PacketPlayOutEntity {
        ...
        public static final StreamCodec<PacketDataSerializer, PacketPlayOutEntity.PacketPlayOutRelEntityMove> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutEntity.PacketPlayOutRelEntityMove>codec(PacketPlayOutEntity.PacketPlayOutRelEntityMove::write, PacketPlayOutEntity.PacketPlayOutRelEntityMove::read);
    ...
    public static class PacketPlayOutEntityLook extends PacketPlayOutEntity {
        ...
        public static final StreamCodec<PacketDataSerializer, PacketPlayOutEntity.PacketPlayOutEntityLook> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutEntity.PacketPlayOutEntityLook>codec(PacketPlayOutEntity.PacketPlayOutEntityLook::write, PacketPlayOutEntity.PacketPlayOutEntityLook::read);
