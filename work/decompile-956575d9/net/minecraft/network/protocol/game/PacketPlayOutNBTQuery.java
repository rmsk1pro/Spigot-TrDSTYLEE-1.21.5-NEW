...
public class PacketPlayOutNBTQuery implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutNBTQuery> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutNBTQuery>codec(PacketPlayOutNBTQuery::write, PacketPlayOutNBTQuery::new);
