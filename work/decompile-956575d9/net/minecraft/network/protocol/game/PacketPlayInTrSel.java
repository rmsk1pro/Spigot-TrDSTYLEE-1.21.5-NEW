...
public class PacketPlayInTrSel implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInTrSel> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInTrSel>codec(PacketPlayInTrSel::write, PacketPlayInTrSel::new);
