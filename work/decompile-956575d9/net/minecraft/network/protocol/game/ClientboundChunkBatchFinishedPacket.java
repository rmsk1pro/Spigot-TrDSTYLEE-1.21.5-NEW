...
public record ClientboundChunkBatchFinishedPacket(int batchSize) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundChunkBatchFinishedPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundChunkBatchFinishedPacket>codec(ClientboundChunkBatchFinishedPacket::write, ClientboundChunkBatchFinishedPacket::new);
