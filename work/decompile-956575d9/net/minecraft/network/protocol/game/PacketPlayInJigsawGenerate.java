...
public class PacketPlayInJigsawGenerate implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInJigsawGenerate> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInJigsawGenerate>codec(PacketPlayInJigsawGenerate::write, PacketPlayInJigsawGenerate::new);
