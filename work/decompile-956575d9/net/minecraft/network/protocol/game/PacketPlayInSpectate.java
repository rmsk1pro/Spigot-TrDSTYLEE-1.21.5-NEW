...
public class PacketPlayInSpectate implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInSpectate> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInSpectate>codec(PacketPlayInSpectate::write, PacketPlayInSpectate::new);
