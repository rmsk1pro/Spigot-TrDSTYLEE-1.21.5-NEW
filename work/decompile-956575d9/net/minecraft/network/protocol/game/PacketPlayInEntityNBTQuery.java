...
public class PacketPlayInEntityNBTQuery implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInEntityNBTQuery> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInEntityNBTQuery>codec(PacketPlayInEntityNBTQuery::write, PacketPlayInEntityNBTQuery::new);
