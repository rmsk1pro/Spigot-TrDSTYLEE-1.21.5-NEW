...
public class PacketPlayOutCommands implements Packet<PacketListenerPlayOut> {
    ...
    private static List<PacketPlayOutCommands.b> createEntries(Object2IntMap<CommandNode<ICompletionProvider>> object2intmap) {
        ...
        while (objectiterator.hasNext()) {
            Object2IntMap.Entry<CommandNode<ICompletionProvider>> object2intmap_entry = (Entry) objectiterator.next();

            objectarraylist.set(object2intmap_entry.getIntValue(), createEntry((CommandNode) object2intmap_entry.getKey(), object2intmap));
        }
    ...
    private static PacketPlayOutCommands.b createEntry(CommandNode<ICompletionProvider> commandnode, Object2IntMap<CommandNode<ICompletionProvider>> object2intmap) {
        ...
        PacketPlayOutCommands.e packetplayoutcommands_e;

        if (commandnode instanceof RootCommandNode) {
            i |= 0;
            packetplayoutcommands_e = null;
        } else if (commandnode instanceof ArgumentCommandNode) {
            ArgumentCommandNode<ICompletionProvider, ?> argumentcommandnode = (ArgumentCommandNode) commandnode;

            packetplayoutcommands_e = new PacketPlayOutCommands.a(argumentcommandnode);
            i |= 2;
            ...
            packetplayoutcommands_e = new PacketPlayOutCommands.c(literalcommandnode.getLiteral());
            i |= 1;
        }
        ...
        return new PacketPlayOutCommands.b(packetplayoutcommands_e, i, j, aint);
    }
        ...
        public CommandNode<ICompletionProvider> resolve(int i) {
            ...
            if (commandnode != null) {
                ...
                for (int j : packetplayoutcommands_b.children) {
                    CommandNode<ICompletionProvider> commandnode2 = this.resolve(j);
