...
public record ClientboundResetScorePacket(String owner, @Nullable String objectiveName) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundResetScorePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundResetScorePacket>codec(ClientboundResetScorePacket::write, ClientboundResetScorePacket::new);
