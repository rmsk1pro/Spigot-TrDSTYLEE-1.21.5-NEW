...
public record ClientboundDeleteChatPacket(MessageSignature.a messageSignature) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundDeleteChatPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundDeleteChatPacket>codec(ClientboundDeleteChatPacket::write, ClientboundDeleteChatPacket::new);
