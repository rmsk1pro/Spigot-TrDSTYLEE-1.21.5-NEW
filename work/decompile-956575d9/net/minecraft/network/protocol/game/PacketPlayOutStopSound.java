...
public class PacketPlayOutStopSound implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutStopSound> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutStopSound>codec(PacketPlayOutStopSound::write, PacketPlayOutStopSound::new);
