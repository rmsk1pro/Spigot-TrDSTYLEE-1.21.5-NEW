...
public class PacketPlayInUseEntity implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInUseEntity> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInUseEntity>codec(PacketPlayInUseEntity::write, PacketPlayInUseEntity::new);
    ...
    @Override
    public PacketType<PacketPlayInUseEntity> type() {
    ...
    private static enum b {
        ...
        private b(final Function function) {
