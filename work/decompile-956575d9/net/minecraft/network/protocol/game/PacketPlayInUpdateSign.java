...
public class PacketPlayInUpdateSign implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInUpdateSign> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInUpdateSign>codec(PacketPlayInUpdateSign::write, PacketPlayInUpdateSign::new);
