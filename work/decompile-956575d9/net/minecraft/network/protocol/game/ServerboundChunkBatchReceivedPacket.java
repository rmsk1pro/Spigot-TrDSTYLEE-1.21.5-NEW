...
public record ServerboundChunkBatchReceivedPacket(float desiredChunksPerTick) implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundChunkBatchReceivedPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundChunkBatchReceivedPacket>codec(ServerboundChunkBatchReceivedPacket::write, ServerboundChunkBatchReceivedPacket::new);
