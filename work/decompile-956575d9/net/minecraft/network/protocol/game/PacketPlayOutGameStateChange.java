...
public class PacketPlayOutGameStateChange implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutGameStateChange> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutGameStateChange>codec(PacketPlayOutGameStateChange::write, PacketPlayOutGameStateChange::new);
    ...
    public static final PacketPlayOutGameStateChange.a PLAY_ARROW_HIT_SOUND = new PacketPlayOutGameStateChange.a(6);
    ...
    @Override
    public PacketType<PacketPlayOutGameStateChange> type() {
