...
public class PacketPlayInHeldItemSlot implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInHeldItemSlot> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInHeldItemSlot>codec(PacketPlayInHeldItemSlot::write, PacketPlayInHeldItemSlot::new);
