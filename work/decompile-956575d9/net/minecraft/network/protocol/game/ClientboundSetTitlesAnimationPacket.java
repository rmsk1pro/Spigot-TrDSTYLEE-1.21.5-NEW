...
public class ClientboundSetTitlesAnimationPacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundSetTitlesAnimationPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundSetTitlesAnimationPacket>codec(ClientboundSetTitlesAnimationPacket::write, ClientboundSetTitlesAnimationPacket::new);
