...
public class PacketPlayInBoatMove implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInBoatMove> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInBoatMove>codec(PacketPlayInBoatMove::write, PacketPlayInBoatMove::new);
