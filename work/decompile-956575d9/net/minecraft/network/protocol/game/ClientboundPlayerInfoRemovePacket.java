...
public record ClientboundPlayerInfoRemovePacket(List<UUID> profileIds) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundPlayerInfoRemovePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundPlayerInfoRemovePacket>codec(ClientboundPlayerInfoRemovePacket::write, ClientboundPlayerInfoRemovePacket::new);
