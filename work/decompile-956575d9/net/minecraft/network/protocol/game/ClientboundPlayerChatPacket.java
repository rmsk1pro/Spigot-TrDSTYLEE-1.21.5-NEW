...
public record ClientboundPlayerChatPacket(int globalIndex, UUID sender, int index, @Nullable MessageSignature signature, SignedMessageBody.a body, @Nullable IChatBaseComponent unsignedContent, FilterMask filterMask, ChatMessageType.a chatType) implements Packet<PacketListenerPlayOut> {
    ...
    private ClientboundPlayerChatPacket(RegistryFriendlyByteBuf registryfriendlybytebuf) {
        this(registryfriendlybytebuf.readVarInt(), registryfriendlybytebuf.readUUID(), registryfriendlybytebuf.readVarInt(), (MessageSignature) registryfriendlybytebuf.readNullable(MessageSignature::read), new SignedMessageBody.a(registryfriendlybytebuf), (IChatBaseComponent) PacketDataSerializer.readNullable(registryfriendlybytebuf, ComponentSerialization.TRUSTED_STREAM_CODEC), FilterMask.read(registryfriendlybytebuf), (ChatMessageType.a) ChatMessageType.a.STREAM_CODEC.decode(registryfriendlybytebuf));
    }
