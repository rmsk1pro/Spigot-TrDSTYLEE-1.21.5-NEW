...
public class PacketPlayOutLookAt implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutLookAt> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutLookAt>codec(PacketPlayOutLookAt::write, PacketPlayOutLookAt::new);
    ...
    @Override
    public PacketType<PacketPlayOutLookAt> type() {
