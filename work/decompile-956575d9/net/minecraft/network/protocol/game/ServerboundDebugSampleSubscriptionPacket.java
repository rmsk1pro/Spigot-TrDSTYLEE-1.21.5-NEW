...
public record ServerboundDebugSampleSubscriptionPacket(RemoteDebugSampleType sampleType) implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundDebugSampleSubscriptionPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundDebugSampleSubscriptionPacket>codec(ServerboundDebugSampleSubscriptionPacket::write, ServerboundDebugSampleSubscriptionPacket::new);
