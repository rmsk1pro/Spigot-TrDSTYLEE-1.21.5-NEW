...
public class PacketPlayOutOpenWindowHorse implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutOpenWindowHorse> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutOpenWindowHorse>codec(PacketPlayOutOpenWindowHorse::write, PacketPlayOutOpenWindowHorse::new);
    ...
    private PacketPlayOutOpenWindowHorse(PacketDataSerializer packetdataserializer) {
        this.containerId = packetdataserializer.readContainerId();
