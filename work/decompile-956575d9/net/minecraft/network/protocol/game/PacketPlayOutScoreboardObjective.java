...
public class PacketPlayOutScoreboardObjective implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, PacketPlayOutScoreboardObjective> STREAM_CODEC = Packet.<RegistryFriendlyByteBuf, PacketPlayOutScoreboardObjective>codec(PacketPlayOutScoreboardObjective::write, PacketPlayOutScoreboardObjective::new);
