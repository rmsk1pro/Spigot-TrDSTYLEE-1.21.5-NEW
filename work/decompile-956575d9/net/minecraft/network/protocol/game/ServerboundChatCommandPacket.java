...
public record ServerboundChatCommandPacket(String command) implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundChatCommandPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundChatCommandPacket>codec(ServerboundChatCommandPacket::write, ServerboundChatCommandPacket::new);
