...
public class PacketPlayInAbilities implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInAbilities> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInAbilities>codec(PacketPlayInAbilities::write, PacketPlayInAbilities::new);
