...
public class PacketPlayOutAttachEntity implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutAttachEntity> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutAttachEntity>codec(PacketPlayOutAttachEntity::write, PacketPlayOutAttachEntity::new);
