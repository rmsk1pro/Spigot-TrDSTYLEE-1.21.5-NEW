...
public class PacketPlayOutOpenBook implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutOpenBook> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutOpenBook>codec(PacketPlayOutOpenBook::write, PacketPlayOutOpenBook::new);
