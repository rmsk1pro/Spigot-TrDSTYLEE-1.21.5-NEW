...
public class PacketPlayInClientCommand implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInClientCommand> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInClientCommand>codec(PacketPlayInClientCommand::write, PacketPlayInClientCommand::new);
