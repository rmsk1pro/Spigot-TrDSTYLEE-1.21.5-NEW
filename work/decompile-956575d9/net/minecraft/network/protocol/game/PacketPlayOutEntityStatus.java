...
public class PacketPlayOutEntityStatus implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutEntityStatus> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutEntityStatus>codec(PacketPlayOutEntityStatus::write, PacketPlayOutEntityStatus::new);
