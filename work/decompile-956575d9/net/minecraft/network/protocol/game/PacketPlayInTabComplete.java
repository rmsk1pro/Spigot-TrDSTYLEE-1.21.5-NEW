...
public class PacketPlayInTabComplete implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInTabComplete> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInTabComplete>codec(PacketPlayInTabComplete::write, PacketPlayInTabComplete::new);
