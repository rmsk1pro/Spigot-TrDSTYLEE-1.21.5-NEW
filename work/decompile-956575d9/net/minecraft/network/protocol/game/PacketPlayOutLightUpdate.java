...
public class PacketPlayOutLightUpdate implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutLightUpdate> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutLightUpdate>codec(PacketPlayOutLightUpdate::write, PacketPlayOutLightUpdate::new);
    private final int x;
    private final int z;
