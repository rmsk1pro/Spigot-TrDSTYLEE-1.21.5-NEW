...
public class PacketPlayOutExperience implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutExperience> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutExperience>codec(PacketPlayOutExperience::write, PacketPlayOutExperience::new);
