...
public class PacketPlayInUseItem implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInUseItem> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInUseItem>codec(PacketPlayInUseItem::write, PacketPlayInUseItem::new);
