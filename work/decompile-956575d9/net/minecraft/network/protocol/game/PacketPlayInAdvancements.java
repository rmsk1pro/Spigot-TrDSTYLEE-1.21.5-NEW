...
public class PacketPlayInAdvancements implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInAdvancements> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInAdvancements>codec(PacketPlayInAdvancements::write, PacketPlayInAdvancements::new);
