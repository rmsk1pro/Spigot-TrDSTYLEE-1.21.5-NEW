...
public class PacketPlayInArmAnimation implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInArmAnimation> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInArmAnimation>codec(PacketPlayInArmAnimation::write, PacketPlayInArmAnimation::new);
