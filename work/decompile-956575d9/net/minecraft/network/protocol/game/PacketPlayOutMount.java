...
public class PacketPlayOutMount implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutMount> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutMount>codec(PacketPlayOutMount::write, PacketPlayOutMount::new);
