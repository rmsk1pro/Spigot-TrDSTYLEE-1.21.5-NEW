...
public class ClientboundPlayerCombatEndPacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundPlayerCombatEndPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundPlayerCombatEndPacket>codec(ClientboundPlayerCombatEndPacket::write, ClientboundPlayerCombatEndPacket::new);
