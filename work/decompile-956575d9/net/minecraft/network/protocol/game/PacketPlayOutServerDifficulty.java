...
public class PacketPlayOutServerDifficulty implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutServerDifficulty> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutServerDifficulty>codec(PacketPlayOutServerDifficulty::write, PacketPlayOutServerDifficulty::new);
