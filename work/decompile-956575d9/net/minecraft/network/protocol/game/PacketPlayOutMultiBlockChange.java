...
public class PacketPlayOutMultiBlockChange implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutMultiBlockChange> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutMultiBlockChange>codec(PacketPlayOutMultiBlockChange::write, PacketPlayOutMultiBlockChange::new);
