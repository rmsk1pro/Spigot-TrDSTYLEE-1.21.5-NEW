...
public record ClientboundBlockChangedAckPacket(int sequence) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundBlockChangedAckPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundBlockChangedAckPacket>codec(ClientboundBlockChangedAckPacket::write, ClientboundBlockChangedAckPacket::new);
