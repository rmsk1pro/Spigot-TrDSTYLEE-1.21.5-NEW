...
public class PacketPlayOutAbilities implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutAbilities> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutAbilities>codec(PacketPlayOutAbilities::write, PacketPlayOutAbilities::new);
    ...
    private PacketPlayOutAbilities(PacketDataSerializer packetdataserializer) {
    ...
    @Override
    public PacketType<PacketPlayOutAbilities> type() {
