...
public class PacketPlayInSetJigsaw implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInSetJigsaw> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInSetJigsaw>codec(PacketPlayInSetJigsaw::write, PacketPlayInSetJigsaw::new);
    ...
    private PacketPlayInSetJigsaw(PacketDataSerializer packetdataserializer) {
        ...
        this.joint = (TileEntityJigsaw.JointType) TileEntityJigsaw.JointType.CODEC.byName(packetdataserializer.readUtf(), TileEntityJigsaw.JointType.ALIGNED);
