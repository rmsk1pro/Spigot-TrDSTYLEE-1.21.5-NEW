...
public class PacketPlayOutViewDistance implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutViewDistance> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutViewDistance>codec(PacketPlayOutViewDistance::write, PacketPlayOutViewDistance::new);
