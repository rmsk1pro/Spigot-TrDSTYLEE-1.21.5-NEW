...
public class PacketPlayOutOpenSignEditor implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutOpenSignEditor> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutOpenSignEditor>codec(PacketPlayOutOpenSignEditor::write, PacketPlayOutOpenSignEditor::new);
