...
public class PacketPlayInItemName implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInItemName> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInItemName>codec(PacketPlayInItemName::write, PacketPlayInItemName::new);
