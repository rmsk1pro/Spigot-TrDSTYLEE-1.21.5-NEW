...
public class PacketPlayOutViewCentre implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutViewCentre> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutViewCentre>codec(PacketPlayOutViewCentre::write, PacketPlayOutViewCentre::new);
    private final int x;
    private final int z;
