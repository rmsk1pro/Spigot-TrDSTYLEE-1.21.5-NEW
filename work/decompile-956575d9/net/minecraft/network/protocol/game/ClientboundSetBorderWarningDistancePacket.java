...
public class ClientboundSetBorderWarningDistancePacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundSetBorderWarningDistancePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundSetBorderWarningDistancePacket>codec(ClientboundSetBorderWarningDistancePacket::write, ClientboundSetBorderWarningDistancePacket::new);
