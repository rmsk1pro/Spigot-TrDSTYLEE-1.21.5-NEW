...
public class PacketPlayInCloseWindow implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInCloseWindow> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInCloseWindow>codec(PacketPlayInCloseWindow::write, PacketPlayInCloseWindow::new);
