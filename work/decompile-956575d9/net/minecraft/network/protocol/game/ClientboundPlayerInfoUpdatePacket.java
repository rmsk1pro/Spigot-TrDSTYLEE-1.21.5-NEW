...
public class ClientboundPlayerInfoUpdatePacket implements Packet<PacketListenerPlayOut> {
    ...
    public static ClientboundPlayerInfoUpdatePacket createPlayerInitializing(Collection<EntityPlayer> collection) {
        EnumSet<ClientboundPlayerInfoUpdatePacket.a> enumset = EnumSet.of(ClientboundPlayerInfoUpdatePacket.a.ADD_PLAYER, ClientboundPlayerInfoUpdatePacket.a.INITIALIZE_CHAT, ClientboundPlayerInfoUpdatePacket.a.UPDATE_GAME_MODE, ClientboundPlayerInfoUpdatePacket.a.UPDATE_LISTED, ClientboundPlayerInfoUpdatePacket.a.UPDATE_LATENCY, ClientboundPlayerInfoUpdatePacket.a.UPDATE_DISPLAY_NAME, ClientboundPlayerInfoUpdatePacket.a.UPDATE_HAT, ClientboundPlayerInfoUpdatePacket.a.UPDATE_LIST_ORDER);
    ...
    private ClientboundPlayerInfoUpdatePacket(RegistryFriendlyByteBuf registryfriendlybytebuf) {
        this.actions = registryfriendlybytebuf.<ClientboundPlayerInfoUpdatePacket.a>readEnumSet(ClientboundPlayerInfoUpdatePacket.a.class);
        this.entries = registryfriendlybytebuf.<ClientboundPlayerInfoUpdatePacket.b>readList((packetdataserializer) -> {
            ...
            for (ClientboundPlayerInfoUpdatePacket.a clientboundplayerinfoupdatepacket_a : this.actions) {
    ...
    public static enum a {
        ...
        }), UPDATE_LIST_ORDER((clientboundplayerinfoupdatepacket_c, registryfriendlybytebuf) -> {
            clientboundplayerinfoupdatepacket_c.listOrder = registryfriendlybytebuf.readVarInt();
        }, (registryfriendlybytebuf, clientboundplayerinfoupdatepacket_b) -> {
            registryfriendlybytebuf.writeVarInt(clientboundplayerinfoupdatepacket_b.listOrder);
        }), UPDATE_HAT((clientboundplayerinfoupdatepacket_c, registryfriendlybytebuf) -> {
            clientboundplayerinfoupdatepacket_c.showHat = registryfriendlybytebuf.readBoolean();
        }, (registryfriendlybytebuf, clientboundplayerinfoupdatepacket_b) -> {
            registryfriendlybytebuf.writeBoolean(clientboundplayerinfoupdatepacket_b.showHat);
        });
    ...
    public static record b(UUID profileId, @Nullable GameProfile profile, boolean listed, int latency, EnumGamemode gameMode, @Nullable IChatBaseComponent displayName, boolean showHat, int listOrder, @Nullable RemoteChatSession.a chatSession) {

        b(EntityPlayer entityplayer) {
            this(entityplayer.getUUID(), entityplayer.getGameProfile(), true, entityplayer.connection.latency(), entityplayer.gameMode(), entityplayer.getTabListDisplayName(), entityplayer.isModelPartShown(PlayerModelPart.HAT), entityplayer.getTabListOrder(), (RemoteChatSession.a) Optionull.map(entityplayer.getChatSession(), RemoteChatSession::asData));
        }
    }
    ...
    private static class c {
        ...
        ClientboundPlayerInfoUpdatePacket.b build() {
            return new ClientboundPlayerInfoUpdatePacket.b(this.profileId, this.profile, this.listed, this.latency, this.gameMode, this.displayName, this.showHat, this.listOrder, this.chatSession);
        }
    }
}
