...
public class PacketPlayOutScoreboardDisplayObjective implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutScoreboardDisplayObjective> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutScoreboardDisplayObjective>codec(PacketPlayOutScoreboardDisplayObjective::write, PacketPlayOutScoreboardDisplayObjective::new);
