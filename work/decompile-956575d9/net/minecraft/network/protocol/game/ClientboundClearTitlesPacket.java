...
public class ClientboundClearTitlesPacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundClearTitlesPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundClearTitlesPacket>codec(ClientboundClearTitlesPacket::write, ClientboundClearTitlesPacket::new);
