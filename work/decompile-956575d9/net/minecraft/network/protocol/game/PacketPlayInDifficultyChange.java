...
public class PacketPlayInDifficultyChange implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInDifficultyChange> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInDifficultyChange>codec(PacketPlayInDifficultyChange::write, PacketPlayInDifficultyChange::new);
