...
public record ServerboundChatAckPacket(int offset) implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundChatAckPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundChatAckPacket>codec(ServerboundChatAckPacket::write, ServerboundChatAckPacket::new);
