...
public class ClientboundProjectilePowerPacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundProjectilePowerPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundProjectilePowerPacket>codec(ClientboundProjectilePowerPacket::write, ClientboundProjectilePowerPacket::new);
