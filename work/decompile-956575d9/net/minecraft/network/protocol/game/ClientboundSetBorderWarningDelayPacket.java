...
public class ClientboundSetBorderWarningDelayPacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundSetBorderWarningDelayPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundSetBorderWarningDelayPacket>codec(ClientboundSetBorderWarningDelayPacket::write, ClientboundSetBorderWarningDelayPacket::new);
