...
public class ClientboundSetBorderLerpSizePacket implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundSetBorderLerpSizePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundSetBorderLerpSizePacket>codec(ClientboundSetBorderLerpSizePacket::write, ClientboundSetBorderLerpSizePacket::new);
