...
public class PacketPlayOutWindowData implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutWindowData> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutWindowData>codec(PacketPlayOutWindowData::write, PacketPlayOutWindowData::new);
