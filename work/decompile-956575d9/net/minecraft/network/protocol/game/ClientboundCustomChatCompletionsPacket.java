...
public record ClientboundCustomChatCompletionsPacket(ClientboundCustomChatCompletionsPacket.Action action, List<String> entries) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundCustomChatCompletionsPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundCustomChatCompletionsPacket>codec(ClientboundCustomChatCompletionsPacket::write, ClientboundCustomChatCompletionsPacket::new);
