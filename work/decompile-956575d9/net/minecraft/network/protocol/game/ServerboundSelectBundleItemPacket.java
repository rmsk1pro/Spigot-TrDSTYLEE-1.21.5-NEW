...
public record ServerboundSelectBundleItemPacket(int slotId, int selectedItemIndex) implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundSelectBundleItemPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundSelectBundleItemPacket>codec(ServerboundSelectBundleItemPacket::write, ServerboundSelectBundleItemPacket::new);
