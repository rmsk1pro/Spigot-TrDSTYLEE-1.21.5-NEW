...
public class PacketPlayOutCamera implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayOutCamera> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayOutCamera>codec(PacketPlayOutCamera::write, PacketPlayOutCamera::new);
