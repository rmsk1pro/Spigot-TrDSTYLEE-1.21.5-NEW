...
public record ClientboundTickingStatePacket(float tickRate, boolean isFrozen) implements Packet<PacketListenerPlayOut> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundTickingStatePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundTickingStatePacket>codec(ClientboundTickingStatePacket::write, ClientboundTickingStatePacket::new);
