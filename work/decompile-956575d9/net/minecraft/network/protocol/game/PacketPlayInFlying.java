...
public abstract class PacketPlayInFlying implements Packet<PacketListenerPlayIn> {
    ...
    public static class PacketPlayInPositionLook extends PacketPlayInFlying {
        ...
        public static final StreamCodec<PacketDataSerializer, PacketPlayInFlying.PacketPlayInPositionLook> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInFlying.PacketPlayInPositionLook>codec(PacketPlayInFlying.PacketPlayInPositionLook::write, PacketPlayInFlying.PacketPlayInPositionLook::read);

        public PacketPlayInPositionLook(Vec3D vec3d, float f, float f1, boolean flag, boolean flag1) {
            super(vec3d.x, vec3d.y, vec3d.z, f, f1, flag, flag1, true, true);
        }
    ...
    public static class PacketPlayInPosition extends PacketPlayInFlying {
        ...
        public static final StreamCodec<PacketDataSerializer, PacketPlayInFlying.PacketPlayInPosition> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInFlying.PacketPlayInPosition>codec(PacketPlayInFlying.PacketPlayInPosition::write, PacketPlayInFlying.PacketPlayInPosition::read);

        public PacketPlayInPosition(Vec3D vec3d, boolean flag, boolean flag1) {
            super(vec3d.x, vec3d.y, vec3d.z, 0.0F, 0.0F, flag, flag1, true, false);
        }
    ...
    public static class PacketPlayInLook extends PacketPlayInFlying {
        ...
        public static final StreamCodec<PacketDataSerializer, PacketPlayInFlying.PacketPlayInLook> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInFlying.PacketPlayInLook>codec(PacketPlayInFlying.PacketPlayInLook::write, PacketPlayInFlying.PacketPlayInLook::read);
    ...
    public static class d extends PacketPlayInFlying {
        ...
        public static final StreamCodec<PacketDataSerializer, PacketPlayInFlying.d> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInFlying.d>codec(PacketPlayInFlying.d::write, PacketPlayInFlying.d::read);
