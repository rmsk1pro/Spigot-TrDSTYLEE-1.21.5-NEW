...
public record ServerboundChatCommandSignedPacket(String command, Instant timeStamp, long salt, ArgumentSignatures argumentSignatures, LastSeenMessages.b lastSeenMessages) implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundChatCommandSignedPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundChatCommandSignedPacket>codec(ServerboundChatCommandSignedPacket::write, ServerboundChatCommandSignedPacket::new);
