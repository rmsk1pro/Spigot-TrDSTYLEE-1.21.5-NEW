...
public class PacketPlayInTileNBTQuery implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInTileNBTQuery> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInTileNBTQuery>codec(PacketPlayInTileNBTQuery::write, PacketPlayInTileNBTQuery::new);
