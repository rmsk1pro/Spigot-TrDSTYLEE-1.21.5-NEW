...
public class PacketPlayInRecipeSettings implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInRecipeSettings> STREAM_CODEC = Packet.<PacketDataSerializer, PacketPlayInRecipeSettings>codec(PacketPlayInRecipeSettings::write, PacketPlayInRecipeSettings::new);
