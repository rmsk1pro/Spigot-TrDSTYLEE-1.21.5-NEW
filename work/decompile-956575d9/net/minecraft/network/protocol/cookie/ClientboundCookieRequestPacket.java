...
public record ClientboundCookieRequestPacket(MinecraftKey key) implements Packet<ClientCookiePacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ClientboundCookieRequestPacket> STREAM_CODEC = Packet.<PacketDataSerializer, ClientboundCookieRequestPacket>codec(ClientboundCookieRequestPacket::write, ClientboundCookieRequestPacket::new);
