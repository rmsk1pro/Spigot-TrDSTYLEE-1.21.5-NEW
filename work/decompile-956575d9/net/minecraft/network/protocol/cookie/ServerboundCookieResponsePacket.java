...
public record ServerboundCookieResponsePacket(MinecraftKey key, @Nullable byte[] payload) implements Packet<ServerCookiePacketListener> {
    ...
    public static final StreamCodec<PacketDataSerializer, ServerboundCookieResponsePacket> STREAM_CODEC = Packet.<PacketDataSerializer, ServerboundCookieResponsePacket>codec(ServerboundCookieResponsePacket::write, ServerboundCookieResponsePacket::new);
