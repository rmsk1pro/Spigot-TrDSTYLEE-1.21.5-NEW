        ...
        public boolean test(ShapeDetectorBlock shapedetectorblock) {
            ...
            if (!iblockdata.is(this.state.getBlock())) {
                ...
                if (this.nbt == null) {
                    ...
                    return tileentity != null && GameProfileSerializer.compareNbt(this.nbt, tileentity.saveWithFullMetadata(shapedetectorblock.getLevel().registryAccess()), true);
                }
            }
        }
        ...
        public boolean test(ShapeDetectorBlock shapedetectorblock) {
            ...
            if (!iblockdata.is(this.tag)) {
                ...
                for (Map.Entry<String, String> map_entry : this.vagueProperties.entrySet()) {
                    IBlockState<?> iblockstate = iblockdata.getBlock().getStateDefinition().getProperty((String) map_entry.getKey());

                    if (iblockstate == null) {
                        return false;
                    }

                    Comparable<?> comparable = (Comparable) iblockstate.getValue((String) map_entry.getValue()).orElse((Object) null);
