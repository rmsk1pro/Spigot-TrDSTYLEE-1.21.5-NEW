...
public class ArgumentScoreholder implements ArgumentType<ArgumentScoreholder.b> {
    ...
    public static final SuggestionProvider<CommandListenerWrapper> SUGGEST_SCORE_HOLDERS = (commandcontext, suggestionsbuilder) -> {
        ...
        ArgumentParserSelector argumentparserselector = new ArgumentParserSelector(stringreader, ArgumentParserSelector.allowSelectors((CommandListenerWrapper) commandcontext.getSource()));
        ...
        return argumentparserselector.fillSuggestions(suggestionsbuilder, (suggestionsbuilder1) -> {
            ICompletionProvider.suggest(((CommandListenerWrapper) commandcontext.getSource()).getOnlinePlayerNames(), suggestionsbuilder1);
        });
    };
    ...
    public <S> ArgumentScoreholder.b parse(StringReader stringreader, S s0) throws CommandSyntaxException {
        return this.parse(stringreader, ArgumentParserSelector.allowSelectors(s0));
    }

    private ArgumentScoreholder.b parse(StringReader stringreader, boolean flag) throws CommandSyntaxException {
                ...
                if (s.startsWith("#")) {
                    ...
                    try {
                        ...
                        return (commandlistenerwrapper, supplier) -> {
                            ...
                            for (WorldServer worldserver : minecraftserver.getAllLevels()) {
