    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> commandcontext, SuggestionsBuilder suggestionsbuilder) {
        ...
        if (object instanceof ICompletionProvider icompletionprovider) {
            ...
            return argumentparserselector.fillSuggestions(suggestionsbuilder, (suggestionsbuilder1) -> {
                ...
                Iterable<String> iterable = (Iterable<String>) (this.playersOnly ? collection : Iterables.concat(collection, icompletionprovider.getSelectedEntities()));

                ICompletionProvider.suggest(iterable, suggestionsbuilder1);
            });
        } else {
