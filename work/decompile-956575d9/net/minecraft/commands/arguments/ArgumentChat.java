...
public class ArgumentChat implements SignedArgument<ArgumentChat.a> {
    ...
    public <S> ArgumentChat.a parse(StringReader stringreader, @Nullable S s0) throws CommandSyntaxException {
        return ArgumentChat.a.parseText(stringreader, ArgumentParserSelector.allowSelectors(s0));
    }
    ...
    public static record a(String text, ArgumentChat.b[] parts) {
        ...
        IChatBaseComponent resolveComponent(CommandListenerWrapper commandlistenerwrapper) throws CommandSyntaxException {
            return this.toComponent(commandlistenerwrapper, ArgumentParserSelector.allowSelectors(commandlistenerwrapper));
        }
        ...
        public IChatBaseComponent toComponent(CommandListenerWrapper commandlistenerwrapper, boolean flag) throws CommandSyntaxException {
            if (this.parts.length != 0 && flag) {
                ...
                for (ArgumentChat.b argumentchat_b : this.parts) {
                    ...
                    while (true) {
                        ...
                        while (true) {
                            ...
                            if (stringreader.peek() == '@') {
                                ...
                                try {
                                    ArgumentParserSelector argumentparserselector = new ArgumentParserSelector(stringreader, true);
