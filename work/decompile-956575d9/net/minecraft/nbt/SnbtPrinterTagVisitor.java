...
public class SnbtPrinterTagVisitor implements TagVisitor {
    ...
    protected List<String> getKeys(NBTTagCompound nbttagcompound) {
        Set<String> set = Sets.newHashSet(nbttagcompound.keySet());
