...
public final class RecipeBookSettings {
    ...
    public static final StreamCodec<PacketDataSerializer, RecipeBookSettings> STREAM_CODEC = StreamCodec.<PacketDataSerializer, RecipeBookSettings>ofMember(RecipeBookSettings::write, RecipeBookSettings::read);
    ...
    public static RecipeBookSettings read(NBTTagCompound nbttagcompound) {
        ...
        RecipeBookSettings.TAG_FIELDS.forEach((recipebooktype, pair) -> {
            boolean flag = nbttagcompound.getBooleanOr((String) pair.getFirst(), RecipeBookSettings.a.DEFAULT.open());
            boolean flag1 = nbttagcompound.getBooleanOr((String) pair.getSecond(), RecipeBookSettings.a.DEFAULT.filtering());
