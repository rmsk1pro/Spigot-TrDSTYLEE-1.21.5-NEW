...
public class StatisticList {
    ...
    private static <T> StatisticWrapper<T> makeRegistryStatType(String s, IRegistry<T> iregistry) {
        IChatBaseComponent ichatbasecomponent = IChatBaseComponent.translatable("stat_type.minecraft." + s);

        return (StatisticWrapper) IRegistry.register(BuiltInRegistries.STAT_TYPE, s, new StatisticWrapper(iregistry, ichatbasecomponent));
    }
}
