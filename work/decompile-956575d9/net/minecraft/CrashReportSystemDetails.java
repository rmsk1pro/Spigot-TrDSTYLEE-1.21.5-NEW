...
public class CrashReportSystemDetails {
    ...
    public static String formatLocation(LevelHeightAccessor levelheightaccessor, int i, int j, int k) {
        ...
        try {
            ...
            int i1 = SectionPosition.blockToSectionCoord(j);
            int j1 = SectionPosition.blockToSectionCoord(k);
            int k1 = i & 15;
            int l1 = j & 15;
            int i2 = k & 15;
            int j2 = SectionPosition.sectionToBlockCoord(l);
            int k2 = levelheightaccessor.getMinY();
            int l2 = SectionPosition.sectionToBlockCoord(j1);
            int i3 = SectionPosition.sectionToBlockCoord(l + 1) - 1;
            int j3 = levelheightaccessor.getMaxY();
            int k3 = SectionPosition.sectionToBlockCoord(j1 + 1) - 1;
    ...
    public void getDetails(StringBuilder stringbuilder) {
        ...
        for (CrashReportSystemDetails.CrashReportDetail crashreportsystemdetails_crashreportdetail : this.entries) {
            stringbuilder.append("\n\t");
    ...
    public static void populateBlockDetails(CrashReportSystemDetails crashreportsystemdetails, LevelHeightAccessor levelheightaccessor, BlockPosition blockposition, IBlockData iblockdata) {
        Objects.requireNonNull(iblockdata);
        crashreportsystemdetails.setDetail("Block", iblockdata::toString);
        populateBlockLocationDetails(crashreportsystemdetails, levelheightaccessor, blockposition);
    }

    public static CrashReportSystemDetails populateBlockLocationDetails(CrashReportSystemDetails crashreportsystemdetails, LevelHeightAccessor levelheightaccessor, BlockPosition blockposition) {
        return crashreportsystemdetails.setDetail("Block location", () -> {
