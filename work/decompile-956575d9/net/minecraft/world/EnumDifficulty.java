...
public enum EnumDifficulty implements INamable {
    ...
    public static final INamable.a<EnumDifficulty> CODEC = INamable.<EnumDifficulty>fromEnum(EnumDifficulty::values);
    private static final IntFunction<EnumDifficulty> BY_ID = ByIdMap.<EnumDifficulty>continuous(EnumDifficulty::getId, values(), ByIdMap.a.WRAP);
    private final int id;
    private final String key;

    private EnumDifficulty(final int i, final String s) {
        this.id = i;
        this.key = s;
    }
    ...
    public static EnumDifficulty byName(String s) {
        return EnumDifficulty.CODEC.byName(s);
    }
