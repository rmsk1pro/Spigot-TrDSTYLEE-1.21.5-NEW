...
public class DragonControllerLandingFly extends AbstractDragonController {
    ...
    private void findNewTarget(WorldServer worldserver) {
        if (this.currentPath == null || this.currentPath.isDone()) {
            ...
            EntityHuman entityhuman = worldserver.getNearestPlayer(DragonControllerLandingFly.NEAR_EGG_TARGETING, this.dragon, (double) blockposition.getX(), (double) blockposition.getY(), (double) blockposition.getZ());
            int j;
