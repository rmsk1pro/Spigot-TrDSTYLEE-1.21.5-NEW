...
public enum EnumMainHand implements OptionEnum, INamable {
    ...
    public static final Codec<EnumMainHand> CODEC = INamable.<EnumMainHand>fromEnum(EnumMainHand::values);
    public static final IntFunction<EnumMainHand> BY_ID = ByIdMap.<EnumMainHand>continuous(EnumMainHand::getId, values(), ByIdMap.a.ZERO);
