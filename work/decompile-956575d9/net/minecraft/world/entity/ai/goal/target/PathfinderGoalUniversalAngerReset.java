...
public class PathfinderGoalUniversalAngerReset<T extends EntityInsentient & IEntityAngerable> extends PathfinderGoal {
    ...
    public boolean canUse() {
        return getServerLevel((Entity) this.mob).getGameRules().getBoolean(GameRules.RULE_UNIVERSAL_ANGER) && this.wasHurtByPlayer();
    }
    ...
    private List<? extends EntityInsentient> getNearbyMobsOfSameType() {
        ...
        return this.mob.level().<EntityInsentient>getEntitiesOfClass(this.mob.getClass(), axisalignedbb, IEntitySelector.NO_SPECTATORS);
    }
}
