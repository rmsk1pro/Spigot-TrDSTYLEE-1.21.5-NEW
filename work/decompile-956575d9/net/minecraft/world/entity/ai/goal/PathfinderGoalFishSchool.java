...
public class PathfinderGoalFishSchool extends PathfinderGoal {
    ...
    public boolean canUse() {
        if (this.mob.hasFollowers()) {
            ...
            List<? extends EntityFishSchool> list = this.mob.level().<EntityFishSchool>getEntitiesOfClass(this.mob.getClass(), this.mob.getBoundingBox().inflate(8.0D, 8.0D, 8.0D), predicate);
