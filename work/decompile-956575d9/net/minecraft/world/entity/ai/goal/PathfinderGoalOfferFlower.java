...
public class PathfinderGoalOfferFlower extends PathfinderGoal {
    ...
    public boolean canUse() {
        if (!this.golem.level().isBrightOutside()) {
            ...
            this.villager = (EntityVillager) getServerLevel((Entity) this.golem).getNearestEntity(EntityVillager.class, PathfinderGoalOfferFlower.OFFER_TARGER_CONTEXT, this.golem, this.golem.getX(), this.golem.getY(), this.golem.getZ(), this.golem.getBoundingBox().inflate(6.0D, 2.0D, 6.0D));
