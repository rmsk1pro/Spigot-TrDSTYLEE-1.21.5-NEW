...
public class PathfinderGoalFollowEntity extends PathfinderGoal {
    ...
    public boolean canUse() {
        List<EntityInsentient> list = this.mob.level().<EntityInsentient>getEntitiesOfClass(EntityInsentient.class, this.mob.getBoundingBox().inflate((double) this.areaSize), this.followPredicate);
