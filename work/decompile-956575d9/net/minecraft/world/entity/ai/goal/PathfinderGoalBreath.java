...
public class PathfinderGoalBreath extends PathfinderGoal {
    ...
    private void findAirPosition() {
        ...
        if (blockposition == null) {
            blockposition = BlockPosition.containing(this.mob.getX(), this.mob.getY() + 8.0D, this.mob.getZ());
        }
    ...
    private boolean givesAir(IWorldReader iworldreader, BlockPosition blockposition) {
        ...
        return (iworldreader.getFluidState(blockposition).isEmpty() || iblockdata.is(Blocks.BUBBLE_COLUMN)) && iblockdata.isPathfindable(PathMode.LAND);
    }
}
