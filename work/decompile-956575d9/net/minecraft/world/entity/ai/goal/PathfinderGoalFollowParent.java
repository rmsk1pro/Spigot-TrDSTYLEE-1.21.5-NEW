...
public class PathfinderGoalFollowParent extends PathfinderGoal {
    ...
    public boolean canUse() {
        if (this.animal.getAge() >= 0) {
            ...
            List<? extends EntityAnimal> list = this.animal.level().<EntityAnimal>getEntitiesOfClass(this.animal.getClass(), this.animal.getBoundingBox().inflate(8.0D, 4.0D, 8.0D));
