...
public class PathfinderGoalStrollVillage extends PathfinderGoalRandomStroll {
    ...
    protected Vec3D getPosition() {
        ...
        return sectionposition1 != sectionposition ? DefaultRandomPos.getPosTowards(this.mob, 10, 7, Vec3D.atBottomCenterOf(sectionposition1.center()), (double) ((float) Math.PI / 2F)) : null;
    }
}
