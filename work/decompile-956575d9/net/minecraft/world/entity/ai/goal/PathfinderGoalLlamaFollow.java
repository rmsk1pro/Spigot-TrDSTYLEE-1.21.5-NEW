        ...
        if (!this.llama.isLeashed() && !this.llama.inCaravan()) {
            ...
            for (Entity entity : list) {
                ...
                if (entityllama1.inCaravan() && !entityllama1.hasCaravanTail()) {
                    double d1 = this.llama.distanceToSqr((Entity) entityllama1);
            ...
            if (entityllama == null) {
                for (Entity entity1 : list) {
                    EntityLlama entityllama2 = (EntityLlama) entity1;

                    if (entityllama2.isLeashed() && !entityllama2.hasCaravanTail()) {
                        double d2 = this.llama.distanceToSqr((Entity) entityllama2);
