...
public class SensorPiglinBruteSpecific extends Sensor<EntityLiving> {
    ...
    protected void doTick(WorldServer worldserver, EntityLiving entityliving) {
        ...
        for (EntityLiving entityliving1 : (List) behaviorcontroller.getMemory(MemoryModuleType.NEAREST_LIVING_ENTITIES).orElse(ImmutableList.of())) {
        ...
        behaviorcontroller.setMemory(MemoryModuleType.NEARBY_ADULT_PIGLINS, list);
    }
}
