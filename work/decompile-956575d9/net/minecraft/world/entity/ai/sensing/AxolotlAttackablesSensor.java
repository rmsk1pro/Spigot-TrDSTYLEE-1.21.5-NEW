...
public class AxolotlAttackablesSensor extends NearestVisibleLivingEntitySensor {
    ...
    @Override
    protected boolean isMatchingEntity(WorldServer worldserver, EntityLiving entityliving, EntityLiving entityliving1) {
        return this.isClose(entityliving, entityliving1) && entityliving1.isInWater() && (this.isHostileTarget(entityliving1) || this.isHuntTarget(entityliving, entityliving1)) && Sensor.isEntityAttackable(worldserver, entityliving, entityliving1);
    }
