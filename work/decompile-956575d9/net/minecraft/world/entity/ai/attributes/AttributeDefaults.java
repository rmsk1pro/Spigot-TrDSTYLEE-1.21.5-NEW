...
public class AttributeDefaults {
    ...
    public static void validate() {
        ...
        stream.map(registryblocks::getKey).forEach((minecraftkey) -> {
            SystemUtils.logAndPauseIfInIde("Entity " + String.valueOf(minecraftkey) + " has no attributes");
        });
    }
}
