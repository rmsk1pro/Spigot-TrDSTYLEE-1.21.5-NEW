...
public class BehaviorInteractPlayer extends Behavior<EntityVillager> {
    ...
    private void followPlayer(EntityVillager entityvillager) {
        ...
        behaviorcontroller.setMemory(MemoryModuleType.WALK_TARGET, new MemoryTarget(new BehaviorPositionEntity(entityvillager.getTradingPlayer(), false), this.speedModifier, 2));
        behaviorcontroller.setMemory(MemoryModuleType.LOOK_TARGET, new BehaviorPositionEntity(entityvillager.getTradingPlayer(), true));
    }
}
