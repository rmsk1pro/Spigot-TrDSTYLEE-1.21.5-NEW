                ...
                return (worldserver, entityliving, i) -> {
                    if (!entityliving.isInWater() && entityliving.onGround()) {
                        ...
                        for (EnumDirection enumdirection : EnumDirection.EnumDirectionLimit.HORIZONTAL) {
                            ...
                            if (worldserver.getBlockState(blockposition1).getCollisionShape(worldserver, blockposition1).getFaceShape(EnumDirection.UP).isEmpty() && worldserver.getFluidState(blockposition1).is(FluidTypes.WATER)) {
