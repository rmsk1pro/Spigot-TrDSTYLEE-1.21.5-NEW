...
public class RandomLookAround extends Behavior<EntityInsentient> {
    ...
    protected void start(WorldServer worldserver, EntityInsentient entityinsentient, long i) {
        ...
        entityinsentient.getBrain().setMemory(MemoryModuleType.LOOK_TARGET, new BehaviorTarget(entityinsentient.getEyePosition().add(vec3d)));
        entityinsentient.getBrain().setMemory(MemoryModuleType.GAZE_COOLDOWN_TICKS, this.interval.sample(randomsource));
    }
}
