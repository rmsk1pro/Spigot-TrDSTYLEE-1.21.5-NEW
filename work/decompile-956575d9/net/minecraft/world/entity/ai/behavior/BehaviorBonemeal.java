...
public class BehaviorBonemeal extends Behavior<EntityVillager> {
    ...
    private void setCurrentCropAsTarget(EntityVillager entityvillager) {
        this.cropPos.ifPresent((blockposition) -> {
            ...
            entityvillager.getBrain().setMemory(MemoryModuleType.LOOK_TARGET, behaviortarget);
            entityvillager.getBrain().setMemory(MemoryModuleType.WALK_TARGET, new MemoryTarget(behaviortarget, 0.5F, 1));
        });
    }
