    ...
    public boolean isVisibleBy(EntityLiving entityliving) {
        ...
        if (entity instanceof EntityLiving entityliving1) {
            if (!entityliving1.isAlive()) {
                ...
                Optional<NearestVisibleLivingEntities> optional = entityliving.getBrain().<NearestVisibleLivingEntities>getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES);
