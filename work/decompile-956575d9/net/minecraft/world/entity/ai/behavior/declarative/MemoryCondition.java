...
public interface MemoryCondition<F extends K1, Value> {
    ...
    public static record c<Value>(MemoryModuleType<Value> memory) implements MemoryCondition<Mu, Value> {
        ...
        @Override
        public MemoryAccessor<Mu, Value> createAccessor(BehaviorController<?> behaviorcontroller, Optional<Value> optional) {
            return new MemoryAccessor<Mu, Value>(behaviorcontroller, this.memory, OptionalBox.create(optional));
        }
    }
    ...
    public static record a<Value>(MemoryModuleType<Value> memory) implements MemoryCondition<Const.Mu<Unit>, Value> {
        ...
        @Override
        public MemoryAccessor<Const.Mu<Unit>, Value> createAccessor(BehaviorController<?> behaviorcontroller, Optional<Value> optional) {
