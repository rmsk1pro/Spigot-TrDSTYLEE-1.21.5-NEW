...
public class BehaviorBuilder<E extends EntityLiving, M> implements App<BehaviorBuilder.c<E>, M> {
    ...
    public static <E extends EntityLiving> BehaviorBuilder.b<E> instance() {
        return new BehaviorBuilder.b<E>();
    }
    ...
    public static <E extends EntityLiving> OneShot<E> create(Function<BehaviorBuilder.b<E>, ? extends App<BehaviorBuilder.c<E>, Trigger<E>>> function) {
        ...
        return new OneShot<E>() {
            ...
            public boolean trigger(WorldServer worldserver, E e0, long i) {
                Trigger<E> trigger = behaviorbuilder_e.tryTrigger(worldserver, e0, i);
    ...
    static <E extends EntityLiving, M> BehaviorBuilder<E, M> create(BehaviorBuilder.e<E, M> behaviorbuilder_e) {
        return new BehaviorBuilder<E, M>(behaviorbuilder_e);
    }
        ...
        d(final MemoryCondition<F, Value> memorycondition) {
            super(new BehaviorBuilder.e<E, MemoryAccessor<F, Value>>() {
                ...
                public MemoryAccessor<F, Value> tryTrigger(WorldServer worldserver, E e0, long i) {
                    BehaviorController<?> behaviorcontroller = ((EntityLiving) e0).getBrain();
                    Optional<Value> optional = behaviorcontroller.<Value>getMemoryInternal(memorycondition.memory());
    ...
    public static final class b<E extends EntityLiving> implements Applicative<BehaviorBuilder.c<E>, BehaviorBuilder.b.a<E>> {
        ...
        public <A> BehaviorBuilder<E, A> point(A a0) {
            return new BehaviorBuilder.a<E, A>(a0);
        }

        public <A> BehaviorBuilder<E, A> point(Supplier<String> supplier, A a0) {
            return new BehaviorBuilder.a<E, A>(a0, supplier);
        }

        public <A, R> Function<App<BehaviorBuilder.c<E>, A>, App<BehaviorBuilder.c<E>, R>> lift1(App<BehaviorBuilder.c<E>, Function<A, R>> app) {
            return (app1) -> {
                final BehaviorBuilder.e<E, A> behaviorbuilder_e = BehaviorBuilder.<E, A>get(app1);
                final BehaviorBuilder.e<E, Function<A, R>> behaviorbuilder_e1 = BehaviorBuilder.<E, Function<A, R>>get(app);
                ...
                return BehaviorBuilder.create(new BehaviorBuilder.e<E, R>() {
                    ...
                    public R tryTrigger(WorldServer worldserver, E e0, long i) {
                        ...
                        if (a0 == null) {
                            ...
                            Function<A, R> function = behaviorbuilder_e1.tryTrigger(worldserver, e0, i);

                            return (R) (function == null ? null : function.apply(a0));
                        }
                    }
        ...
        public <T, R> BehaviorBuilder<E, R> map(final Function<? super T, ? extends R> function, App<BehaviorBuilder.c<E>, T> app) {
            final BehaviorBuilder.e<E, T> behaviorbuilder_e = BehaviorBuilder.<E, T>get(app);
            ...
            return BehaviorBuilder.create(new BehaviorBuilder.e<E, R>() {
                ...
                public R tryTrigger(WorldServer worldserver, E e0, long i) {
                    ...
                    return (R) (t0 == null ? null : function.apply(t0));
                }
                ...
                public String debugString() {
                    ...
                    return s + ".map[" + String.valueOf(function) + "]";
                }
        ...
        public <A, B, R> BehaviorBuilder<E, R> ap2(App<BehaviorBuilder.c<E>, BiFunction<A, B, R>> app, App<BehaviorBuilder.c<E>, A> app1, App<BehaviorBuilder.c<E>, B> app2) {
            final BehaviorBuilder.e<E, A> behaviorbuilder_e = BehaviorBuilder.<E, A>get(app1);
            final BehaviorBuilder.e<E, B> behaviorbuilder_e1 = BehaviorBuilder.<E, B>get(app2);
            final BehaviorBuilder.e<E, BiFunction<A, B, R>> behaviorbuilder_e2 = BehaviorBuilder.<E, BiFunction<A, B, R>>get(app);
                ...
                public R tryTrigger(WorldServer worldserver, E e0, long i) {
                    ...
                    if (a0 == null) {
                        ...
                        if (b0 == null) {
                            ...
                            BiFunction<A, B, R> bifunction = behaviorbuilder_e2.tryTrigger(worldserver, e0, i);
        ...
        public <T1, T2, T3, R> BehaviorBuilder<E, R> ap3(App<BehaviorBuilder.c<E>, Function3<T1, T2, T3, R>> app, App<BehaviorBuilder.c<E>, T1> app1, App<BehaviorBuilder.c<E>, T2> app2, App<BehaviorBuilder.c<E>, T3> app3) {
            final BehaviorBuilder.e<E, T1> behaviorbuilder_e = BehaviorBuilder.<E, T1>get(app1);
            final BehaviorBuilder.e<E, T2> behaviorbuilder_e1 = BehaviorBuilder.<E, T2>get(app2);
            final BehaviorBuilder.e<E, T3> behaviorbuilder_e2 = BehaviorBuilder.<E, T3>get(app3);
            final BehaviorBuilder.e<E, Function3<T1, T2, T3, R>> behaviorbuilder_e3 = BehaviorBuilder.<E, Function3<T1, T2, T3, R>>get(app);
                    ...
                    if (t1 == null) {
                        ...
                        if (t2 == null) {
                            ...
                            if (t3 == null) {
                                ...
                                Function3<T1, T2, T3, R> function3 = behaviorbuilder_e3.tryTrigger(worldserver, e0, i);
        ...
        public <T1, T2, T3, T4, R> BehaviorBuilder<E, R> ap4(App<BehaviorBuilder.c<E>, Function4<T1, T2, T3, T4, R>> app, App<BehaviorBuilder.c<E>, T1> app1, App<BehaviorBuilder.c<E>, T2> app2, App<BehaviorBuilder.c<E>, T3> app3, App<BehaviorBuilder.c<E>, T4> app4) {
            ...
            final BehaviorBuilder.e<E, T2> behaviorbuilder_e1 = BehaviorBuilder.<E, T2>get(app2);
            final BehaviorBuilder.e<E, T3> behaviorbuilder_e2 = BehaviorBuilder.<E, T3>get(app3);
            final BehaviorBuilder.e<E, T4> behaviorbuilder_e3 = BehaviorBuilder.<E, T4>get(app4);
            final BehaviorBuilder.e<E, Function4<T1, T2, T3, T4, R>> behaviorbuilder_e4 = BehaviorBuilder.<E, Function4<T1, T2, T3, T4, R>>get(app);
                        ...
                        if (t2 == null) {
                            ...
                            if (t3 == null) {
                                ...
                                if (t4 == null) {
                                    ...
                                    Function4<T1, T2, T3, T4, R> function4 = behaviorbuilder_e4.tryTrigger(worldserver, e0, i);
