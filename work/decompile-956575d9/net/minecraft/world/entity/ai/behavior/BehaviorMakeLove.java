...
public class BehaviorMakeLove extends Behavior<EntityVillager> {
    ...
    private boolean isBreedingPossible(EntityVillager entityvillager) {
        ...
        return optional.isEmpty() ? false : BehaviorUtil.targetIsValid(behaviorcontroller, MemoryModuleType.BREED_TARGET, EntityTypes.VILLAGER) && entityvillager.canBreed() && ((EntityAgeable) optional.get()).canBreed();
    }
