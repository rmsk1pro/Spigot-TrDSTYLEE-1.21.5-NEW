...
public class ControllerLook implements Control {
    ...
    protected Optional<Float> getXRotD() {
        ...
        return Math.abs(d1) <= (double) 1.0E-5F && Math.abs(d3) <= (double) 1.0E-5F ? Optional.empty() : Optional.of((float) (-(MathHelper.atan2(d1, d3) * (double) (180F / (float) Math.PI))));
    }
    ...
    protected Optional<Float> getYRotD() {
        ...
        return Math.abs(d1) <= (double) 1.0E-5F && Math.abs(d0) <= (double) 1.0E-5F ? Optional.empty() : Optional.of((float) (MathHelper.atan2(d1, d0) * (double) (180F / (float) Math.PI)) - 90.0F);
    }
