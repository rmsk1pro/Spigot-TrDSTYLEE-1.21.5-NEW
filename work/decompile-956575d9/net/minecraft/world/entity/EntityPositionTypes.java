...
public class EntityPositionTypes {
    ...
    public static <T extends Entity> boolean checkSpawnRules(EntityTypes<T> entitytypes, WorldAccess worldaccess, EntitySpawnReason entityspawnreason, BlockPosition blockposition, RandomSource randomsource) {
        ...
        return entitypositiontypes_a == null || entitypositiontypes_a.predicate.test(entitytypes, worldaccess, entityspawnreason, blockposition, randomsource);
    }
    ...
    static {
        ...
        register(EntityTypes.DOLPHIN, SpawnPlacementTypes.IN_WATER, HeightMap.Type.MOTION_BLOCKING_NO_LEAVES, AgeableWaterCreature::checkSurfaceAgeableWaterCreatureSpawnRules);
        ...
        register(EntityTypes.SQUID, SpawnPlacementTypes.IN_WATER, HeightMap.Type.MOTION_BLOCKING_NO_LEAVES, AgeableWaterCreature::checkSurfaceAgeableWaterCreatureSpawnRules);
        ...
        register(EntityTypes.BREEZE, SpawnPlacementTypes.ON_GROUND, HeightMap.Type.MOTION_BLOCKING_NO_LEAVES, EntityMonster::checkAnyLightMonsterSpawnRules);
        register(EntityTypes.CAMEL, SpawnPlacementTypes.ON_GROUND, HeightMap.Type.MOTION_BLOCKING_NO_LEAVES, Camel::checkCamelSpawnRules);
        ...
        register(EntityTypes.ZOGLIN, SpawnPlacementTypes.ON_GROUND, HeightMap.Type.MOTION_BLOCKING_NO_LEAVES, EntityMonster::checkAnyLightMonsterSpawnRules);
