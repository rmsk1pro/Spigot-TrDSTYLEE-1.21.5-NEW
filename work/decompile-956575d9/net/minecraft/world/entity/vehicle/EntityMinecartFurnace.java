...
public class EntityMinecartFurnace extends EntityMinecartAbstract {
    ...
    private static final DataWatcherObject<Boolean> DATA_ID_FUEL = DataWatcher.<Boolean>defineId(EntityMinecartFurnace.class, DataWatcherRegistry.BOOLEAN);
    ...
    protected void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        double d0 = nbttagcompound.getDoubleOr("PushX", EntityMinecartFurnace.DEFAULT_PUSH.x);
        double d1 = nbttagcompound.getDoubleOr("PushZ", EntityMinecartFurnace.DEFAULT_PUSH.z);

        this.push = new Vec3D(d0, 0.0D, d1);
        this.fuel = nbttagcompound.getShortOr("Fuel", (short) 0);
    }
