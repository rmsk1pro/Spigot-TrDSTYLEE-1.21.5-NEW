...
public class EntityGhast extends EntityFlying implements IMonster {
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.explosionPower = nbttagcompound.getByteOr("ExplosionPower", (byte) 1);
    }
    ...
    private static class PathfinderGoalGhastMoveTowardsTarget extends PathfinderGoal {
        ...
        public void tick() {
            if (this.ghast.getTarget() == null) {
                ...
                this.ghast.setYRot(-((float) MathHelper.atan2(vec3d.x, vec3d.z)) * (180F / (float) Math.PI));
                ...
                if (entityliving.distanceToSqr((Entity) this.ghast) < 4096.0D) {
                    ...
                    this.ghast.setYRot(-((float) MathHelper.atan2(d1, d2)) * (180F / (float) Math.PI));
                    this.ghast.yBodyRot = this.ghast.getYRot();
                }
            }
