...
public class EntityRavager extends EntityRaider {
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.attackTick = nbttagcompound.getIntOr("AttackTick", 0);
        this.stunnedTick = nbttagcompound.getIntOr("StunTick", 0);
        this.roarTick = nbttagcompound.getIntOr("RoarTick", 0);
    }
    ...
    private void roar() {
        if (this.isAlive()) {
            ...
            if (world instanceof WorldServer) {
                ...
                for (EntityLiving entityliving1 : this.level().getEntitiesOfClass(EntityLiving.class, this.getBoundingBox().inflate(4.0D), EntityRavager.ROAR_TARGET_ON_CLIENT)) {
