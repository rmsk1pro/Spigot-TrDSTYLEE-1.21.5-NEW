...
public class EntityPiglinBrute extends EntityPiglinAbstract {
    ...
    public static AttributeProvider.Builder createAttributes() {
        return EntityMonster.createMonsterAttributes().add(GenericAttributes.MAX_HEALTH, 50.0D).add(GenericAttributes.MOVEMENT_SPEED, (double) 0.35F).add(GenericAttributes.ATTACK_DAMAGE, 7.0D).add(GenericAttributes.FOLLOW_RANGE, 12.0D);
    }
    ...
    protected BehaviorController.b<EntityPiglinBrute> brainProvider() {
        return BehaviorController.<EntityPiglinBrute>provider(EntityPiglinBrute.MEMORY_TYPES, EntityPiglinBrute.SENSOR_TYPES);
    }
