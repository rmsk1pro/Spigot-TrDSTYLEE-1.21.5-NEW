...
public class BreezeAi {
    ...
    private static void initIdleActivity(BehaviorController<Breeze> behaviorcontroller) {
        behaviorcontroller.addActivity(Activity.IDLE, ImmutableList.of(Pair.of(0, BehaviorAttackTargetSet.create((worldserver, breeze) -> {
            return breeze.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE);
        })), Pair.of(1, BehaviorAttackTargetSet.create((worldserver, breeze) -> {
            return breeze.getHurtBy();
        })), Pair.of(2, new BreezeAi.a(20, 40)), Pair.of(3, new BehaviorGateSingle(ImmutableList.of(Pair.of(new BehaviorNop(20, 100), 1), Pair.of(BehaviorStrollRandomUnconstrained.stroll(0.6F), 2))))));
    }
