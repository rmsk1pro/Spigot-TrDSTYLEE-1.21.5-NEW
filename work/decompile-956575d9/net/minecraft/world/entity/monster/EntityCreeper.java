...
public class EntityCreeper extends EntityMonster {
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.entityData.set(EntityCreeper.DATA_IS_POWERED, nbttagcompound.getBooleanOr("powered", false));
        this.maxSwell = nbttagcompound.getShortOr("Fuse", (short) 30);
        this.explosionRadius = nbttagcompound.getByteOr("ExplosionRadius", (byte) 3);
        if (nbttagcompound.getBooleanOr("ignited", false)) {
            this.ignite();
        }
