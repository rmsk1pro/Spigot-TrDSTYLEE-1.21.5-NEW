...
public class EntityBlaze extends EntityMonster {
    ...
    private static final DataWatcherObject<Byte> DATA_FLAGS_ID = DataWatcher.<Byte>defineId(EntityBlaze.class, DataWatcherRegistry.BYTE);
    ...
    protected void defineSynchedData(DataWatcher.a datawatcher_a) {
        ...
        datawatcher_a.define(EntityBlaze.DATA_FLAGS_ID, (byte) 0);
    }
            ...
            if (entityliving != null) {
                ...
                if (d0 < 4.0D) {
                    ...
                    if (this.attackTime <= 0) {
                        this.attackTime = 20;
                        this.blaze.doHurtTarget(getServerLevel((Entity) this.blaze), entityliving);
                    }
                    ...
                    if (this.attackTime <= 0) {
                        ...
                        if (this.attackStep > 1) {
                            ...
                            for (int i = 0; i < 1; ++i) {
                                Vec3D vec3d = new Vec3D(this.blaze.getRandom().triangle(d1, 2.297D * d4), d2, this.blaze.getRandom().triangle(d3, 2.297D * d4));
                                EntitySmallFireball entitysmallfireball = new EntitySmallFireball(this.blaze.level(), this.blaze, vec3d.normalize());
