...
public class Warden extends EntityMonster implements VibrationSystem {
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.store("anger", AngerManagement.codec(this::canTargetEntity), registryops, this.angerManagement);
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.angerManagement = (AngerManagement) nbttagcompound.read("anger", AngerManagement.codec(this::canTargetEntity), registryops).orElseGet(() -> {
