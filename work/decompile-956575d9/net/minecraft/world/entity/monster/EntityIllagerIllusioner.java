...
public class EntityIllagerIllusioner extends EntityIllagerWizard implements IRangedEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new PathfinderGoalAvoidTarget(this, Creaking.class, 8.0F, 1.0D, 1.2D));
        ...
        if (this.level().isClientSide && this.isInvisible()) {
            ...
            if (this.hurtTime != 1 && this.tickCount % 1200 != 0) {
                ...
                for (int k = 0; k < 4; ++k) {
                    ...
                    this.clientSideIllusionOffsets[1][k] = new Vec3D((double) (-6.0F + (float) this.random.nextInt(13)) * 0.5D, (double) Math.max(0, this.random.nextInt(6) - 4), (double) (-6.0F + (float) this.random.nextInt(13)) * 0.5D);
                }
    ...
    public void performRangedAttack(EntityLiving entityliving, float f) {
        ...
        EntityArrow entityarrow = ProjectileHelper.getMobArrow(this, itemstack1, f, itemstack);
