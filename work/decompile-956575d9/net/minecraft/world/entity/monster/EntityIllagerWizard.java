...
public abstract class EntityIllagerWizard extends EntityIllagerAbstract {
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.spellCastingTickCount = nbttagcompound.getIntOr("SpellTicks", 0);
    }
    ...
    public void tick() {
        ...
        if (this.level().isClientSide && this.isCastingSpell()) {
            ...
            float f3 = this.yBodyRot * ((float) Math.PI / 180F) + MathHelper.cos((float) this.tickCount * 0.6662F) * 0.25F;
    ...
    public static enum Spell {
        ...
        private static final IntFunction<EntityIllagerWizard.Spell> BY_ID = ByIdMap.<EntityIllagerWizard.Spell>continuous((entityillagerwizard_spell) -> {
