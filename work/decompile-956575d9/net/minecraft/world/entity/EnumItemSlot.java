...
public enum EnumItemSlot implements INamable {
    ...
    MAINHAND(EnumItemSlot.Function.HAND, 0, 0, "mainhand"), OFFHAND(EnumItemSlot.Function.HAND, 1, 5, "offhand"), FEET(EnumItemSlot.Function.HUMANOID_ARMOR, 0, 1, 1, "feet"), LEGS(EnumItemSlot.Function.HUMANOID_ARMOR, 1, 1, 2, "legs"), CHEST(EnumItemSlot.Function.HUMANOID_ARMOR, 2, 1, 3, "chest"), HEAD(EnumItemSlot.Function.HUMANOID_ARMOR, 3, 1, 4, "head"), BODY(EnumItemSlot.Function.ANIMAL_ARMOR, 0, 1, 6, "body"), SADDLE(EnumItemSlot.Function.SADDLE, 0, 1, 7, "saddle");

    public static final int NO_COUNT_LIMIT = 0;
    public static final List<EnumItemSlot> VALUES = List.of(values());
    public static final IntFunction<EnumItemSlot> BY_ID = ByIdMap.<EnumItemSlot>continuous((enumitemslot) -> {
        return enumitemslot.id;
    }, values(), ByIdMap.a.ZERO);
    public static final INamable.a<EnumItemSlot> CODEC = INamable.<EnumItemSlot>fromEnum(EnumItemSlot::values);
    ...
    public boolean canIncreaseExperience() {
        return this.type != EnumItemSlot.Function.SADDLE;
    }

    public static EnumItemSlot byName(String s) {
        EnumItemSlot enumitemslot = EnumItemSlot.CODEC.byName(s);
