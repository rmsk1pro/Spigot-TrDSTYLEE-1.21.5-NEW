...
public abstract class EntityTameableAnimal extends EntityAnimal implements OwnableEntity {
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        if (entityreference != null) {
            entityreference.store(nbttagcompound, "Owner");
        }
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        EntityReference<EntityLiving> entityreference = EntityReference.<EntityLiving>readWithOldOwnerConversion(nbttagcompound, "Owner", this.level());
        ...
        this.orderedToSit = nbttagcompound.getBooleanOr("Sitting", false);
