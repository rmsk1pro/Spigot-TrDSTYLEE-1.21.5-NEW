...
public enum EnumChatVisibility implements OptionEnum {
    ...
    private static final IntFunction<EnumChatVisibility> BY_ID = ByIdMap.<EnumChatVisibility>continuous(EnumChatVisibility::getId, values(), ByIdMap.a.WRAP);
    private final int id;
    private final String key;

    private EnumChatVisibility(final int i, final String s) {
        this.id = i;
        this.key = s;
    }
