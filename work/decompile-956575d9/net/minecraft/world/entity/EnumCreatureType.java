...
public enum EnumCreatureType implements INamable {
    ...
    public static final Codec<EnumCreatureType> CODEC = INamable.<EnumCreatureType>fromEnum(EnumCreatureType::values);
    ...
    private EnumCreatureType(final String s, final int i, final boolean flag, final boolean flag1, final int j) {
        this.name = s;
        this.max = i;
