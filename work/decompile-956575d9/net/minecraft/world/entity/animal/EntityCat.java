...
public class EntityCat extends EntityTameableAnimal {
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        VariantUtils.readVariant(nbttagcompound, this.registryAccess(), Registries.CAT_VARIANT).ifPresent(this::setVariant);
        this.setCollarColor((EnumColor) nbttagcompound.read("CollarColor", EnumColor.LEGACY_ID_CODEC).orElse(EntityCat.DEFAULT_COLLAR_COLOR));
    }
    ...
    public GroupDataEntity finalizeSpawn(WorldAccess worldaccess, DifficultyDamageScaler difficultydamagescaler, EntitySpawnReason entityspawnreason, @Nullable GroupDataEntity groupdataentity) {
        ...
        CatVariants.selectVariantToSpawn(this.random, this.registryAccess(), SpawnContext.create(worldaccess, this.blockPosition())).ifPresent(this::setVariant);
