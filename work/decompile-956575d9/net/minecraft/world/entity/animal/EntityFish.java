...
public abstract class EntityFish extends EntityWaterAnimal implements Bucketable {
    ...
    private static final DataWatcherObject<Boolean> FROM_BUCKET = DataWatcher.<Boolean>defineId(EntityFish.class, DataWatcherRegistry.BOOLEAN);
    ...
    protected void defineSynchedData(DataWatcher.a datawatcher_a) {
        ...
        datawatcher_a.define(EntityFish.FROM_BUCKET, false);
    }
