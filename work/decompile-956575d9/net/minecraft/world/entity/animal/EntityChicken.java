...
public class EntityChicken extends EntityAnimal {
    ...
    public GroupDataEntity finalizeSpawn(WorldAccess worldaccess, DifficultyDamageScaler difficultydamagescaler, EntitySpawnReason entityspawnreason, @Nullable GroupDataEntity groupdataentity) {
        ChickenVariants.selectVariantToSpawn(this.random, this.registryAccess(), SpawnContext.create(worldaccess, this.blockPosition())).ifPresent(this::setVariant);
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.getInt("EggLayTime").ifPresent((integer) -> {
            this.eggTime = integer;
        });
        VariantUtils.readVariant(nbttagcompound, this.registryAccess(), Registries.CHICKEN_VARIANT).ifPresent(this::setVariant);
    }
