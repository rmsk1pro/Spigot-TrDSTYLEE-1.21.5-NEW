...
public class Armadillo extends EntityAnimal {
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.store("state", Armadillo.a.CODEC, this.getState());
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.switchToState((Armadillo.a) nbttagcompound.read("state", Armadillo.a.CODEC).orElse(Armadillo.a.IDLE));
        nbttagcompound.getInt("scute_time").ifPresent((integer) -> {
