...
public class EntityPolarBear extends EntityAnimal implements IEntityAngerable {
    ...
    private static final DataWatcherObject<Boolean> DATA_STANDING_ID = DataWatcher.<Boolean>defineId(EntityPolarBear.class, DataWatcherRegistry.BOOLEAN);
    ...
    private class a extends PathfinderGoalNearestAttackableTarget<EntityHuman> {
        ...
        public boolean canUse() {
            if (EntityPolarBear.this.isBaby()) {
                ...
                if (super.canUse()) {
                    for (EntityPolarBear entitypolarbear : EntityPolarBear.this.level().getEntitiesOfClass(EntityPolarBear.class, EntityPolarBear.this.getBoundingBox().inflate(8.0D, 4.0D, 8.0D))) {
