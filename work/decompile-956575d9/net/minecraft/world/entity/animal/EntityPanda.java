...
public class EntityPanda extends EntityAnimal {
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.store("MainGene", EntityPanda.Gene.CODEC, this.getMainGene());
        nbttagcompound.store("HiddenGene", EntityPanda.Gene.CODEC, this.getHiddenGene());
    }

    @Override
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        super.readAdditionalSaveData(nbttagcompound);
        this.setMainGene((EntityPanda.Gene) nbttagcompound.read("MainGene", EntityPanda.Gene.CODEC).orElse(EntityPanda.Gene.NORMAL));
        this.setHiddenGene((EntityPanda.Gene) nbttagcompound.read("HiddenGene", EntityPanda.Gene.CODEC).orElse(EntityPanda.Gene.NORMAL));
    }
