...
public class EntityHorseZombie extends EntityHorseAbstract {
    ...
    public static boolean checkZombieHorseSpawnRules(EntityTypes<? extends EntityAnimal> entitytypes, GeneratorAccess generatoraccess, EntitySpawnReason entityspawnreason, BlockPosition blockposition, RandomSource randomsource) {
    ...
    public EntityAgeable getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        return EntityTypes.ZOMBIE_HORSE.create(worldserver, EntitySpawnReason.BREEDING);
    }
