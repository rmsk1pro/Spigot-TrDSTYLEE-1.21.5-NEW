...
public class EntityIronGolem extends EntityGolem implements IEntityAngerable {
    ...
    protected static final DataWatcherObject<Byte> DATA_FLAGS_ID = DataWatcher.<Byte>defineId(EntityIronGolem.class, DataWatcherRegistry.BYTE);
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.setPlayerCreated(nbttagcompound.getBooleanOr("PlayerCreated", false));
    ...
    public boolean doHurtTarget(WorldServer worldserver, Entity entity) {
        ...
        boolean flag = entity.hurtServer(worldserver, damagesource, f1);
        ...
        if (flag) {
            ...
            entity.setDeltaMovement(entity.getDeltaMovement().add(0.0D, (double) 0.4F * d2, 0.0D));
