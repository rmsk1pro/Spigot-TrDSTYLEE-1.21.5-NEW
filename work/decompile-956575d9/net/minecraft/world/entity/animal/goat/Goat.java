...
public class Goat extends EntityAnimal {
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.setScreamingGoat(nbttagcompound.getBooleanOr("IsScreamingGoat", false));
        this.entityData.set(Goat.DATA_HAS_LEFT_HORN, nbttagcompound.getBooleanOr("HasLeftHorn", true));
        this.entityData.set(Goat.DATA_HAS_RIGHT_HORN, nbttagcompound.getBooleanOr("HasRightHorn", true));
    }
