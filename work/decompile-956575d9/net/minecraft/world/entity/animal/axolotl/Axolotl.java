...
public class Axolotl extends EntityAnimal implements Bucketable {
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.store("Variant", Axolotl.Variant.LEGACY_CODEC, this.getVariant());
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.setVariant((Axolotl.Variant) nbttagcompound.read("Variant", Axolotl.Variant.LEGACY_CODEC).orElse(Axolotl.Variant.DEFAULT));
        this.setFromBucket(nbttagcompound.getBooleanOr("FromBucket", false));
    }
