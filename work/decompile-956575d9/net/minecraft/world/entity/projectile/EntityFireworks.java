...
public class EntityFireworks extends IProjectile implements ItemSupplier {
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.store("FireworksItem", ItemStack.CODEC, registryops, this.getItem());
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        this.life = nbttagcompound.getIntOr("Life", 0);
        this.lifetime = nbttagcompound.getIntOr("LifeTime", 0);
        RegistryOps<NBTBase> registryops = this.registryAccess().<NBTBase>createSerializationContext(DynamicOpsNBT.INSTANCE);

        this.entityData.set(EntityFireworks.DATA_ID_FIREWORKS_ITEM, (ItemStack) nbttagcompound.read("FireworksItem", ItemStack.CODEC, registryops).orElse(getDefaultItem()));
        this.entityData.set(EntityFireworks.DATA_SHOT_AT_ANGLE, nbttagcompound.getBooleanOr("ShotAtAngle", false));
    }
