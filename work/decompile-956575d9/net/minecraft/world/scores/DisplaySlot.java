...
public enum DisplaySlot implements INamable {
    ...
    public static final INamable.a<DisplaySlot> CODEC = INamable.<DisplaySlot>fromEnum(DisplaySlot::values);
    public static final IntFunction<DisplaySlot> BY_ID = ByIdMap.<DisplaySlot>continuous(DisplaySlot::id, values(), ByIdMap.a.ZERO);
