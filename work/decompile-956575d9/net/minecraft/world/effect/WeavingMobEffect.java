...
class WeavingMobEffect extends MobEffectList {
    ...
    private void spawnCobwebsRandomlyAround(WorldServer worldserver, RandomSource randomsource, BlockPosition blockposition) {
        ...
        for (BlockPosition blockposition1 : BlockPosition.randomInCube(randomsource, 15, blockposition, 1)) {
        ...
        for (BlockPosition blockposition3 : set) {
            worldserver.setBlock(blockposition3, Blocks.COBWEB.defaultBlockState(), 3);
            worldserver.levelEvent(3018, blockposition3, 0);
        }
