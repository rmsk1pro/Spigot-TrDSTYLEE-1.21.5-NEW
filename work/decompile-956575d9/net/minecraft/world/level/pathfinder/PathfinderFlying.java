...
public class PathfinderFlying extends PathfinderNormal {
    ...
    public PathPoint getStart() {
        ...
        if (!this.canStartAt(blockposition)) {
            for (BlockPosition blockposition1 : this.iteratePathfindingStartNodeCandidatePositions(this.mob)) {
    ...
    private Iterable<BlockPosition> iteratePathfindingStartNodeCandidatePositions(EntityInsentient entityinsentient) {
        ...
        if (!flag) {
            ...
            double d0 = Math.max(0.0D, (double) 1.1F - axisalignedbb.getZsize());
            double d1 = Math.max(0.0D, (double) 1.1F - axisalignedbb.getXsize());
            double d2 = Math.max(0.0D, (double) 1.1F - axisalignedbb.getYsize());
