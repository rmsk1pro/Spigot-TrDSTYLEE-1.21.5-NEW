...
public class PathfindingContext {
    ...
    public PathType getPathTypeFromState(int i, int j, int k) {
        BlockPosition blockposition = this.mutablePos.set(i, j, k);

        return this.cache == null ? PathfinderNormal.getPathTypeFromState(this.level, blockposition) : this.cache.getOrCompute(this.level, blockposition);
    }
