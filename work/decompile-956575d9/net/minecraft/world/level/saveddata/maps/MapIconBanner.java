...
public record MapIconBanner(BlockPosition pos, EnumColor color, Optional<IChatBaseComponent> name) {
    ...
    public static final Codec<MapIconBanner> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(BlockPosition.CODEC.fieldOf("pos").forGetter(MapIconBanner::pos), EnumColor.CODEC.lenientOptionalFieldOf("color", EnumColor.WHITE).forGetter(MapIconBanner::color), ComponentSerialization.CODEC.lenientOptionalFieldOf("name").forGetter(MapIconBanner::name)).apply(instance, MapIconBanner::new);
    });
