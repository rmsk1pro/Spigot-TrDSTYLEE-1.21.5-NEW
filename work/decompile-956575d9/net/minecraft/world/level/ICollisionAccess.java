...
public interface ICollisionAccess extends IBlockAccess {
    ...
    default boolean isUnobstructed(IBlockData iblockdata, BlockPosition blockposition, VoxelShapeCollision voxelshapecollision) {
        ...
        return voxelshape.isEmpty() || this.isUnobstructed((Entity) null, voxelshape.move((BaseBlockPosition) blockposition));
    }
    ...
    default boolean noCollision(@Nullable Entity entity, AxisAlignedBB axisalignedbb, boolean flag) {
        for (VoxelShape voxelshape : flag ? this.getBlockAndLiquidCollisions(entity, axisalignedbb) : this.getBlockCollisions(entity, axisalignedbb)) {
    ...
    default boolean noBlockCollision(@Nullable Entity entity, AxisAlignedBB axisalignedbb) {
        for (VoxelShape voxelshape : this.getBlockCollisions(entity, axisalignedbb)) {
            if (!voxelshape.isEmpty()) {
                return false;
            }
        }
    ...
    default boolean collidesWithSuffocatingBlock(@Nullable Entity entity, AxisAlignedBB axisalignedbb) {
        VoxelShapeSpliterator<VoxelShape> voxelshapespliterator = new VoxelShapeSpliterator<VoxelShape>(this, entity, axisalignedbb, true, (blockposition_mutableblockposition, voxelshape) -> {
            return voxelshape;
        });
    ...
    default Optional<BlockPosition> findSupportingBlock(Entity entity, AxisAlignedBB axisalignedbb) {
        ...
        VoxelShapeSpliterator<BlockPosition> voxelshapespliterator = new VoxelShapeSpliterator<BlockPosition>(this, entity, axisalignedbb, false, (blockposition_mutableblockposition, voxelshape) -> {
