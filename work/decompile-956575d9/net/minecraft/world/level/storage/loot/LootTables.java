...
public class LootTables {
    ...
    private static final Set<ResourceKey<LootTable>> IMMUTABLE_LOCATIONS = Collections.unmodifiableSet(LootTables.LOCATIONS);
    ...
    public static final Map<EnumColor, ResourceKey<LootTable>> SHEEP_BY_DYE = makeDyeKeyMap("entities/sheep");
    ...
    public static final Map<EnumColor, ResourceKey<LootTable>> SHEAR_SHEEP_BY_DYE = makeDyeKeyMap("shearing/sheep");
    ...
    private static Map<EnumColor, ResourceKey<LootTable>> makeDyeKeyMap(String s) {
        return SystemUtils.<EnumColor, ResourceKey<LootTable>>makeEnumMap(EnumColor.class, (enumcolor) -> {
            return register(s + "/" + enumcolor.getName());
        });
    }

    private static ResourceKey<LootTable> register(String s) {
        return register(ResourceKey.create(Registries.LOOT_TABLE, MinecraftKey.withDefaultNamespace(s)));
    }

    private static ResourceKey<LootTable> register(ResourceKey<LootTable> resourcekey) {
        if (LootTables.LOCATIONS.add(resourcekey)) {
            return resourcekey;
        } else {
