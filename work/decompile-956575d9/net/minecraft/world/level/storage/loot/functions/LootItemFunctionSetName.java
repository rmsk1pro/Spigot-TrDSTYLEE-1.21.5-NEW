...
public class LootItemFunctionSetName extends LootItemFunctionConditional {
    ...
    public static UnaryOperator<IChatBaseComponent> createResolver(LootTableInfo loottableinfo, @Nullable LootTableInfo.EntityTarget loottableinfo_entitytarget) {
        if (loottableinfo_entitytarget != null) {
            Entity entity = (Entity) loottableinfo.getOptionalParameter(loottableinfo_entitytarget.getParam());

            if (entity != null) {
                CommandListenerWrapper commandlistenerwrapper = entity.createCommandSourceStackForNameResolution(loottableinfo.getLevel()).withPermission(2);
    ...
    public static enum a implements INamable {
        ...
        public static final Codec<LootItemFunctionSetName.a> CODEC = INamable.<LootItemFunctionSetName.a>fromEnum(LootItemFunctionSetName.a::values);
