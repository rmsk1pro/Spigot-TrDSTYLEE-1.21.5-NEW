...
public abstract class LootItemFunctionConditional implements LootItemFunction {
    ...
    protected static <T extends LootItemFunctionConditional> Products.P1<RecordCodecBuilder.Mu<T>, List<LootItemCondition>> commonFields(RecordCodecBuilder.Instance<T> recordcodecbuilder_instance) {
        return recordcodecbuilder_instance.group(LootItemCondition.DIRECT_CODEC.listOf().optionalFieldOf("conditions", List.of()).forGetter((lootitemfunctionconditional) -> {
