...
public class LootItemFunctionSetAttribute extends LootItemFunctionConditional {
    ...
    private ItemAttributeModifiers updateModifiers(LootTableInfo loottableinfo, ItemAttributeModifiers itemattributemodifiers) {
        ...
        for (LootItemFunctionSetAttribute.b lootitemfunctionsetattribute_b : this.modifiers) {
            EquipmentSlotGroup equipmentslotgroup = (EquipmentSlotGroup) SystemUtils.getRandom(lootitemfunctionsetattribute_b.slots, randomsource);

            itemattributemodifiers = itemattributemodifiers.withModifierAdded(lootitemfunctionsetattribute_b.attribute, new AttributeModifier(lootitemfunctionsetattribute_b.id, (double) lootitemfunctionsetattribute_b.amount.getFloat(loottableinfo), lootitemfunctionsetattribute_b.operation), equipmentslotgroup);
        }
