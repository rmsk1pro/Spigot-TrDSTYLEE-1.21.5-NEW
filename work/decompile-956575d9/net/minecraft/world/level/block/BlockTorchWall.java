...
public class BlockTorchWall extends BlockTorch {
    ...
    private static final Map<EnumDirection, VoxelShape> SHAPES = VoxelShapes.rotateHorizontal(Block.boxZ(5.0D, 3.0D, 13.0D, 11.0D, 16.0D));
    ...
    protected BlockTorchWall(ParticleType particletype, BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) (this.stateDefinition.any()).setValue(BlockTorchWall.FACING, EnumDirection.NORTH));
    }
    ...
    public static VoxelShape getShape(IBlockData iblockdata) {
        return (VoxelShape) BlockTorchWall.SHAPES.get(iblockdata.getValue(BlockTorchWall.FACING));
    }
