...
public class DoubleBlockFinder {
    ...
    public static <S extends TileEntity> DoubleBlockFinder.Result<S> combineWithNeigbour(TileEntityTypes<S> tileentitytypes, Function<IBlockData, DoubleBlockFinder.BlockType> function, Function<IBlockData, EnumDirection> function1, IBlockState<EnumDirection> iblockstate, IBlockData iblockdata, GeneratorAccess generatoraccess, BlockPosition blockposition, BiPredicate<GeneratorAccess, BlockPosition> bipredicate) {
        ...
        if (s0 == null) {
            ...
            if (flag) {
                return new DoubleBlockFinder.Result.Single<S>(s0);
            } else {
                ...
                if (iblockdata1.is(iblockdata.getBlock())) {
                    ...
                    if (doubleblockfinder_blocktype1 != DoubleBlockFinder.BlockType.SINGLE && doubleblockfinder_blocktype != doubleblockfinder_blocktype1 && iblockdata1.getValue(iblockstate) == iblockdata.getValue(iblockstate)) {
                        ...
                        if (s1 != null) {
                            ...
                            return new DoubleBlockFinder.Result.Double<S>(s2, s3);
                        }
                    }
                }
