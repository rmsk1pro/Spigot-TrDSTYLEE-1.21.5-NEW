...
public class CaveVinesBlock extends BlockGrowingTop implements CaveVines {
    ...
    public CaveVinesBlock(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(CaveVinesBlock.AGE, 0)).setValue(CaveVinesBlock.BERRIES, false));
    }
