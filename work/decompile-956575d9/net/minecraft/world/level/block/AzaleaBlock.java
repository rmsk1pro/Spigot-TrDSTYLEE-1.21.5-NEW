...
public class AzaleaBlock extends VegetationBlock implements IBlockFragilePlantElement {

    public static final MapCodec<AzaleaBlock> CODEC = simpleCodec(AzaleaBlock::new);
    private static final VoxelShape SHAPE = VoxelShapes.or(Block.column(16.0D, 8.0D, 16.0D), Block.column(4.0D, 0.0D, 8.0D));
