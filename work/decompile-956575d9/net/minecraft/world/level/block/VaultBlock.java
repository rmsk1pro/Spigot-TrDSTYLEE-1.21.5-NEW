...
public class VaultBlock extends BlockTileEntity {
    ...
    public VaultBlock(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(VaultBlock.FACING, EnumDirection.NORTH)).setValue(VaultBlock.STATE, VaultState.INACTIVE)).setValue(VaultBlock.OMINOUS, false));
    }
