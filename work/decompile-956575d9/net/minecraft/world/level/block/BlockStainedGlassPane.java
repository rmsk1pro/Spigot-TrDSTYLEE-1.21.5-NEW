...
public class BlockStainedGlassPane extends BlockIronBars implements IBeaconBeam {
    ...
    public BlockStainedGlassPane(EnumColor enumcolor, BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockStainedGlassPane.NORTH, false)).setValue(BlockStainedGlassPane.EAST, false)).setValue(BlockStainedGlassPane.SOUTH, false)).setValue(BlockStainedGlassPane.WEST, false)).setValue(BlockStainedGlassPane.WATERLOGGED, false));
    }
