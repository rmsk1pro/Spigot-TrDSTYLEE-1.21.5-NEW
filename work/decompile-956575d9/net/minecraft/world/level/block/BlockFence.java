...
public class BlockFence extends BlockTall {
    ...
    private final Function<IBlockData, VoxelShape> occlusionShapes;
    ...
    public BlockFence(BlockBase.Info blockbase_info) {
        super(4.0F, 16.0F, 4.0F, 16.0F, 24.0F, blockbase_info);
        this.registerDefaultState((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockFence.NORTH, false)).setValue(BlockFence.EAST, false)).setValue(BlockFence.SOUTH, false)).setValue(BlockFence.WEST, false)).setValue(BlockFence.WATERLOGGED, false));
    ...
    protected VoxelShape getOcclusionShape(IBlockData iblockdata) {
        return (VoxelShape) this.occlusionShapes.apply(iblockdata);
    }
    ...
    public IBlockData getStateForPlacement(BlockActionContext blockactioncontext) {
        ...
        return (IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) super.getStateForPlacement(blockactioncontext).setValue(BlockFence.NORTH, this.connectsTo(iblockdata, iblockdata.isFaceSturdy(iblockaccess, blockposition1, EnumDirection.SOUTH), EnumDirection.SOUTH))).setValue(BlockFence.EAST, this.connectsTo(iblockdata1, iblockdata1.isFaceSturdy(iblockaccess, blockposition2, EnumDirection.WEST), EnumDirection.WEST))).setValue(BlockFence.SOUTH, this.connectsTo(iblockdata2, iblockdata2.isFaceSturdy(iblockaccess, blockposition3, EnumDirection.NORTH), EnumDirection.NORTH))).setValue(BlockFence.WEST, this.connectsTo(iblockdata3, iblockdata3.isFaceSturdy(iblockaccess, blockposition4, EnumDirection.EAST), EnumDirection.EAST))).setValue(BlockFence.WATERLOGGED, fluid.getType() == FluidTypes.WATER);
    }
