...
public class BlockDaylightDetector extends BlockTileEntity {
    ...
    public BlockDaylightDetector(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockDaylightDetector.POWER, 0)).setValue(BlockDaylightDetector.INVERTED, false));
    }
