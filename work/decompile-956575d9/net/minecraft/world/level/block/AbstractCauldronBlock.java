...
public abstract class AbstractCauldronBlock extends Block {
    ...
    private static final VoxelShape SHAPE = (VoxelShape) SystemUtils.make(() -> {
        int i = 4;
        int j = 3;
        int k = 2;

        return VoxelShapes.join(VoxelShapes.block(), VoxelShapes.or(Block.column(16.0D, 8.0D, 0.0D, 3.0D), Block.column(8.0D, 16.0D, 0.0D, 3.0D), Block.column(12.0D, 0.0D, 3.0D), AbstractCauldronBlock.SHAPE_INSIDE), OperatorBoolean.ONLY_FIRST);
    });
