...
public class BlockEndRod extends RodBlock {
    ...
    protected BlockEndRod(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) (this.stateDefinition.any()).setValue(BlockEndRod.FACING, EnumDirection.UP));
    }
    ...
    public IBlockData getStateForPlacement(BlockActionContext blockactioncontext) {
        ...
        return iblockdata.is(this) && iblockdata.getValue(BlockEndRod.FACING) == enumdirection ? (IBlockData) this.defaultBlockState().setValue(BlockEndRod.FACING, enumdirection.getOpposite()) : (IBlockData) this.defaultBlockState().setValue(BlockEndRod.FACING, enumdirection);
    }
