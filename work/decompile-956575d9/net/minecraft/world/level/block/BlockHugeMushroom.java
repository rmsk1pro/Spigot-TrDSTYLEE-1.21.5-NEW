...
public class BlockHugeMushroom extends Block {
    ...
    public BlockHugeMushroom(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockHugeMushroom.NORTH, true)).setValue(BlockHugeMushroom.EAST, true)).setValue(BlockHugeMushroom.SOUTH, true)).setValue(BlockHugeMushroom.WEST, true)).setValue(BlockHugeMushroom.UP, true)).setValue(BlockHugeMushroom.DOWN, true));
    }
    ...
    public IBlockData getStateForPlacement(BlockActionContext blockactioncontext) {
        ...
        return (IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) this.defaultBlockState().setValue(BlockHugeMushroom.DOWN, !iblockaccess.getBlockState(blockposition.below()).is(this))).setValue(BlockHugeMushroom.UP, !iblockaccess.getBlockState(blockposition.above()).is(this))).setValue(BlockHugeMushroom.NORTH, !iblockaccess.getBlockState(blockposition.north()).is(this))).setValue(BlockHugeMushroom.EAST, !iblockaccess.getBlockState(blockposition.east()).is(this))).setValue(BlockHugeMushroom.SOUTH, !iblockaccess.getBlockState(blockposition.south()).is(this))).setValue(BlockHugeMushroom.WEST, !iblockaccess.getBlockState(blockposition.west()).is(this));
    }

    @Override
    protected IBlockData updateShape(IBlockData iblockdata, IWorldReader iworldreader, ScheduledTickAccess scheduledtickaccess, BlockPosition blockposition, EnumDirection enumdirection, BlockPosition blockposition1, IBlockData iblockdata1, RandomSource randomsource) {
        return iblockdata1.is(this) ? (IBlockData) iblockdata.setValue((IBlockState) BlockHugeMushroom.PROPERTY_BY_DIRECTION.get(enumdirection), false) : super.updateShape(iblockdata, iworldreader, scheduledtickaccess, blockposition, enumdirection, blockposition1, iblockdata1, randomsource);
    }
