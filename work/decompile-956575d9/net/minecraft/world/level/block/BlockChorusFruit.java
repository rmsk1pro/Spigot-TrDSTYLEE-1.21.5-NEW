...
public class BlockChorusFruit extends BlockSprawling {
    ...
    protected IBlockData updateShape(IBlockData iblockdata, IWorldReader iworldreader, ScheduledTickAccess scheduledtickaccess, BlockPosition blockposition, EnumDirection enumdirection, BlockPosition blockposition1, IBlockData iblockdata1, RandomSource randomsource) {
        if (!iblockdata.canSurvive(iworldreader, blockposition)) {
            ...
            boolean flag = iblockdata1.is(this) || iblockdata1.is(Blocks.CHORUS_FLOWER) || enumdirection == EnumDirection.DOWN && iblockdata1.is(Blocks.END_STONE);
    ...
    protected boolean canSurvive(IBlockData iblockdata, IWorldReader iworldreader, BlockPosition blockposition) {
        ...
        for (EnumDirection enumdirection : EnumDirection.EnumDirectionLimit.HORIZONTAL) {
            ...
            IBlockData iblockdata2 = iworldreader.getBlockState(blockposition1);
            ...
            if (iblockdata2.is(this)) {
                ...
                IBlockData iblockdata3 = iworldreader.getBlockState(blockposition1.below());

                if (iblockdata3.is(this) || iblockdata3.is(Blocks.END_STONE)) {
                    return true;
                }
            }
        }

        return iblockdata1.is(this) || iblockdata1.is(Blocks.END_STONE);
    }
