...
public class BlockRepeater extends BlockDiodeAbstract {
    ...
    protected BlockRepeater(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockRepeater.FACING, EnumDirection.NORTH)).setValue(BlockRepeater.DELAY, 1)).setValue(BlockRepeater.LOCKED, false)).setValue(BlockRepeater.POWERED, false));
    }
    ...
    protected IBlockData updateShape(IBlockData iblockdata, IWorldReader iworldreader, ScheduledTickAccess scheduledtickaccess, BlockPosition blockposition, EnumDirection enumdirection, BlockPosition blockposition1, IBlockData iblockdata1, RandomSource randomsource) {
        return enumdirection == EnumDirection.DOWN && !this.canSurviveOn(iworldreader, blockposition1, iblockdata1) ? Blocks.AIR.defaultBlockState() : (!iworldreader.isClientSide() && enumdirection.getAxis() != ((EnumDirection) iblockdata.getValue(BlockRepeater.FACING)).getAxis() ? (IBlockData) iblockdata.setValue(BlockRepeater.LOCKED, this.isLocked(iworldreader, blockposition, iblockdata)) : super.updateShape(iblockdata, iworldreader, scheduledtickaccess, blockposition, enumdirection, blockposition1, iblockdata1, randomsource));
    }
