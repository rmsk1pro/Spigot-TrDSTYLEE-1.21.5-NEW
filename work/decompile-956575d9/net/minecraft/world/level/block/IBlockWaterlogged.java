...
public interface IBlockWaterlogged extends IFluidSource, IFluidContainer {
    ...
    @Override
    default boolean canPlaceLiquid(@Nullable EntityLiving entityliving, IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata, FluidType fluidtype) {
    ...
    @Override
    default ItemStack pickupBlock(@Nullable EntityLiving entityliving, GeneratorAccess generatoraccess, BlockPosition blockposition, IBlockData iblockdata) {
