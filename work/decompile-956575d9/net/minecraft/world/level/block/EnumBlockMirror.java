...
public enum EnumBlockMirror implements INamable {
    ...
    public static final Codec<EnumBlockMirror> CODEC = INamable.<EnumBlockMirror>fromEnum(EnumBlockMirror::values);
    /** @deprecated */
    @Deprecated
    public static final Codec<EnumBlockMirror> LEGACY_CODEC = ExtraCodecs.<EnumBlockMirror>legacyEnum(EnumBlockMirror::valueOf);
    private final String id;
    private final IChatBaseComponent symbol;
    private final PointGroupO rotation;

    private EnumBlockMirror(final String s, final PointGroupO pointgroupo) {
        this.id = s;
