...
public class BlockBrewingStand extends BlockTileEntity {
    ...
    private static final VoxelShape SHAPE = VoxelShapes.or(Block.column(2.0D, 2.0D, 14.0D), Block.column(14.0D, 0.0D, 2.0D));
    ...
    public BlockBrewingStand(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockBrewingStand.HAS_BOTTLE[0], false)).setValue(BlockBrewingStand.HAS_BOTTLE[1], false)).setValue(BlockBrewingStand.HAS_BOTTLE[2], false));
    }
    ...
    protected EnumInteractionResult useWithoutItem(IBlockData iblockdata, World world, BlockPosition blockposition, EntityHuman entityhuman, MovingObjectPositionBlock movingobjectpositionblock) {
        if (!world.isClientSide) {
            ...
            if (tileentity instanceof TileEntityBrewingStand) {
                ...
                entityhuman.openMenu(tileentitybrewingstand);
