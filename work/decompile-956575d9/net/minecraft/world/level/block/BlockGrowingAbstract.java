...
public abstract class BlockGrowingAbstract extends Block {
    ...
    public IBlockData getStateForPlacement(BlockActionContext blockactioncontext) {
        ...
        return !iblockdata.is(this.getHeadBlock()) && !iblockdata.is(this.getBodyBlock()) ? this.getStateForPlacement(blockactioncontext.getLevel().random) : this.getBodyBlock().defaultBlockState();
    }
    ...
    protected boolean canSurvive(IBlockData iblockdata, IWorldReader iworldreader, BlockPosition blockposition) {
        ...
        return !this.canAttachTo(iblockdata1) ? false : iblockdata1.is(this.getHeadBlock()) || iblockdata1.is(this.getBodyBlock()) || iblockdata1.isFaceSturdy(iworldreader, blockposition1, this.growthDirection);
    }
