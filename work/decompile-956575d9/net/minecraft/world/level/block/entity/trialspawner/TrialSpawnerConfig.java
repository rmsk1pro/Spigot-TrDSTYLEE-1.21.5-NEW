...
public record TrialSpawnerConfig(int spawnRange, float totalMobs, float simultaneousMobs, float totalMobsAddedPerPlayer, float simultaneousMobsAddedPerPlayer, int ticksBetweenSpawn, WeightedList<MobSpawnerData> spawnPotentialsDefinition, WeightedList<ResourceKey<LootTable>> lootTablesToEject, ResourceKey<LootTable> itemsToDropWhenOminous) {
    ...
    public TrialSpawnerConfig withSpawning(EntityTypes<?> entitytypes) {
        ...
        return new TrialSpawnerConfig(this.spawnRange, this.totalMobs, this.simultaneousMobs, this.totalMobsAddedPerPlayer, this.simultaneousMobsAddedPerPlayer, this.ticksBetweenSpawn, WeightedList.of(mobspawnerdata), this.lootTablesToEject, this.itemsToDropWhenOminous);
    }
    ...
    public static class a {
        ...
        private WeightedList<MobSpawnerData> spawnPotentialsDefinition = WeightedList.<MobSpawnerData>of();
        private WeightedList<ResourceKey<LootTable>> lootTablesToEject;
        private ResourceKey<LootTable> itemsToDropWhenOminous;

        public a() {
            this.lootTablesToEject = WeightedList.<ResourceKey<LootTable>>builder().add(LootTables.SPAWNER_TRIAL_CHAMBER_CONSUMABLES).add(LootTables.SPAWNER_TRIAL_CHAMBER_KEY).build();
        ...
        public TrialSpawnerConfig.a spawnPotentialsDefinition(WeightedList<MobSpawnerData> weightedlist) {
            this.spawnPotentialsDefinition = weightedlist;
            return this;
        }

        public TrialSpawnerConfig.a lootTablesToEject(WeightedList<ResourceKey<LootTable>> weightedlist) {
