...
public record EnumBannerPatternType(MinecraftKey assetId, String translationKey) {
    ...
    public static final Codec<Holder<EnumBannerPatternType>> CODEC = RegistryFileCodec.<Holder<EnumBannerPatternType>>create(Registries.BANNER_PATTERN, EnumBannerPatternType.DIRECT_CODEC);
