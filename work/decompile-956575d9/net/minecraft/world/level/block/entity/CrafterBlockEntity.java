...
public class CrafterBlockEntity extends TileEntityLootable implements InventoryCrafting {
    ...
    protected void loadAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        this.craftingTicksRemaining = nbttagcompound.getIntOr("crafting_ticks_remaining", 0);
        ...
        nbttagcompound.getIntArray("disabled_slots").ifPresent((aint) -> {
            for (int j : aint) {
        ...
        this.containerData.set(9, nbttagcompound.getIntOr("triggered", 0));
    }
    ...
    private void addDisabledSlots(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.putIntArray("disabled_slots", intlist.toIntArray());
    }
