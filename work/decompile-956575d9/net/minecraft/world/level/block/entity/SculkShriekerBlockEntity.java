...
public class SculkShriekerBlockEntity extends TileEntity implements GameEventListener.b<VibrationSystem.b>, VibrationSystem {
    ...
    protected void loadAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        this.warningLevel = nbttagcompound.getIntOr("warning_level", 0);
    ...
    public static EntityPlayer tryGetPlayer(@Nullable Entity entity) {
        if (entity instanceof EntityPlayer entityplayer) {
            ...
            if (entity instanceof IProjectile iprojectile) {
                ...
                if (entity1 instanceof EntityPlayer entityplayer2) {
                    return entityplayer2;
                }
            }

            if (entity instanceof EntityItem entityitem) {
                Entity entity2 = entityitem.getOwner();

                if (entity2 instanceof EntityPlayer entityplayer3) {
    ...
    private void playWardenReplySound(World world) {
        ...
        if (soundeffect != null) {
            ...
            world.playSound((Entity) null, (double) i, (double) j, (double) k, soundeffect, SoundCategory.HOSTILE, 5.0F, 1.0F);
        }

    }

    private boolean trySummonWarden(WorldServer worldserver) {
        return this.warningLevel < 4 ? false : SpawnUtil.trySpawnMob(EntityTypes.WARDEN, EntitySpawnReason.TRIGGERED, worldserver, this.getBlockPos(), 20, 5, 6, SpawnUtil.a.ON_TOP_OF_COLLIDER, false).isPresent();
    }
