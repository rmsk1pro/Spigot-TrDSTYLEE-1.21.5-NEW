...
public class TileEntityLectern extends TileEntity implements Clearable, ITileInventory {
    ...
    protected void loadAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        this.book = (ItemStack) nbttagcompound.read("Book", ItemStack.CODEC, registryops).map((itemstack) -> {
    ...
    protected void saveAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        if (!this.getBook().isEmpty()) {
            ...
            nbttagcompound.store("Book", ItemStack.CODEC, registryops, this.getBook());
