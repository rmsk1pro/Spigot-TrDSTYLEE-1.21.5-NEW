...
public class TileEntityBarrel extends TileEntityLootable {
    ...
    public void playSound(IBlockData iblockdata, SoundEffect soundeffect) {
        BaseBlockPosition baseblockposition = ((EnumDirection) iblockdata.getValue(BlockBarrel.FACING)).getUnitVec3i();
        ...
        this.level.playSound((Entity) null, d0, d1, d2, soundeffect, SoundCategory.BLOCKS, 0.5F, this.level.random.nextFloat() * 0.1F + 0.9F);
    }
}
