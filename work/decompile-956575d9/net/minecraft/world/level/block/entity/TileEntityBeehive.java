...
public class TileEntityBeehive extends TileEntity {
    ...
    protected void loadAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        this.stored.clear();
        ((List) nbttagcompound.read("bees", TileEntityBeehive.c.LIST_CODEC).orElse(List.of())).forEach(this::storeBee);
    ...
    protected void saveAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        nbttagcompound.store("bees", TileEntityBeehive.c.LIST_CODEC, this.getBees());
