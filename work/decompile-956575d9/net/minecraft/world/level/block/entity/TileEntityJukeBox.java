...
public class TileEntityJukeBox extends TileEntity implements ContainerSingleItem.a {
    ...
    protected void loadAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        ItemStack itemstack = (ItemStack) nbttagcompound.read("RecordItem", ItemStack.CODEC, registryops).orElse(ItemStack.EMPTY);
        ...
        this.item = itemstack;
        nbttagcompound.getLong("ticks_since_song_started").ifPresent((olong) -> {
    ...
    protected void saveAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        if (!this.getTheItem().isEmpty()) {
            ...
            nbttagcompound.store("RecordItem", ItemStack.CODEC, registryops, this.getTheItem());
        }
