...
public class TrialSpawnerBlock extends BlockTileEntity {
    ...
    public TrialSpawnerBlock(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(TrialSpawnerBlock.STATE, TrialSpawnerState.INACTIVE)).setValue(TrialSpawnerBlock.OMINOUS, false));
    }
