...
public class BlockBarrel extends BlockTileEntity {
    ...
    public BlockBarrel(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockBarrel.FACING, EnumDirection.NORTH)).setValue(BlockBarrel.OPEN, false));
    }
    ...
    protected EnumInteractionResult useWithoutItem(IBlockData iblockdata, World world, BlockPosition blockposition, EntityHuman entityhuman, MovingObjectPositionBlock movingobjectpositionblock) {
        if (world instanceof WorldServer worldserver) {
            ...
            if (tileentity instanceof TileEntityBarrel tileentitybarrel) {
                entityhuman.openMenu(tileentitybarrel);
