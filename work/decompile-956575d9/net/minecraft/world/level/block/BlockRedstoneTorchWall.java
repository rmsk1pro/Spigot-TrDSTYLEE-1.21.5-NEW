...
public class BlockRedstoneTorchWall extends BlockRedstoneTorch {
    ...
    protected BlockRedstoneTorchWall(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockRedstoneTorchWall.FACING, EnumDirection.NORTH)).setValue(BlockRedstoneTorchWall.LIT, true));
    }
    ...
    protected IBlockData updateShape(IBlockData iblockdata, IWorldReader iworldreader, ScheduledTickAccess scheduledtickaccess, BlockPosition blockposition, EnumDirection enumdirection, BlockPosition blockposition1, IBlockData iblockdata1, RandomSource randomsource) {
        return enumdirection.getOpposite() == iblockdata.getValue(BlockRedstoneTorchWall.FACING) && !iblockdata.canSurvive(iworldreader, blockposition) ? Blocks.AIR.defaultBlockState() : iblockdata;
    }
    ...
    protected Orientation randomOrientation(World world, IBlockData iblockdata) {
        return ExperimentalRedstoneUtils.initialOrientation(world, ((EnumDirection) iblockdata.getValue(BlockRedstoneTorchWall.FACING)).getOpposite(), EnumDirection.UP);
    }
}
