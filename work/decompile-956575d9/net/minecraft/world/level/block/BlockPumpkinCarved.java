...
public class BlockPumpkinCarved extends BlockFacingHorizontal {
    ...
    protected BlockPumpkinCarved(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) (this.stateDefinition.any()).setValue(BlockPumpkinCarved.FACING, EnumDirection.NORTH));
    }
    ...
    private void trySpawnGolem(World world, BlockPosition blockposition) {
        ...
        if (shapedetector_shapedetectorcollection != null) {
            EntitySnowman entitysnowman = EntityTypes.SNOW_GOLEM.create(world, EntitySpawnReason.TRIGGERED);
            ...
            if (shapedetector_shapedetectorcollection1 != null) {
                EntityIronGolem entityirongolem = EntityTypes.IRON_GOLEM.create(world, EntitySpawnReason.TRIGGERED);
