...
public class BlockDispenser extends BlockTileEntity {
    ...
    protected BlockDispenser(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockDispenser.FACING, EnumDirection.NORTH)).setValue(BlockDispenser.TRIGGERED, false));
    }
    ...
    protected IDispenseBehavior getDispenseMethod(World world, ItemStack itemstack) {
        if (!itemstack.isItemEnabled(world.enabledFeatures())) {
            return BlockDispenser.DEFAULT_BEHAVIOR;
        } else {
            IDispenseBehavior idispensebehavior = (IDispenseBehavior) BlockDispenser.DISPENSER_REGISTRY.get(itemstack.getItem());
    ...
    private static IDispenseBehavior getDefaultDispenseMethod(ItemStack itemstack) {
        return (IDispenseBehavior) (itemstack.has(DataComponents.EQUIPPABLE) ? EquipmentDispenseItemBehavior.INSTANCE : BlockDispenser.DEFAULT_BEHAVIOR);
    }
