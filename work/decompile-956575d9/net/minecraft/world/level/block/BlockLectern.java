...
public class BlockLectern extends BlockTileEntity {
    ...
    private static final Map<EnumDirection, VoxelShape> SHAPES = VoxelShapes.rotateHorizontal(VoxelShapes.or(Block.boxZ(16.0D, 10.0D, 14.0D, 1.0D, 5.333333D), Block.boxZ(16.0D, 12.0D, 16.0D, 5.333333D, 9.666667D), Block.boxZ(16.0D, 14.0D, 18.0D, 9.666667D, 14.0D), BlockLectern.SHAPE_COLLISION));
    ...
    protected BlockLectern(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) ((IBlockData) ((IBlockData) (this.stateDefinition.any()).setValue(BlockLectern.FACING, EnumDirection.NORTH)).setValue(BlockLectern.POWERED, false)).setValue(BlockLectern.HAS_BOOK, false));
    }
    ...
    protected VoxelShape getShape(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition, VoxelShapeCollision voxelshapecollision) {
        return (VoxelShape) BlockLectern.SHAPES.get(iblockdata.getValue(BlockLectern.FACING));
    }
