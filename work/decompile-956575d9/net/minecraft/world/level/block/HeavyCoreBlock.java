...
public class HeavyCoreBlock extends Block implements IBlockWaterlogged {
    ...
    public HeavyCoreBlock(BlockBase.Info blockbase_info) {
        ...
        this.registerDefaultState((IBlockData) (this.stateDefinition.any()).setValue(HeavyCoreBlock.WATERLOGGED, false));
    }
    ...
    public IBlockData getStateForPlacement(BlockActionContext blockactioncontext) {
        ...
        return (IBlockData) this.defaultBlockState().setValue(HeavyCoreBlock.WATERLOGGED, fluid.is(FluidTypes.WATER));
    }
