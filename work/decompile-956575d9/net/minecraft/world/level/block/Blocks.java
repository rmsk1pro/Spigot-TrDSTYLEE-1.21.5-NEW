...
public class Blocks {
    ...
    public static final Block SAND = register("sand", (blockbase_info) -> {
        return new SandBlock(new ColorRGBA(14406560), blockbase_info);
    ...
    public static final Block RED_SAND = register("red_sand", (blockbase_info) -> {
        return new SandBlock(new ColorRGBA(11098145), blockbase_info);
    ...
    public static final Block OAK_LEAVES = register("oak_leaves", (blockbase_info) -> {
        return new TintedParticleLeavesBlock(0.01F, blockbase_info);
    }, leavesProperties(SoundEffectType.GRASS));
    public static final Block SPRUCE_LEAVES = register("spruce_leaves", (blockbase_info) -> {
        return new TintedParticleLeavesBlock(0.01F, blockbase_info);
    }, leavesProperties(SoundEffectType.GRASS));
    public static final Block BIRCH_LEAVES = register("birch_leaves", (blockbase_info) -> {
        return new TintedParticleLeavesBlock(0.01F, blockbase_info);
    }, leavesProperties(SoundEffectType.GRASS));
    public static final Block JUNGLE_LEAVES = register("jungle_leaves", (blockbase_info) -> {
        return new TintedParticleLeavesBlock(0.01F, blockbase_info);
    }, leavesProperties(SoundEffectType.GRASS));
    public static final Block ACACIA_LEAVES = register("acacia_leaves", (blockbase_info) -> {
        return new TintedParticleLeavesBlock(0.01F, blockbase_info);
    }, leavesProperties(SoundEffectType.GRASS));
    public static final Block CHERRY_LEAVES = register("cherry_leaves", (blockbase_info) -> {
        return new UntintedParticleLeavesBlock(0.1F, Particles.CHERRY_LEAVES, blockbase_info);
    ...
    public static final Block DARK_OAK_LEAVES = register("dark_oak_leaves", (blockbase_info) -> {
        return new TintedParticleLeavesBlock(0.01F, blockbase_info);
    }, leavesProperties(SoundEffectType.GRASS));
    public static final Block PALE_OAK_LEAVES = register("pale_oak_leaves", (blockbase_info) -> {
        return new UntintedParticleLeavesBlock(0.02F, Particles.PALE_OAK_LEAVES, blockbase_info);
    ...
    public static final Block MANGROVE_LEAVES = register("mangrove_leaves", (blockbase_info) -> {
        return new MangroveLeavesBlock(0.01F, blockbase_info);
    }, leavesProperties(SoundEffectType.GRASS));
    public static final Block AZALEA_LEAVES = register("azalea_leaves", (blockbase_info) -> {
        return new UntintedParticleLeavesBlock(0.01F, ColorParticleOption.create(Particles.TINTED_LEAVES, -9399763), blockbase_info);
    }, leavesProperties(SoundEffectType.AZALEA_LEAVES));
    public static final Block FLOWERING_AZALEA_LEAVES = register("flowering_azalea_leaves", (blockbase_info) -> {
        return new UntintedParticleLeavesBlock(0.01F, ColorParticleOption.create(Particles.TINTED_LEAVES, -9399763), blockbase_info);
    }, leavesProperties(SoundEffectType.AZALEA_LEAVES));
    ...
    public static final Block DEAD_BUSH = register("dead_bush", DryVegetationBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).replaceable().noCollission().instabreak().sound(SoundEffectType.GRASS).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block BUSH = register("bush", BlockPlant::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).replaceable().noCollission().instabreak().sound(SoundEffectType.GRASS).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block SHORT_DRY_GRASS = register("short_dry_grass", ShortDryGrassBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_YELLOW).replaceable().noCollission().instabreak().sound(SoundEffectType.GRASS).ignitedByLava().offsetType(BlockBase.EnumRandomOffset.XYZ).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block TALL_DRY_GRASS = register("tall_dry_grass", TallDryGrassBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_YELLOW).replaceable().noCollission().instabreak().sound(SoundEffectType.GRASS).ignitedByLava().offsetType(BlockBase.EnumRandomOffset.XYZ).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block CORNFLOWER = register("cornflower", (blockbase_info) -> {
        return new BlockFlowers(MobEffects.JUMP_BOOST, 5.0F, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block CACTUS_FLOWER = register("cactus_flower", CactusFlowerBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PINK).noCollission().instabreak().ignitedByLava().sound(SoundEffectType.CACTUS_FLOWER).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block IRON_BARS = register("iron_bars", BlockIronBars::new, BlockBase.Info.of().requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundEffectType.IRON).noOcclusion());
    ...
    public static final Block WHITE_TERRACOTTA = register("white_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_WHITE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block ORANGE_TERRACOTTA = register("orange_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_ORANGE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block MAGENTA_TERRACOTTA = register("magenta_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_MAGENTA).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block LIGHT_BLUE_TERRACOTTA = register("light_blue_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_LIGHT_BLUE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block YELLOW_TERRACOTTA = register("yellow_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_YELLOW).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block LIME_TERRACOTTA = register("lime_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_LIGHT_GREEN).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block PINK_TERRACOTTA = register("pink_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_PINK).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block GRAY_TERRACOTTA = register("gray_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_GRAY).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block LIGHT_GRAY_TERRACOTTA = register("light_gray_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_LIGHT_GRAY).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block CYAN_TERRACOTTA = register("cyan_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_CYAN).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block PURPLE_TERRACOTTA = register("purple_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_PURPLE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block BLUE_TERRACOTTA = register("blue_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_BLUE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block BROWN_TERRACOTTA = register("brown_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_BROWN).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block GREEN_TERRACOTTA = register("green_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_GREEN).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block RED_TERRACOTTA = register("red_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_RED).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    public static final Block BLACK_TERRACOTTA = register("black_terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_BLACK).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    ...
    public static final Block TERRACOTTA = register("terracotta", TerracottaBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.25F, 4.2F));
    ...
    public static final Block TEST_BLOCK = register("test_block", TestBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_LIGHT_GRAY).strength(-1.0F, 3600000.0F).noLootTable());
    public static final Block TEST_INSTANCE_BLOCK = register("test_instance_block", TestInstanceBlock::new, BlockBase.Info.of().noOcclusion().strength(-1.0F, 3600000.0F).noLootTable().isViewBlocking(Blocks::never));
    ...
    public static final Block AMETHYST_CLUSTER = register("amethyst_cluster", (blockbase_info) -> {
        return new AmethystClusterBlock(7.0F, 10.0F, blockbase_info);
    ...
    public static final Block LARGE_AMETHYST_BUD = register("large_amethyst_bud", (blockbase_info) -> {
        return new AmethystClusterBlock(5.0F, 10.0F, blockbase_info);
    ...
    public static final Block MEDIUM_AMETHYST_BUD = register("medium_amethyst_bud", (blockbase_info) -> {
        return new AmethystClusterBlock(4.0F, 10.0F, blockbase_info);
    ...
    public static final Block SMALL_AMETHYST_BUD = register("small_amethyst_bud", (blockbase_info) -> {
        return new AmethystClusterBlock(3.0F, 8.0F, blockbase_info);
    ...
    public static final Block PINK_PETALS = register("pink_petals", FlowerBedBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().sound(SoundEffectType.PINK_PETALS).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block WILDFLOWERS = register("wildflowers", FlowerBedBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().sound(SoundEffectType.PINK_PETALS).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block LEAF_LITTER = register("leaf_litter", LeafLitterBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BROWN).replaceable().noCollission().sound(SoundEffectType.LEAF_LITTER).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block FIREFLY_BUSH = register("firefly_bush", FireflyBushBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).ignitedByLava().lightLevel((iblockdata) -> {
        return 2;
