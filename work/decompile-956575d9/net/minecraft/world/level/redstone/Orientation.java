...
public class Orientation {
    ...
    public static Orientation random(RandomSource randomsource) {
        return (Orientation) SystemUtils.getRandom(Orientation.ORIENTATIONS, randomsource);
    }
    ...
    private static Orientation generateContext(Orientation orientation, Orientation[] aorientation) {
        if (aorientation[orientation.getIndex()] != null) {
            ...
            for (Orientation.a orientation_a : Orientation.a.values()) {
            ...
            for (EnumDirection enumdirection : EnumDirection.values()) {
                EnumDirection enumdirection1 = orientation.up;
            ...
            for (EnumDirection enumdirection2 : EnumDirection.values()) {
                EnumDirection enumdirection3 = orientation.front;

                if (enumdirection2 == orientation.front) {
                    enumdirection3 = orientation.up.getOpposite();
                }

                if (enumdirection2 == orientation.front.getOpposite()) {
                    enumdirection3 = orientation.up;
                }

                orientation.withUp.put(enumdirection2, generateContext(new Orientation(enumdirection2, enumdirection3, orientation.sideBias), aorientation));
            }
