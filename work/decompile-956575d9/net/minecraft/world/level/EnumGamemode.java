...
public enum EnumGamemode implements INamable {
    ...
    public static final INamable.a<EnumGamemode> CODEC = INamable.<EnumGamemode>fromEnum(EnumGamemode::values);
    private static final IntFunction<EnumGamemode> BY_ID = ByIdMap.<EnumGamemode>continuous(EnumGamemode::getId, values(), ByIdMap.a.ZERO);
    /** @deprecated */
    @Deprecated
    public static final Codec<EnumGamemode> LEGACY_ID_CODEC = Codec.INT.xmap(EnumGamemode::byId, EnumGamemode::getId);
    ...
    private EnumGamemode(final int i, final String s) {
        this.id = i;
        this.name = s;
    ...
    public static EnumGamemode byName(String s, @Nullable EnumGamemode enumgamemode) {
        EnumGamemode enumgamemode1 = EnumGamemode.CODEC.byName(s);
