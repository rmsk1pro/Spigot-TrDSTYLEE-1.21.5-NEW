...
public class LightEngineStorageSky extends LightEngineStorage<LightEngineStorageSky.a> {
    ...
    protected NibbleArray createDataLayer(long i) {
        ...
        if (nibblearray != null) {
            ...
            int j = (this.updatingSectionData).topSections.get(SectionPosition.getZeroNode(i));

            if (j != (this.updatingSectionData).currentLowestY && SectionPosition.y(i) < j) {
    ...
    protected boolean isAboveData(long i) {
        ...
        return k == (this.updatingSectionData).currentLowestY || SectionPosition.y(i) >= k;
    }
