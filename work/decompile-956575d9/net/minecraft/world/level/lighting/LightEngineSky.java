...
public final class LightEngineSky extends LightEngine<LightEngineStorageSky.a, LightEngineStorageSky> {
    ...
    protected void propagateIncrease(long i, long j, int k) {
        ...
        for (EnumDirection enumdirection : LightEngineSky.PROPAGATION_DIRECTIONS) {
            if (LightEngine.a.shouldPropagateInDirection(j, enumdirection)) {
                long i1 = BlockPosition.offset(i, enumdirection);

                if (((LightEngineStorageSky) this.storage).storingLightForSection(SectionPosition.blockToSection(i1))) {
                    int j1 = ((LightEngineStorageSky) this.storage).getStoredLevel(i1);
                    int k1 = k - 1;

                    if (k1 > j1) {
                        this.mutablePos.set(i1);
                        IBlockData iblockdata1 = this.getState(this.mutablePos);
                        int l1 = k - this.getOpacity(iblockdata1);
                        ...
                        if (l1 > j1) {
                            ...
                            if (!this.shapeOccludes(iblockdata, iblockdata1, enumdirection)) {
                                ((LightEngineStorageSky) this.storage).setStoredLevel(i1, l1);
                                if (l1 > 1) {
                                    this.enqueueIncrease(i1, LightEngine.a.increaseSkipOneDirection(l1, isEmptyShape(iblockdata1), enumdirection.getOpposite()));
                                }

                                this.propagateFromEmptySections(i1, enumdirection, l1, true, l);
                            }
                        }
                    }
                }
        ...
        for (EnumDirection enumdirection : LightEngineSky.PROPAGATION_DIRECTIONS) {
            if (LightEngine.a.shouldPropagateInDirection(j, enumdirection)) {
                ...
                if (((LightEngineStorageSky) this.storage).storingLightForSection(SectionPosition.blockToSection(i1))) {
                    ...
                    if (j1 != 0) {
                        if (j1 <= l - 1) {
                            ((LightEngineStorageSky) this.storage).setStoredLevel(i1, 0);
                            this.enqueueDecrease(i1, LightEngine.a.decreaseSkipOneDirection(j1, enumdirection.getOpposite()));
                            this.propagateFromEmptySections(i1, enumdirection, j1, false, k);
                        } else {
                            this.enqueueIncrease(i1, LightEngine.a.increaseOnlyOneDirection(j1, false, enumdirection.getOpposite()));
                        }
                    }
                }
            }
