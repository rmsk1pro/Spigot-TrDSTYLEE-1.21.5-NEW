...
public class ProtoChunkExtension extends ProtoChunk {
    ...
    public ProtoChunkExtension(Chunk chunk, boolean flag) {
        super(chunk.getPos(), ChunkConverter.EMPTY, chunk.levelHeightAccessor, chunk.getLevel().registryAccess().lookupOrThrow(Registries.BIOME), chunk.getBlendingData());
        this.wrapped = chunk;
    ...
    public IBlockData setBlockState(BlockPosition blockposition, IBlockData iblockdata, int i) {
        return this.allowWrites ? this.wrapped.setBlockState(blockposition, iblockdata, i) : null;
    }
    ...
    public IChunkAccess.a getTicksForSerialization(long i) {
        return this.wrapped.getTicksForSerialization(i);
    }
