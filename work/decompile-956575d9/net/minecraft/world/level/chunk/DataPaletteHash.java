...
public class DataPaletteHash<T> implements DataPalette<T> {
    ...
    public static <A> DataPalette<A> create(int i, Registry<A> registry, DataPaletteExpandable<A> datapaletteexpandable, List<A> list) {
        return new DataPaletteHash<A>(registry, i, datapaletteexpandable, list);
    }
    ...
    public DataPalette<T> copy(DataPaletteExpandable<T> datapaletteexpandable) {
        return new DataPaletteHash<T>(this.registry, this.bits, datapaletteexpandable, this.values.copy());
    }
}
