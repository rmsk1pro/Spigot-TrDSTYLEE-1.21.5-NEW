...
public abstract class IChunkAccess implements BiomeManager.Provider, LightChunk, StructureAccess {
    ...
    public abstract IChunkAccess.a getTicksForSerialization(long i);
    ...
    public static record a(List<TickListChunk<Block>> blocks, List<TickListChunk<FluidType>> fluids) {
