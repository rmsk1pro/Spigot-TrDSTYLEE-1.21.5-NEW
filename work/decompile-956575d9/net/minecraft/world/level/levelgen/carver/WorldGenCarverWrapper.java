...
public record WorldGenCarverWrapper<WC extends WorldGenCarverConfiguration>(WorldGenCarverAbstract<WC> worldCarver, WC config) {
    ...
    public static final Codec<Holder<WorldGenCarverWrapper<?>>> CODEC = RegistryFileCodec.<Holder<WorldGenCarverWrapper<?>>>create(Registries.CONFIGURED_CARVER, WorldGenCarverWrapper.DIRECT_CODEC);
