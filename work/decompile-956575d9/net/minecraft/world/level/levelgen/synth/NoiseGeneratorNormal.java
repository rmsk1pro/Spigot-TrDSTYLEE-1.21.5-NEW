...
public class NoiseGeneratorNormal {
    ...
    public static record a(int firstOctave, DoubleList amplitudes) {
        ...
        public static final Codec<Holder<NoiseGeneratorNormal.a>> CODEC = RegistryFileCodec.<Holder<NoiseGeneratorNormal.a>>create(Registries.NOISE, NoiseGeneratorNormal.a.DIRECT_CODEC);
