...
public class BlendedNoise implements DensityFunction.d {
    ...
    public double compute(DensityFunction.b densityfunction_b) {
        ...
        for (int j = 0; j < 16; ++j) {
            ...
            if (!flag1) {
                NoiseGeneratorPerlin noisegeneratorperlin1 = this.minLimitNoise.getOctaveNoise(j);
            ...
            if (!flag2) {
                NoiseGeneratorPerlin noisegeneratorperlin2 = this.maxLimitNoise.getOctaveNoise(j);

                if (noisegeneratorperlin2 != null) {
                    d9 += noisegeneratorperlin2.noise(d13, d14, d15, d16, d1 * d11) / d11;
                }
            }
