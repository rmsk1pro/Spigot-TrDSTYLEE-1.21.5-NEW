...
public class NoiseRouterData {
    ...
    private static void registerTerrainNoises(BootstrapContext<DensityFunction> bootstrapcontext, HolderGetter<DensityFunction> holdergetter, DensityFunction densityfunction, Holder<DensityFunction> holder, Holder<DensityFunction> holder1, ResourceKey<DensityFunction> resourcekey, ResourceKey<DensityFunction> resourcekey1, ResourceKey<DensityFunction> resourcekey2, ResourceKey<DensityFunction> resourcekey3, ResourceKey<DensityFunction> resourcekey4, boolean flag) {
        ...
        DensityFunction densityfunction2 = registerAndWrap(bootstrapcontext, resourcekey1, splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldFactor(densityfunctions_w_a, densityfunctions_w_a1, densityfunctions_w_a2, densityfunctions_w_a3, flag)), NoiseRouterData.BLENDING_FACTOR));
        DensityFunction densityfunction3 = registerAndWrap(bootstrapcontext, resourcekey3, DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5D, -1.5D), densityfunction1));
        DensityFunction densityfunction4 = registerAndWrap(bootstrapcontext, resourcekey2, splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldJaggedness(densityfunctions_w_a, densityfunctions_w_a1, densityfunctions_w_a2, densityfunctions_w_a3, flag)), NoiseRouterData.BLENDING_JAGGEDNESS));
    ...
    private static DensityFunction registerAndWrap(BootstrapContext<DensityFunction> bootstrapcontext, ResourceKey<DensityFunction> resourcekey, DensityFunction densityfunction) {
        return new DensityFunctions.j(bootstrapcontext.register(resourcekey, densityfunction));
    }
