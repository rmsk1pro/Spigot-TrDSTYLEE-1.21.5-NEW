...
public class SurfaceRules {
    ...
    public static SurfaceRules.f verticalGradient(String s, VerticalAnchor verticalanchor, VerticalAnchor verticalanchor1) {
        return new SurfaceRules.y(MinecraftKey.parse(s), verticalanchor, verticalanchor1);
    }
    ...
    static <A> MapCodec<? extends A> register(IRegistry<MapCodec<? extends A>> iregistry, String s, KeyDispatchDataCodec<? extends A> keydispatchdatacodec) {
    ...
    protected static final class g {
        ...
        private static class d extends SurfaceRules.k {
            ...
            @Override
            protected boolean compute() {
                return ((BiomeBase) ((Holder) this.context.biome.get()).value()).coldEnoughToSnow(this.context.pos.set(this.context.blockX, this.context.blockY, this.context.blockZ), this.context.getSeaLevel());
            }
        }
    ...
    private static record p(List<SurfaceRules.u> rules) implements SurfaceRules.u {
        ...
        @Override
        public IBlockData tryApply(int i, int j, int k) {
            for (SurfaceRules.u surfacerules_u : this.rules) {
    ...
    public interface f extends Function<SurfaceRules.g, SurfaceRules.e> {
        ...
        static MapCodec<? extends SurfaceRules.f> bootstrap(IRegistry<MapCodec<? extends SurfaceRules.f>> iregistry) {
            ...
            return SurfaceRules.<SurfaceRules.f>register(iregistry, "stone_depth", SurfaceRules.t.CODEC);
        }
    ...
    public interface o extends Function<SurfaceRules.g, SurfaceRules.u> {
        ...
        static MapCodec<? extends SurfaceRules.o> bootstrap(IRegistry<MapCodec<? extends SurfaceRules.o>> iregistry) {
            ...
            return SurfaceRules.<SurfaceRules.o>register(iregistry, "condition", SurfaceRules.x.CODEC);
        }
    ...
    private static record n(SurfaceRules.f target) implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.n> CODEC = KeyDispatchDataCodec.<SurfaceRules.n>of(SurfaceRules.f.CODEC.xmap(SurfaceRules.n::new, SurfaceRules.n::target).fieldOf("invert"));
    ...
    private static record t(int offset, boolean addSurfaceDepth, int secondaryDepthRange, CaveSurface surfaceType) implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.t> CODEC = KeyDispatchDataCodec.<SurfaceRules.t>of(RecordCodecBuilder.mapCodec((instance) -> {
    ...
    private static enum a implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.a> CODEC = KeyDispatchDataCodec.<SurfaceRules.a>of(MapCodec.unit(SurfaceRules.a.INSTANCE));
    ...
    private static enum h implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.h> CODEC = KeyDispatchDataCodec.<SurfaceRules.h>of(MapCodec.unit(SurfaceRules.h.INSTANCE));
    ...
    private static record aa(VerticalAnchor anchor, int surfaceDepthMultiplier, boolean addStoneDepth) implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.aa> CODEC = KeyDispatchDataCodec.<SurfaceRules.aa>of(RecordCodecBuilder.mapCodec((instance) -> {
    ...
    private static record z(int offset, int surfaceDepthMultiplier, boolean addStoneDepth) implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.z> CODEC = KeyDispatchDataCodec.<SurfaceRules.z>of(RecordCodecBuilder.mapCodec((instance) -> {
    ...
    private static final class c implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.c> CODEC = KeyDispatchDataCodec.<SurfaceRules.c>of(ResourceKey.codec(Registries.BIOME).listOf().fieldOf("biome_is").xmap(SurfaceRules::isBiome, (surfacerules_c) -> {
    ...
    private static record l(ResourceKey<NoiseGeneratorNormal.a> noise, double minThreshold, double maxThreshold) implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.l> CODEC = KeyDispatchDataCodec.<SurfaceRules.l>of(RecordCodecBuilder.mapCodec((instance) -> {
    ...
    private static record y(MinecraftKey randomName, VerticalAnchor trueAtAndBelow, VerticalAnchor falseAtAndAbove) implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.y> CODEC = KeyDispatchDataCodec.<SurfaceRules.y>of(RecordCodecBuilder.mapCodec((instance) -> {
    ...
    private static enum v implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.v> CODEC = KeyDispatchDataCodec.<SurfaceRules.v>of(MapCodec.unit(SurfaceRules.v.INSTANCE));
    ...
    private static enum s implements SurfaceRules.f {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.s> CODEC = KeyDispatchDataCodec.<SurfaceRules.s>of(MapCodec.unit(SurfaceRules.s.INSTANCE));
    ...
    private static record d(IBlockData resultState, SurfaceRules.r rule) implements SurfaceRules.o {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.d> CODEC = KeyDispatchDataCodec.<SurfaceRules.d>of(IBlockData.CODEC.xmap(SurfaceRules.d::new, SurfaceRules.d::resultState).fieldOf("result_state"));
    ...
    private static record x(SurfaceRules.f ifTrue, SurfaceRules.o thenRun) implements SurfaceRules.o {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.x> CODEC = KeyDispatchDataCodec.<SurfaceRules.x>of(RecordCodecBuilder.mapCodec((instance) -> {
    ...
    private static record q(List<SurfaceRules.o> sequence) implements SurfaceRules.o {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.q> CODEC = KeyDispatchDataCodec.<SurfaceRules.q>of(SurfaceRules.o.CODEC.listOf().xmap(SurfaceRules.q::new, SurfaceRules.q::sequence).fieldOf("sequence"));
        ...
        public SurfaceRules.u apply(SurfaceRules.g surfacerules_g) {
            if (this.sequence.size() == 1) {
                ...
                ImmutableList.Builder<SurfaceRules.u> immutablelist_builder = ImmutableList.builder();

                for (SurfaceRules.o surfacerules_o : this.sequence) {
                    immutablelist_builder.add((SurfaceRules.u) surfacerules_o.apply(surfacerules_g));
                }

                return new SurfaceRules.p(immutablelist_builder.build());
            }
        }
    }
    ...
    private static enum b implements SurfaceRules.o {
        ...
        static final KeyDispatchDataCodec<SurfaceRules.b> CODEC = KeyDispatchDataCodec.<SurfaceRules.b>of(MapCodec.unit(SurfaceRules.b.INSTANCE));
