...
public class DefinedStructureProcessorBlockAge extends DefinedStructureProcessor {
    ...
    public static final MapCodec<DefinedStructureProcessorBlockAge> CODEC = Codec.FLOAT.fieldOf("mossiness").xmap(DefinedStructureProcessorBlockAge::new, (definedstructureprocessorblockage) -> {
    ...
    private static IBlockData getRandomFacingStairs(RandomSource randomsource, Block block) {
        return (IBlockData) ((IBlockData) block.defaultBlockState().setValue(BlockStairs.FACING, EnumDirection.EnumDirectionLimit.HORIZONTAL.getRandomDirection(randomsource))).setValue(BlockStairs.HALF, (BlockPropertyHalf) SystemUtils.getRandom(BlockPropertyHalf.values(), randomsource));
    }
