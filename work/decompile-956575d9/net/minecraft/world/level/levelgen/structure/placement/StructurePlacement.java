...
public abstract class StructurePlacement {
    ...
    protected static <S extends StructurePlacement> Products.P5<RecordCodecBuilder.Mu<S>, BaseBlockPosition, StructurePlacement.c, Float, Integer, Optional<StructurePlacement.a>> placementCodec(RecordCodecBuilder.Instance<S> recordcodecbuilder_instance) {
        return recordcodecbuilder_instance.group(BaseBlockPosition.offsetCodec(16).optionalFieldOf("locate_offset", BaseBlockPosition.ZERO).forGetter(StructurePlacement::locateOffset), StructurePlacement.c.CODEC.optionalFieldOf("frequency_reduction_method", StructurePlacement.c.DEFAULT).forGetter(StructurePlacement::frequencyReductionMethod), Codec.floatRange(0.0F, 1.0F).optionalFieldOf("frequency", 1.0F).forGetter(StructurePlacement::frequency), ExtraCodecs.NON_NEGATIVE_INT.fieldOf("salt").forGetter(StructurePlacement::salt), StructurePlacement.a.CODEC.optionalFieldOf("exclusion_zone").forGetter(StructurePlacement::exclusionZone));
    }
    ...
    public boolean applyAdditionalChunkRestrictions(int i, int j, long k) {
        return this.frequency >= 1.0F || this.frequencyReductionMethod.shouldGenerate(k, this.salt, i, j, this.frequency);
    }
    ...
    public boolean applyInteractionsWithOtherStructures(ChunkGeneratorStructureState chunkgeneratorstructurestate, int i, int j) {
        return !this.exclusionZone.isPresent() || !((StructurePlacement.a) this.exclusionZone.get()).isPlacementForbidden(chunkgeneratorstructurestate, i, j);
    }
    ...
    public static enum c implements INamable {
        ...
        public static final Codec<StructurePlacement.c> CODEC = INamable.<StructurePlacement.c>fromEnum(StructurePlacement.c::values);
        private final String name;
        private final StructurePlacement.b reducer;

        private c(final String s, final StructurePlacement.b structureplacement_b) {
            this.name = s;
