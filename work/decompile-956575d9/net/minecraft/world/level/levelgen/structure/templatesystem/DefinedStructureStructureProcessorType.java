...
public interface DefinedStructureStructureProcessorType<P extends DefinedStructureProcessor> {
    ...
    Codec<Holder<ProcessorList>> LIST_CODEC = RegistryFileCodec.<Holder<ProcessorList>>create(Registries.PROCESSOR_LIST, DefinedStructureStructureProcessorType.DIRECT_CODEC);
    ...
    static <P extends DefinedStructureProcessor> DefinedStructureStructureProcessorType<P> register(String s, MapCodec<P> mapcodec) {
        return (DefinedStructureStructureProcessorType) IRegistry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, s, (DefinedStructureStructureProcessorType) () -> {
            return mapcodec;
        });
    }
}
