...
public class MineshaftStructure extends Structure {
    ...
    public static enum a implements INamable {
        ...
        public static final Codec<MineshaftStructure.a> CODEC = INamable.<MineshaftStructure.a>fromEnum(MineshaftStructure.a::values);
        private static final IntFunction<MineshaftStructure.a> BY_ID = ByIdMap.<MineshaftStructure.a>continuous(Enum::ordinal, values(), ByIdMap.a.ZERO);
        private final String name;
        private final IBlockData woodState;
        private final IBlockData planksState;
        private final IBlockData fenceState;

        private a(final String s, final Block block, final Block block1, final Block block2) {
            this.name = s;
