        ...
        if (iblockdata.is(Blocks.JIGSAW)) {
            if (definedstructure_blockinfo1.nbt() == null) {
                ...
                try {
                    ...
                    DefinedStructureProcessorJigsawReplacement.LOGGER.error("Failed to parse jigsaw replacement state '{}' at {}: {}", new Object[]{s, blockposition, commandsyntaxexception.getMessage()});
                    return null;
                }
