...
public class NetherFortressPieces {
    ...
    static NetherFortressPieces.m findAndCreateBridgePieceFactory(NetherFortressPieces.n netherfortresspieces_n, StructurePieceAccessor structurepieceaccessor, RandomSource randomsource, int i, int j, int k, EnumDirection enumdirection, int l) {
        ...
        NetherFortressPieces.m netherfortresspieces_m = null;

        if (oclass == NetherFortressPieces.c.class) {
            netherfortresspieces_m = NetherFortressPieces.c.createPiece(structurepieceaccessor, randomsource, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.a.class) {
            netherfortresspieces_m = NetherFortressPieces.a.createPiece(structurepieceaccessor, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.o.class) {
            netherfortresspieces_m = NetherFortressPieces.o.createPiece(structurepieceaccessor, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.p.class) {
            netherfortresspieces_m = NetherFortressPieces.p.createPiece(structurepieceaccessor, i, j, k, l, enumdirection);
        } else if (oclass == NetherFortressPieces.l.class) {
            netherfortresspieces_m = NetherFortressPieces.l.createPiece(structurepieceaccessor, i, j, k, l, enumdirection);
        } else if (oclass == NetherFortressPieces.f.class) {
            netherfortresspieces_m = NetherFortressPieces.f.createPiece(structurepieceaccessor, randomsource, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.i.class) {
            netherfortresspieces_m = NetherFortressPieces.i.createPiece(structurepieceaccessor, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.j.class) {
            netherfortresspieces_m = NetherFortressPieces.j.createPiece(structurepieceaccessor, randomsource, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.h.class) {
            netherfortresspieces_m = NetherFortressPieces.h.createPiece(structurepieceaccessor, randomsource, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.d.class) {
            netherfortresspieces_m = NetherFortressPieces.d.createPiece(structurepieceaccessor, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.e.class) {
            netherfortresspieces_m = NetherFortressPieces.e.createPiece(structurepieceaccessor, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.g.class) {
            netherfortresspieces_m = NetherFortressPieces.g.createPiece(structurepieceaccessor, i, j, k, enumdirection, l);
        } else if (oclass == NetherFortressPieces.k.class) {
            netherfortresspieces_m = NetherFortressPieces.k.createPiece(structurepieceaccessor, i, j, k, enumdirection, l);
        }
    ...
    private abstract static class m extends StructurePiece {
        ...
        private int updatePieceWeight(List<NetherFortressPieces.n> list) {
            ...
            for (NetherFortressPieces.n netherfortresspieces_n : list) {
        ...
        private StructurePiece generateAndAddPiece(NetherFortressPieces.q netherfortresspieces_q, StructurePieceAccessor structurepieceaccessor, RandomSource randomsource, int i, int j, int k, @Nullable EnumDirection enumdirection, int l, boolean flag) {
            if (Math.abs(i - netherfortresspieces_q.getBoundingBox().minX()) <= 112 && Math.abs(k - netherfortresspieces_q.getBoundingBox().minZ()) <= 112) {
                ...
                StructurePiece structurepiece = this.generatePiece(netherfortresspieces_q, list, structurepieceaccessor, randomsource, i, j, k, enumdirection, l + 1);
    ...
    public static class q extends NetherFortressPieces.a {
        ...
        public q(RandomSource randomsource, int i, int j) {
            ...
            for (NetherFortressPieces.n netherfortresspieces_n : NetherFortressPieces.BRIDGE_PIECE_WEIGHTS) {
            ...
            for (NetherFortressPieces.n netherfortresspieces_n1 : NetherFortressPieces.CASTLE_PIECE_WEIGHTS) {
    ...
    public static class l extends NetherFortressPieces.m {
        ...
        public void postProcess(GeneratorAccessSeed generatoraccessseed, StructureManager structuremanager, ChunkGenerator chunkgenerator, RandomSource randomsource, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair, BlockPosition blockposition) {
            ...
            if (!this.hasPlacedSpawner) {
                BlockPosition blockposition1 = this.getWorldPos(3, 5, 5);
    ...
    public static class f extends NetherFortressPieces.m {
        ...
        public void postProcess(GeneratorAccessSeed generatoraccessseed, StructureManager structuremanager, ChunkGenerator chunkgenerator, RandomSource randomsource, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair, BlockPosition blockposition) {
            ...
            for (int j = 3; j <= 9; j += 2) {
                this.generateBox(generatoraccessseed, structureboundingbox, 1, 7, j, 1, 8, j, (IBlockData) iblockdata1.setValue(BlockFence.WEST, true), (IBlockData) iblockdata1.setValue(BlockFence.WEST, true), false);
                this.generateBox(generatoraccessseed, structureboundingbox, 11, 7, j, 11, 8, j, (IBlockData) iblockdata1.setValue(BlockFence.EAST, true), (IBlockData) iblockdata1.setValue(BlockFence.EAST, true), false);
            }
            ...
            BlockPosition blockposition1 = this.getWorldPos(6, 5, 6);

            if (structureboundingbox.isInside(blockposition1)) {
                generatoraccessseed.scheduleTick(blockposition1, (FluidType) FluidTypes.LAVA, 0);
            }
    ...
    public static class e extends NetherFortressPieces.m {
        ...
        public void addChildren(StructurePiece structurepiece, StructurePieceAccessor structurepieceaccessor, RandomSource randomsource) {
            ...
            this.generateChildLeft((NetherFortressPieces.q) structurepiece, structurepieceaccessor, randomsource, 0, i, randomsource.nextInt(8) > 0);
            this.generateChildRight((NetherFortressPieces.q) structurepiece, structurepieceaccessor, randomsource, 0, i, randomsource.nextInt(8) > 0);
        }
