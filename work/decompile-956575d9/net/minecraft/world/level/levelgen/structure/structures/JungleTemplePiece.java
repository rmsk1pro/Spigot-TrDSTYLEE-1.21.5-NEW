...
public class JungleTemplePiece extends WorldGenScatteredPiece {
    ...
    public JungleTemplePiece(NBTTagCompound nbttagcompound) {
        ...
        this.placedMainChest = nbttagcompound.getBooleanOr("placedMainChest", false);
        this.placedHiddenChest = nbttagcompound.getBooleanOr("placedHiddenChest", false);
        this.placedTrap1 = nbttagcompound.getBooleanOr("placedTrap1", false);
        this.placedTrap2 = nbttagcompound.getBooleanOr("placedTrap2", false);
    }
        ...
        if (this.updateAverageGroundHeight(generatoraccessseed, structureboundingbox, 0)) {
            ...
            for (int j = 0; j <= 11; j += 11) {
                for (int k = 2; k <= 12; k += 2) {
                    this.generateBox(generatoraccessseed, structureboundingbox, j, 4, k, j, 5, k, false, randomsource, JungleTemplePiece.STONE_SELECTOR);
                }

                this.generateBox(generatoraccessseed, structureboundingbox, j, 6, 5, j, 6, 5, false, randomsource, JungleTemplePiece.STONE_SELECTOR);
                this.generateBox(generatoraccessseed, structureboundingbox, j, 6, 9, j, 6, 9, false, randomsource, JungleTemplePiece.STONE_SELECTOR);
            }
            ...
            for (int l = 0; l < 4; ++l) {
                this.placeBlock(generatoraccessseed, iblockdata2, 5, 0 - l, 6 + l, structureboundingbox);
                this.placeBlock(generatoraccessseed, iblockdata2, 6, 0 - l, 6 + l, structureboundingbox);
                this.generateAirBox(generatoraccessseed, structureboundingbox, 5, 0 - l, 7 + l, 6, 0 - l, 9 + l);
            }
            ...
            for (int i1 = 1; i1 <= 13; i1 += 2) {
                this.generateBox(generatoraccessseed, structureboundingbox, 1, -3, i1, 1, -2, i1, false, randomsource, JungleTemplePiece.STONE_SELECTOR);
            }

            for (int j1 = 2; j1 <= 12; j1 += 2) {
                this.generateBox(generatoraccessseed, structureboundingbox, 1, -1, j1, 3, -1, j1, false, randomsource, JungleTemplePiece.STONE_SELECTOR);
            }
