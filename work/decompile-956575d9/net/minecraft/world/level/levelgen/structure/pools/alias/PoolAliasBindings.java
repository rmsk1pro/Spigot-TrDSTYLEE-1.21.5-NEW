...
public class PoolAliasBindings {
    ...
    public static MapCodec<? extends PoolAliasBinding> bootstrap(IRegistry<MapCodec<? extends PoolAliasBinding>> iregistry) {
        IRegistry.register(iregistry, "random", RandomPoolAlias.CODEC);
        IRegistry.register(iregistry, "random_group", RandomGroupPoolAlias.CODEC);
        return (MapCodec) IRegistry.register(iregistry, "direct", DirectPoolAlias.CODEC);
    }
