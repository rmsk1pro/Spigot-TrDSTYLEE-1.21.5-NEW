...
public class StructureCheck {
    ...
    public StructureCheckResult checkStart(ChunkCoordIntPair chunkcoordintpair, Structure structure, StructurePlacement structureplacement, boolean flag) {
        ...
        if (object2intmap != null) {
            ...
            } else if (!structureplacement.applyAdditionalChunkRestrictions(chunkcoordintpair.x, chunkcoordintpair.z, this.seed)) {
    ...
    private Object2IntMap<Structure> loadStructures(NBTTagCompound nbttagcompound) {
        Optional<NBTTagCompound> optional = nbttagcompound.getCompound("structures").flatMap((nbttagcompound1) -> {
            return nbttagcompound1.getCompound("starts");
        });
            ...
            if (nbttagcompound1.isEmpty()) {
                ...
                nbttagcompound1.forEach((s, nbtbase) -> {
                    ...
                    if (minecraftkey != null) {
                        ...
                        if (structure != null) {
                            nbtbase.asCompound().ifPresent((nbttagcompound2) -> {
                                String s1 = nbttagcompound2.getStringOr("id", "");

                                if (!"INVALID".equals(s1)) {
                                    int i = nbttagcompound2.getIntOr("references", 0);
