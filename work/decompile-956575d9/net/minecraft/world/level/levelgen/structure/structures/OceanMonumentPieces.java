...
public class OceanMonumentPieces {
    ...
    protected abstract static class r extends StructurePiece {
        ...
        protected void spawnElder(GeneratorAccessSeed generatoraccessseed, StructureBoundingBox structureboundingbox, int i, int j, int k) {
            ...
            if (structureboundingbox.isInside(blockposition)) {
                EntityGuardianElder entityguardianelder = EntityTypes.ELDER_GUARDIAN.create(generatoraccessseed.getLevel(), EntitySpawnReason.STRUCTURE);

                if (entityguardianelder != null) {
                    entityguardianelder.heal(entityguardianelder.getMaxHealth());
                    entityguardianelder.snapTo((double) blockposition.getX() + 0.5D, (double) blockposition.getY(), (double) blockposition.getZ() + 0.5D, 0.0F, 0.0F);
                    entityguardianelder.finalizeSpawn(generatoraccessseed, generatoraccessseed.getCurrentDifficultyAt(entityguardianelder.blockPosition()), EntitySpawnReason.STRUCTURE, (GroupDataEntity) null);
    ...
    public static class h extends OceanMonumentPieces.r {
        ...
        public h(RandomSource randomsource, int i, int j, EnumDirection enumdirection) {
            ...
            for (OceanMonumentPieces.v oceanmonumentpieces_v : list) {
                if (!oceanmonumentpieces_v.claimed && !oceanmonumentpieces_v.isSpecial()) {
                    for (OceanMonumentPieces.i oceanmonumentpieces_i : list1) {
            ...
            BlockPosition blockposition = this.getWorldPos(9, 0, 22);

            for (OceanMonumentPieces.r oceanmonumentpieces_r : this.childPieces) {
                oceanmonumentpieces_r.getBoundingBox().move(blockposition);
            }
        ...
        private List<OceanMonumentPieces.v> generateRoomGraph(RandomSource randomsource) {
            ...
            for (int i = 0; i < 5; ++i) {
                for (int j = 0; j < 4; ++j) {
                    ...
                    aoceanmonumentpieces_v[l] = new OceanMonumentPieces.v(l);
                }
            }
            ...
            for (int i1 = 0; i1 < 5; ++i1) {
                for (int j1 = 0; j1 < 4; ++j1) {
                    ...
                    aoceanmonumentpieces_v[l1] = new OceanMonumentPieces.v(l1);
                }
            }
            ...
            for (int i2 = 1; i2 < 4; ++i2) {
                for (int j2 = 0; j2 < 2; ++j2) {
                    ...
                    aoceanmonumentpieces_v[l2] = new OceanMonumentPieces.v(l2);
                }
            }
            ...
            for (int i3 = 0; i3 < 5; ++i3) {
                for (int j3 = 0; j3 < 5; ++j3) {
                    for (int k3 = 0; k3 < 3; ++k3) {
                        ...
                        if (aoceanmonumentpieces_v[l3] != null) {
                            for (EnumDirection enumdirection : EnumDirection.values()) {
                                int i4 = i3 + enumdirection.getStepX();
                                int j4 = k3 + enumdirection.getStepY();
                                int k4 = j3 + enumdirection.getStepZ();

                                if (i4 >= 0 && i4 < 5 && k4 >= 0 && k4 < 5 && j4 >= 0 && j4 < 3) {
                                    int l4 = getRoomIndex(i4, j4, k4);

                                    if (aoceanmonumentpieces_v[l4] != null) {
                                        if (k4 == j3) {
                                            aoceanmonumentpieces_v[l3].setConnection(enumdirection, aoceanmonumentpieces_v[l4]);
                                        } else {
                                            aoceanmonumentpieces_v[l3].setConnection(enumdirection.getOpposite(), aoceanmonumentpieces_v[l4]);
                                        }
                                    }
                                }
                            }
            ...
            for (OceanMonumentPieces.v oceanmonumentpieces_v3 : aoceanmonumentpieces_v) {
            ...
            while (objectlistiterator.hasNext()) {
                ...
                while (j5 < 2 && k5 < 5) {
                    ...
                    if (oceanmonumentpieces_v4.hasOpening[l5]) {
                        int i6 = EnumDirection.from3DDataValue(l5).getOpposite().get3DDataValue();

                        oceanmonumentpieces_v4.hasOpening[l5] = false;
                        oceanmonumentpieces_v4.connections[l5].hasOpening[i6] = false;
                        if (oceanmonumentpieces_v4.findSource(i5++) && oceanmonumentpieces_v4.connections[l5].findSource(i5++)) {
                            ++j5;
                        } else {
                            oceanmonumentpieces_v4.hasOpening[l5] = true;
                            oceanmonumentpieces_v4.connections[l5].hasOpening[i6] = true;
                        }
                    }
                }
            }
        ...
        public void postProcess(GeneratorAccessSeed generatoraccessseed, StructureManager structuremanager, ChunkGenerator chunkgenerator, RandomSource randomsource, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair, BlockPosition blockposition) {
            ...
            for (int l1 = 0; l1 < 5; ++l1) {
                this.generateWaterBox(generatoraccessseed, structureboundingbox, -1 - l1, 0 + l1 * 2, -1 - l1, -1 - l1, 23, 58 + l1);
                this.generateWaterBox(generatoraccessseed, structureboundingbox, 58 + l1, 0 + l1 * 2, -1 - l1, 58 + l1, 23, 58 + l1);
                this.generateWaterBox(generatoraccessseed, structureboundingbox, 0 - l1, 0 + l1 * 2, -1 - l1, 57 + l1, 23, -1 - l1);
                this.generateWaterBox(generatoraccessseed, structureboundingbox, 0 - l1, 0 + l1 * 2, 58 + l1, 57 + l1, 23, 58 + l1);
            }
        ...
        private void generateWing(boolean flag, int i, GeneratorAccessSeed generatoraccessseed, RandomSource randomsource, StructureBoundingBox structureboundingbox) {
            ...
            if (this.chunkIntersects(structureboundingbox, i, 0, i + 23, 20)) {
                ...
                for (int k = 0; k < 4; ++k) {
                    this.generateBox(generatoraccessseed, structureboundingbox, i + k, k + 1, k, i + k, k + 1, 20, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, i + k + 7, k + 5, k + 7, i + k + 7, k + 5, 20, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, i + 17 - k, k + 5, k + 7, i + 17 - k, k + 5, 20, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, i + 24 - k, k + 1, k, i + 24 - k, k + 1, 20, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, i + k + 1, k + 1, k, i + 23 - k, k + 1, k, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, i + k + 8, k + 5, k + 7, i + 16 - k, k + 5, k + 7, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                }
                ...
                for (int j1 = 20; j1 >= 5; j1 -= 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, l, 5, j1, structureboundingbox);
                }

                for (int k1 = 19; k1 >= 7; k1 -= 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 5, k1, structureboundingbox);
                }

                for (int l1 = 0; l1 < 4; ++l1) {
                    int i2 = flag ? i + 24 - (17 - l1 * 3) : i + 17 - l1 * 3;

                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i2, 5, 5, structureboundingbox);
                }
        ...
        private void generateEntranceWall(GeneratorAccessSeed generatoraccessseed, RandomSource randomsource, StructureBoundingBox structureboundingbox) {
            if (this.chunkIntersects(structureboundingbox, 15, 20, 42, 21)) {
                ...
                for (int j = 0; j < 4; ++j) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.BASE_BLACK, 28 - j, 9 + j, 21, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.BASE_BLACK, 29 + j, 9 + j, 21, structureboundingbox);
                }
                ...
                for (int k = 0; k < 3; ++k) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.BASE_BLACK, 22 - k * 2, 8, 21, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.BASE_BLACK, 22 - k * 2, 9, 21, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.BASE_BLACK, 35 + k * 2, 8, 21, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.BASE_BLACK, 35 + k * 2, 9, 21, structureboundingbox);
                }
        ...
        private void generateLowerWall(GeneratorAccessSeed generatoraccessseed, RandomSource randomsource, StructureBoundingBox structureboundingbox) {
            if (this.chunkIntersects(structureboundingbox, 0, 21, 6, 58)) {
                ...
                for (int j = 23; j < 53; j += 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, 5, 5, j, structureboundingbox);
                }

                this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, 5, 5, 52, structureboundingbox);

                for (int k = 0; k < 4; ++k) {
                    this.generateBox(generatoraccessseed, structureboundingbox, k, k + 1, 21, k, k + 1, 57 - k, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                }
            ...
            if (this.chunkIntersects(structureboundingbox, 51, 21, 58, 58)) {
                ...
                for (int l = 0; l < 4; ++l) {
                    this.generateBox(generatoraccessseed, structureboundingbox, 57 - l, l + 1, 21, 57 - l, l + 1, 57 - l, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                }

                for (int i1 = 23; i1 < 53; i1 += 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, 52, 5, i1, structureboundingbox);
                }
            ...
            if (this.chunkIntersects(structureboundingbox, 0, 51, 57, 57)) {
                ...
                for (int j1 = 0; j1 < 4; ++j1) {
                    this.generateBox(generatoraccessseed, structureboundingbox, j1 + 1, j1 + 1, 57 - j1, 56 - j1, j1 + 1, 57 - j1, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                }
            }
        ...
        private void generateMiddleWall(GeneratorAccessSeed generatoraccessseed, RandomSource randomsource, StructureBoundingBox structureboundingbox) {
            if (this.chunkIntersects(structureboundingbox, 7, 21, 13, 50)) {
                ...
                for (int j = 21; j <= 45; j += 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, 12, 9, j, structureboundingbox);
                }
            }
            ...
            if (this.chunkIntersects(structureboundingbox, 44, 21, 50, 54)) {
                ...
                for (int k = 0; k < 4; ++k) {
                    this.generateBox(generatoraccessseed, structureboundingbox, 50 - k, k + 5, 21, 50 - k, k + 5, 54, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                }

                for (int l = 21; l <= 45; l += 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, 45, 9, l, structureboundingbox);
                }
            }
            ...
            if (this.chunkIntersects(structureboundingbox, 8, 44, 49, 54)) {
                ...
                for (int i1 = 12; i1 <= 45; i1 += 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 9, 45, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 9, 52, structureboundingbox);
                    if (i1 == 12 || i1 == 18 || i1 == 24 || i1 == 33 || i1 == 39 || i1 == 45) {
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 9, 47, structureboundingbox);
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 9, 50, structureboundingbox);
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 10, 45, structureboundingbox);
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 10, 46, structureboundingbox);
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 10, 51, structureboundingbox);
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 10, 52, structureboundingbox);
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 11, 47, structureboundingbox);
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 11, 50, structureboundingbox);
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 12, 48, structureboundingbox);
                        this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, i1, 12, 49, structureboundingbox);
                    }
                }

                for (int j1 = 0; j1 < 3; ++j1) {
                    this.generateBox(generatoraccessseed, structureboundingbox, 8 + j1, 5 + j1, 54, 49 - j1, 5 + j1, 54, OceanMonumentPieces.h.BASE_GRAY, OceanMonumentPieces.h.BASE_GRAY, false);
                }
        ...
        private void generateUpperWall(GeneratorAccessSeed generatoraccessseed, RandomSource randomsource, StructureBoundingBox structureboundingbox) {
            if (this.chunkIntersects(structureboundingbox, 14, 21, 20, 43)) {
                ...
                for (int j = 23; j <= 39; j += 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, 19, 13, j, structureboundingbox);
                }
            }
            ...
            if (this.chunkIntersects(structureboundingbox, 37, 21, 43, 43)) {
                ...
                for (int k = 0; k < 4; ++k) {
                    this.generateBox(generatoraccessseed, structureboundingbox, 43 - k, k + 9, 21, 43 - k, k + 9, 43 - k, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                }

                for (int l = 23; l <= 39; l += 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, 38, 13, l, structureboundingbox);
                }
            }
            ...
            if (this.chunkIntersects(structureboundingbox, 15, 37, 42, 43)) {
                ...
                for (int i1 = 0; i1 < 4; ++i1) {
                    this.generateBox(generatoraccessseed, structureboundingbox, 15 + i1, i1 + 9, 43 - i1, 42 - i1, i1 + 9, 43 - i1, OceanMonumentPieces.h.BASE_LIGHT, OceanMonumentPieces.h.BASE_LIGHT, false);
                }

                for (int j1 = 21; j1 <= 36; j1 += 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.h.DOT_DECO_DATA, j1, 13, 38, structureboundingbox);
                }
            }
        ...
        public void postProcess(GeneratorAccessSeed generatoraccessseed, StructureManager structuremanager, ChunkGenerator chunkgenerator, RandomSource randomsource, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair, BlockPosition blockposition) {
            ...
            for (int i = 1; i <= 5; i += 4) {
                ...
                if (oceanmonumentpieces_v1.hasOpening[EnumDirection.SOUTH.get3DDataValue()]) {
                    this.generateBox(generatoraccessseed, structureboundingbox, 2, i, j, 2, i + 2, j, OceanMonumentPieces.m.BASE_LIGHT, OceanMonumentPieces.m.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, 5, i, j, 5, i + 2, j, OceanMonumentPieces.m.BASE_LIGHT, OceanMonumentPieces.m.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, 3, i + 2, j, 4, i + 2, j, OceanMonumentPieces.m.BASE_LIGHT, OceanMonumentPieces.m.BASE_LIGHT, false);
                } else {
                    this.generateBox(generatoraccessseed, structureboundingbox, 0, i, j, 7, i + 2, j, OceanMonumentPieces.m.BASE_LIGHT, OceanMonumentPieces.m.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, 0, i + 1, j, 7, i + 1, j, OceanMonumentPieces.m.BASE_GRAY, OceanMonumentPieces.m.BASE_GRAY, false);
                }
                ...
                if (oceanmonumentpieces_v1.hasOpening[EnumDirection.WEST.get3DDataValue()]) {
                    this.generateBox(generatoraccessseed, structureboundingbox, k, i, 2, k, i + 2, 2, OceanMonumentPieces.m.BASE_LIGHT, OceanMonumentPieces.m.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, k, i, 5, k, i + 2, 5, OceanMonumentPieces.m.BASE_LIGHT, OceanMonumentPieces.m.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, k, i + 2, 3, k, i + 2, 4, OceanMonumentPieces.m.BASE_LIGHT, OceanMonumentPieces.m.BASE_LIGHT, false);
                } else {
                    this.generateBox(generatoraccessseed, structureboundingbox, k, i, 0, k, i + 2, 7, OceanMonumentPieces.m.BASE_LIGHT, OceanMonumentPieces.m.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, k, i + 1, 0, k, i + 1, 7, OceanMonumentPieces.m.BASE_GRAY, OceanMonumentPieces.m.BASE_GRAY, false);
                }
    ...
    public static class n extends OceanMonumentPieces.r {
        ...
        public void postProcess(GeneratorAccessSeed generatoraccessseed, StructureManager structuremanager, ChunkGenerator chunkgenerator, RandomSource randomsource, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair, BlockPosition blockposition) {
            ...
            for (int i = 1; i <= 7; ++i) {
                IBlockData iblockdata = OceanMonumentPieces.n.BASE_LIGHT;
            ...
            for (int j = 1; j <= 7; ++j) {
                IBlockData iblockdata1 = OceanMonumentPieces.n.BASE_BLACK;

                if (j == 2 || j == 6) {
                    iblockdata1 = OceanMonumentPieces.n.LAMP_BLOCK;
                }

                this.generateBox(generatoraccessseed, structureboundingbox, 3, j, 7, 4, j, 8, iblockdata1, iblockdata1, false);
            }
        ...
        public void postProcess(GeneratorAccessSeed generatoraccessseed, StructureManager structuremanager, ChunkGenerator chunkgenerator, RandomSource randomsource, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair, BlockPosition blockposition) {
            ...
            for (int j = 1; j <= 6; ++j) {
                ...
                for (int k = 0; k <= 15; k += 15) {
                    this.generateBox(generatoraccessseed, structureboundingbox, k, j, 0, k, j, 1, iblockdata, iblockdata, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, k, j, 6, k, j, 9, iblockdata, iblockdata, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, k, j, 14, k, j, 15, iblockdata, iblockdata, false);
                }

                this.generateBox(generatoraccessseed, structureboundingbox, 1, j, 0, 1, j, 0, iblockdata, iblockdata, false);
                this.generateBox(generatoraccessseed, structureboundingbox, 6, j, 0, 9, j, 0, iblockdata, iblockdata, false);
                this.generateBox(generatoraccessseed, structureboundingbox, 14, j, 0, 14, j, 0, iblockdata, iblockdata, false);
                this.generateBox(generatoraccessseed, structureboundingbox, 1, j, 15, 14, j, 15, iblockdata, iblockdata, false);
            }
            ...
            for (int l = 3; l <= 6; l += 3) {
                for (int i1 = 6; i1 <= 9; i1 += 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.j.LAMP_BLOCK, i1, l, 6, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.j.LAMP_BLOCK, i1, l, 9, structureboundingbox);
                }
            }
        ...
        public void postProcess(GeneratorAccessSeed generatoraccessseed, StructureManager structuremanager, ChunkGenerator chunkgenerator, RandomSource randomsource, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair, BlockPosition blockposition) {
            if (this.mainDesign == 0) {
                ...
                for (int j = 18; j >= 7; j -= 3) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.u.LAMP_BLOCK, 6, 3, j, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.u.LAMP_BLOCK, 16, 3, j, structureboundingbox);
                }
                ...
                for (int j1 = 0; j1 < 2; ++j1) {
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.u.BASE_LIGHT, k, 6, 20, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.u.LAMP_BLOCK, k, 5, 20, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.u.BASE_LIGHT, k, 4, 20, structureboundingbox);
                    k = 13;
                }
                ...
                for (int k1 = 0; k1 < 2; ++k1) {
                    this.generateBox(generatoraccessseed, structureboundingbox, k, 0, 10, k, 6, 10, OceanMonumentPieces.u.BASE_LIGHT, OceanMonumentPieces.u.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, k, 0, 12, k, 6, 12, OceanMonumentPieces.u.BASE_LIGHT, OceanMonumentPieces.u.BASE_LIGHT, false);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.u.LAMP_BLOCK, k, 0, 10, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.u.LAMP_BLOCK, k, 0, 12, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.u.LAMP_BLOCK, k, 4, 10, structureboundingbox);
                    this.placeBlock(generatoraccessseed, OceanMonumentPieces.u.LAMP_BLOCK, k, 4, 12, structureboundingbox);
                    k = 12;
                }
                ...
                for (int l1 = 0; l1 < 2; ++l1) {
                    this.generateBox(generatoraccessseed, structureboundingbox, k, 0, 7, k, 2, 7, OceanMonumentPieces.u.BASE_LIGHT, OceanMonumentPieces.u.BASE_LIGHT, false);
                    this.generateBox(generatoraccessseed, structureboundingbox, k, 0, 14, k, 2, 14, OceanMonumentPieces.u.BASE_LIGHT, OceanMonumentPieces.u.BASE_LIGHT, false);
                    k = 14;
                }
    ...
    public static class q extends OceanMonumentPieces.r {
        ...
        public void postProcess(GeneratorAccessSeed generatoraccessseed, StructureManager structuremanager, ChunkGenerator chunkgenerator, RandomSource randomsource, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair, BlockPosition blockposition) {
            ...
            for (int k = 0; k < 2; ++k) {
                for (int l = 2; l <= 8; l += 3) {
                    this.generateBox(generatoraccessseed, structureboundingbox, j, 0, l, j, 2, l, OceanMonumentPieces.q.BASE_LIGHT, OceanMonumentPieces.q.BASE_LIGHT, false);
                }
