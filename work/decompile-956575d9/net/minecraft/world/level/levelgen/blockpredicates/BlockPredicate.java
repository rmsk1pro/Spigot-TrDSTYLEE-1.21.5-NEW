...
public interface BlockPredicate extends BiPredicate<GeneratorAccessSeed, BlockPosition> {
    ...
    static BlockPredicate unobstructed(BaseBlockPosition baseblockposition) {
        return new UnobstructedPredicate(baseblockposition);
    }

    static BlockPredicate unobstructed() {
        return unobstructed(BaseBlockPosition.ZERO);
    }
}
