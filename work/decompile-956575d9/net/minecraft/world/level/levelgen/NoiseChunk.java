...
public class NoiseChunk implements DensityFunction.a, DensityFunction.b {
    ...
    public NoiseChunk(int i, RandomState randomstate, int j, int k, NoiseSettings noisesettings, DensityFunctions.c densityfunctions_c, GeneratorSettingBase generatorsettingbase, Aquifer.a aquifer_a, Blender blender) {
        ...
        for (int l = 0; l <= this.noiseSizeXZ; ++l) {
            ...
            for (int k1 = 0; k1 <= this.noiseSizeXZ; ++k1) {
                ...
                Blender.a blender_a = blender.blendOffsetAndFactor(j1, i2);

                this.blendAlpha.values[l][k1] = blender_a.alpha();
                this.blendOffset.values[l][k1] = blender_a.blendingOffset();
            }
        }
        ...
        if (!generatorsettingbase.isAquifersEnabled()) {
            ...
            int j2 = SectionPosition.blockToSectionCoord(j);
            int k2 = SectionPosition.blockToSectionCoord(k);

            this.aquifer = Aquifer.create(this, new ChunkCoordIntPair(j2, k2), noiserouter1, randomstate.aquiferRandom(), noisesettings.minY(), noisesettings.height(), aquifer_a);
        }

        List<NoiseChunk.c> list = new ArrayList();
        ...
        list.add((NoiseChunk.c) (densityfunction_b) -> {
        ...
        this.blockStateRule = new MaterialRuleList((NoiseChunk.c[]) list.toArray(new NoiseChunk.c[0]));
    ...
    private void fillSlice(boolean flag, int i) {
        ...
        for (int j = 0; j < this.cellCountXZ + 1; ++j) {
            ...
            for (NoiseChunk.i noisechunk_i : this.interpolators) {
    ...
    public void selectCellYZ(int i, int j) {
        ...
        for (NoiseChunk.e noisechunk_e : this.cellCaches) {
    ...
    private class g implements DensityFunctions.m, NoiseChunk.h {
        ...
        g(final DensityFunction densityfunction, final boolean flag) {
    ...
    private class e implements DensityFunctions.m, NoiseChunk.h {
        ...
        e(final DensityFunction densityfunction) {
            this.noiseFiller = densityfunction;
    ...
    public class i implements DensityFunctions.m, NoiseChunk.h {
        ...
        i(final DensityFunction densityfunction) {
            this.noiseFiller = densityfunction;
    ...
    private class f implements DensityFunctions.m, NoiseChunk.h {
        ...
        f(final DensityFunction densityfunction) {
