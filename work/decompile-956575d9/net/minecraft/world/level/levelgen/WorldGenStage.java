...
public class WorldGenStage {
    ...
    public static enum Decoration implements INamable {
        ...
        public static final Codec<WorldGenStage.Decoration> CODEC = INamable.<WorldGenStage.Decoration>fromEnum(WorldGenStage.Decoration::values);
        private final String name;

        private Decoration(final String s) {
            this.name = s;
        }
