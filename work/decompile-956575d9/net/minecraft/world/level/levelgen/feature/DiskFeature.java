...
public class DiskFeature extends WorldGenerator<WorldGenFeatureCircleConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<WorldGenFeatureCircleConfiguration> featureplacecontext) {
        WorldGenFeatureCircleConfiguration worldgenfeaturecircleconfiguration = featureplacecontext.config();
        ...
        for (BlockPosition blockposition1 : BlockPosition.betweenClosed(blockposition.offset(-l, 0, -l), blockposition.offset(l, 0, l))) {
