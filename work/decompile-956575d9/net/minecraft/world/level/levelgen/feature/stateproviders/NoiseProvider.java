...
public class NoiseProvider extends NoiseBasedStateProvider {
    ...
    protected static <P extends NoiseProvider> Products.P4<RecordCodecBuilder.Mu<P>, Long, NoiseGeneratorNormal.a, Float, List<IBlockData>> noiseProviderCodec(RecordCodecBuilder.Instance<P> recordcodecbuilder_instance) {
        return noiseCodec(recordcodecbuilder_instance).and(ExtraCodecs.nonEmptyList(IBlockData.CODEC.listOf()).fieldOf("states").forGetter((noiseprovider) -> {
