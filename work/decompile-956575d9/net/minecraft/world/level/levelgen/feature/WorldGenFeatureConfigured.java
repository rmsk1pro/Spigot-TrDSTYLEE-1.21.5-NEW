...
public record WorldGenFeatureConfigured<FC extends WorldGenFeatureConfiguration, F extends WorldGenerator<FC>>(F feature, FC config) {
    ...
    public static final Codec<Holder<WorldGenFeatureConfigured<?, ?>>> CODEC = RegistryFileCodec.<Holder<WorldGenFeatureConfigured<?, ?>>>create(Registries.CONFIGURED_FEATURE, WorldGenFeatureConfigured.DIRECT_CODEC);
