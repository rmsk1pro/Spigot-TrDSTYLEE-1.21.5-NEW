...
public abstract class RootPlacer {
    ...
    protected static <P extends RootPlacer> Products.P3<RecordCodecBuilder.Mu<P>, IntProvider, WorldGenFeatureStateProvider, Optional<AboveRootPlacement>> rootPlacerParts(RecordCodecBuilder.Instance<P> recordcodecbuilder_instance) {
        return recordcodecbuilder_instance.group(IntProvider.CODEC.fieldOf("trunk_offset_y").forGetter((rootplacer) -> {
