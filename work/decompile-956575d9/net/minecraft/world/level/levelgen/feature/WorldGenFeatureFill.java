...
public class WorldGenFeatureFill extends WorldGenerator<WorldGenFeatureFillConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<WorldGenFeatureFillConfiguration> featureplacecontext) {
        ...
        WorldGenFeatureFillConfiguration worldgenfeaturefillconfiguration = featureplacecontext.config();
        ...
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                ...
                int i1 = generatoraccessseed.getMinY() + worldgenfeaturefillconfiguration.height;
