...
public class WorldGenEndGateway extends WorldGenerator<WorldGenEndGatewayConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<WorldGenEndGatewayConfiguration> featureplacecontext) {
        ...
        WorldGenEndGatewayConfiguration worldgenendgatewayconfiguration = featureplacecontext.config();

        for (BlockPosition blockposition1 : BlockPosition.betweenClosed(blockposition.offset(-1, -2, -1), blockposition.offset(1, 2, 1))) {
