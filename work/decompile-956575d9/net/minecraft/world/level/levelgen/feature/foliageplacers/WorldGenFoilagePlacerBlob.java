...
public class WorldGenFoilagePlacerBlob extends WorldGenFoilagePlacer {
    ...
    public static final MapCodec<WorldGenFoilagePlacerBlob> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return blobParts(instance).apply(instance, WorldGenFoilagePlacerBlob::new);
    });
    protected final int height;

    protected static <P extends WorldGenFoilagePlacerBlob> Products.P3<RecordCodecBuilder.Mu<P>, IntProvider, IntProvider, Integer> blobParts(RecordCodecBuilder.Instance<P> recordcodecbuilder_instance) {
        return foliagePlacerParts(recordcodecbuilder_instance).and(Codec.intRange(0, 16).fieldOf("height").forGetter((worldgenfoilageplacerblob) -> {
