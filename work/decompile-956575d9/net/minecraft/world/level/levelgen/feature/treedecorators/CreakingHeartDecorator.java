    ...
    public void place(WorldGenFeatureTree.a worldgenfeaturetree_a) {
        ...
        if (!((List) list).isEmpty()) {
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (!optional.isEmpty()) {
                    worldgenfeaturetree_a.setBlock((BlockPosition) optional.get(), (IBlockData) ((IBlockData) Blocks.CREAKING_HEART.defaultBlockState().setValue(CreakingHeartBlock.STATE, CreakingHeartState.DORMANT)).setValue(CreakingHeartBlock.NATURAL, true));
                }
            }
        }
    }
