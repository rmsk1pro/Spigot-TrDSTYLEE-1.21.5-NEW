...
public class WorldGenFeatureTreeAlterGround extends WorldGenFeatureTree {
    ...
    public static final MapCodec<WorldGenFeatureTreeAlterGround> CODEC = WorldGenFeatureStateProvider.CODEC.fieldOf("provider").xmap(WorldGenFeatureTreeAlterGround::new, (worldgenfeaturetreealterground) -> {
