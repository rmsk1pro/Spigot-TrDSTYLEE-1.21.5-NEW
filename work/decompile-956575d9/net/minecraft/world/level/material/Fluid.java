...
public final class Fluid extends IBlockDataHolder<FluidType, Fluid> {
    ...
    @Nullable
    public AxisAlignedBB getAABB(IBlockAccess iblockaccess, BlockPosition blockposition) {
        return this.getType().getAABB(this, iblockaccess, blockposition);
    }
    ...
    public void entityInside(World world, BlockPosition blockposition, Entity entity, InsideBlockEffectApplier insideblockeffectapplier) {
        this.getType().entityInside(world, blockposition, entity, insideblockeffectapplier);
    }
}
