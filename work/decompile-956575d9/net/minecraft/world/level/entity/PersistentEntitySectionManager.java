...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable {
    ...
    public PersistentEntitySectionManager(Class<T> oclass, LevelCallback<T> levelcallback, EntityPersistentStorage<T> entitypersistentstorage) {
        this.sectionStorage = new EntitySectionStorage<T>(oclass, this.chunkVisibility);
    ...
    public boolean isTicking(ChunkCoordIntPair chunkcoordintpair) {
    ...
    private LongSet getAllChunksToSave() {
        ...
        while (objectiterator.hasNext()) {
            Long2ObjectMap.Entry<PersistentEntitySectionManager.b> long2objectmap_entry = (Entry) objectiterator.next();

            if (long2objectmap_entry.getValue() == PersistentEntitySectionManager.b.LOADED) {
