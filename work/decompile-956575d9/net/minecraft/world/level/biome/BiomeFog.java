...
public class BiomeFog {
    ...
    public static final Codec<BiomeFog> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        }), Codec.INT.optionalFieldOf("dry_foliage_color").forGetter((biomefog) -> {
            return biomefog.dryFoliageColorOverride;
        ...
        }), WeightedList.codec(Music.CODEC).optionalFieldOf("music").forGetter((biomefog) -> {
            return biomefog.backgroundMusic;
        }), Codec.FLOAT.fieldOf("music_volume").orElse(1.0F).forGetter((biomefog) -> {
            return biomefog.backgroundMusicVolume;
    ...
    BiomeFog(int i, int j, int k, int l, Optional<Integer> optional, Optional<Integer> optional1, Optional<Integer> optional2, BiomeFog.GrassColor biomefog_grasscolor, Optional<BiomeParticles> optional3, Optional<Holder<SoundEffect>> optional4, Optional<CaveSoundSettings> optional5, Optional<CaveSound> optional6, Optional<WeightedList<Music>> optional7, float f) {
        this.fogColor = i;
        this.waterColor = j;
        this.waterFogColor = k;
        this.skyColor = l;
        this.foliageColorOverride = optional;
        this.dryFoliageColorOverride = optional1;
    ...
    public static class a {
        ...
        public BiomeFog.a dryFoliageColorOverride(int i) {
        ...
        public BiomeFog.a silenceAllBackgroundMusic() {
            return this.backgroundMusic(WeightedList.of()).backgroundMusicVolume(0.0F);
        }

        public BiomeFog.a backgroundMusic(WeightedList<Music> weightedlist) {
            this.backgroundMusic = Optional.of(weightedlist);
            return this;
        }

        public BiomeFog.a backgroundMusicVolume(float f) {
            this.backgroundMusicVolume = f;
            return this;
        }
    ...
    public static enum GrassColor implements INamable {
        ...
        public static final Codec<BiomeFog.GrassColor> CODEC = INamable.<BiomeFog.GrassColor>fromEnum(BiomeFog.GrassColor::values);

        public abstract int modifyColor(double d0, double d1, int i);

        GrassColor(final String s) {
            this.name = s;
        }
