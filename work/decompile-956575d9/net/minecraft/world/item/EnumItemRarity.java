...
public enum EnumItemRarity implements INamable {
    ...
    public static final Codec<EnumItemRarity> CODEC = INamable.<EnumItemRarity>fromValues(EnumItemRarity::values);
    public static final IntFunction<EnumItemRarity> BY_ID = ByIdMap.<EnumItemRarity>continuous((enumitemrarity) -> {
