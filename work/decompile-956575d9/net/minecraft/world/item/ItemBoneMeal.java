            ...
            if (!(world instanceof WorldServer)) {
                ...
                for (int i = 0; i < 128; ++i) {
                    ...
                    if (iblockdata.canSurvive(world, blockposition1)) {
                        ...
                        } else if (iblockdata1.is(Blocks.SEAGRASS) && ((IBlockFragilePlantElement) Blocks.SEAGRASS).isValidBonemealTarget(world, blockposition1, iblockdata1) && randomsource.nextInt(10) == 0) {
