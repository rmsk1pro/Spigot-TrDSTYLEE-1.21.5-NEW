...
public class ItemSplashPotion extends ItemPotionThrowable {
    ...
    public EnumInteractionResult use(World world, EntityHuman entityhuman, EnumHand enumhand) {
        world.playSound((Entity) null, entityhuman.getX(), entityhuman.getY(), entityhuman.getZ(), SoundEffects.SPLASH_POTION_THROW, SoundCategory.PLAYERS, 0.5F, 0.4F / (world.getRandom().nextFloat() * 0.4F + 0.8F));
    ...
    protected EntityPotion createPotion(World world, IPosition iposition, ItemStack itemstack) {
        return new ThrownSplashPotion(world, iposition.x(), iposition.y(), iposition.z(), itemstack);
    }
}
