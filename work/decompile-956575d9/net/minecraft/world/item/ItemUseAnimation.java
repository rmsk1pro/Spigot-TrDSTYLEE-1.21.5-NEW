...
public enum ItemUseAnimation implements INamable {
    ...
    private static final IntFunction<ItemUseAnimation> BY_ID = ByIdMap.<ItemUseAnimation>continuous(ItemUseAnimation::getId, values(), ByIdMap.a.ZERO);
    public static final Codec<ItemUseAnimation> CODEC = INamable.<ItemUseAnimation>fromEnum(ItemUseAnimation::values);
