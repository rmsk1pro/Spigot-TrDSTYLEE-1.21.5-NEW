...
public enum EnumColor implements INamable {
    ...
    private static final IntFunction<EnumColor> BY_ID = ByIdMap.<EnumColor>continuous(EnumColor::getId, values(), ByIdMap.a.ZERO);
    ...
    public static final INamable.a<EnumColor> CODEC = INamable.<EnumColor>fromEnum(EnumColor::values);
    public static final StreamCodec<ByteBuf, EnumColor> STREAM_CODEC = ByteBufCodecs.idMapper(EnumColor.BY_ID, EnumColor::getId);
    /** @deprecated */
    @Deprecated
    public static final Codec<EnumColor> LEGACY_ID_CODEC = Codec.BYTE.xmap(EnumColor::byId, (enumcolor) -> {
        return (byte) enumcolor.id;
    });
    ...
    public static EnumColor byName(String s, @Nullable EnumColor enumcolor) {
        EnumColor enumcolor1 = EnumColor.CODEC.byName(s);
