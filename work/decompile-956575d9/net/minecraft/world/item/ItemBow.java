        ...
        if (!(entityliving instanceof EntityHuman entityhuman)) {
            ...
            if (itemstack1.isEmpty()) {
                ...
                if ((double) f < 0.1D) {
                    ...
                    world.playSound((Entity) null, entityhuman.getX(), entityhuman.getY(), entityhuman.getZ(), SoundEffects.ARROW_SHOOT, SoundCategory.PLAYERS, 1.0F, 1.0F / (world.getRandom().nextFloat() * 0.4F + 1.2F) + f * 0.5F);
