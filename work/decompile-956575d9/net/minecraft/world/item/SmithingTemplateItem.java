...
public class SmithingTemplateItem extends Item {
    ...
    public void appendHoverText(ItemStack itemstack, Item.b item_b, TooltipDisplay tooltipdisplay, Consumer<IChatBaseComponent> consumer, TooltipFlag tooltipflag) {
        consumer.accept(SmithingTemplateItem.SMITHING_TEMPLATE_SUFFIX);
        consumer.accept(CommonComponents.EMPTY);
        consumer.accept(SmithingTemplateItem.APPLIES_TO_TITLE);
        consumer.accept(CommonComponents.space().append(this.appliesTo));
        consumer.accept(SmithingTemplateItem.INGREDIENTS_TITLE);
