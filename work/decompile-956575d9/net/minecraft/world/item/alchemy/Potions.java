...
public class Potions {
    ...
    public static final Holder<PotionRegistry> LEAPING = register("leaping", new PotionRegistry("leaping", new MobEffect[]{new MobEffect(MobEffects.JUMP_BOOST, 3600)}));
    public static final Holder<PotionRegistry> LONG_LEAPING = register("long_leaping", new PotionRegistry("leaping", new MobEffect[]{new MobEffect(MobEffects.JUMP_BOOST, 9600)}));
    public static final Holder<PotionRegistry> STRONG_LEAPING = register("strong_leaping", new PotionRegistry("leaping", new MobEffect[]{new MobEffect(MobEffects.JUMP_BOOST, 1800, 1)}));
    ...
    public static final Holder<PotionRegistry> SWIFTNESS = register("swiftness", new PotionRegistry("swiftness", new MobEffect[]{new MobEffect(MobEffects.SPEED, 3600)}));
    public static final Holder<PotionRegistry> LONG_SWIFTNESS = register("long_swiftness", new PotionRegistry("swiftness", new MobEffect[]{new MobEffect(MobEffects.SPEED, 9600)}));
    public static final Holder<PotionRegistry> STRONG_SWIFTNESS = register("strong_swiftness", new PotionRegistry("swiftness", new MobEffect[]{new MobEffect(MobEffects.SPEED, 1800, 1)}));
    public static final Holder<PotionRegistry> SLOWNESS = register("slowness", new PotionRegistry("slowness", new MobEffect[]{new MobEffect(MobEffects.SLOWNESS, 1800)}));
    public static final Holder<PotionRegistry> LONG_SLOWNESS = register("long_slowness", new PotionRegistry("slowness", new MobEffect[]{new MobEffect(MobEffects.SLOWNESS, 4800)}));
    public static final Holder<PotionRegistry> STRONG_SLOWNESS = register("strong_slowness", new PotionRegistry("slowness", new MobEffect[]{new MobEffect(MobEffects.SLOWNESS, 400, 3)}));
    public static final Holder<PotionRegistry> TURTLE_MASTER = register("turtle_master", new PotionRegistry("turtle_master", new MobEffect[]{new MobEffect(MobEffects.SLOWNESS, 400, 3), new MobEffect(MobEffects.RESISTANCE, 400, 2)}));
    public static final Holder<PotionRegistry> LONG_TURTLE_MASTER = register("long_turtle_master", new PotionRegistry("turtle_master", new MobEffect[]{new MobEffect(MobEffects.SLOWNESS, 800, 3), new MobEffect(MobEffects.RESISTANCE, 800, 2)}));
    public static final Holder<PotionRegistry> STRONG_TURTLE_MASTER = register("strong_turtle_master", new PotionRegistry("turtle_master", new MobEffect[]{new MobEffect(MobEffects.SLOWNESS, 400, 5), new MobEffect(MobEffects.RESISTANCE, 400, 3)}));
    ...
    public static final Holder<PotionRegistry> HEALING = register("healing", new PotionRegistry("healing", new MobEffect[]{new MobEffect(MobEffects.INSTANT_HEALTH, 1)}));
    public static final Holder<PotionRegistry> STRONG_HEALING = register("strong_healing", new PotionRegistry("healing", new MobEffect[]{new MobEffect(MobEffects.INSTANT_HEALTH, 1, 1)}));
    public static final Holder<PotionRegistry> HARMING = register("harming", new PotionRegistry("harming", new MobEffect[]{new MobEffect(MobEffects.INSTANT_DAMAGE, 1)}));
    public static final Holder<PotionRegistry> STRONG_HARMING = register("strong_harming", new PotionRegistry("harming", new MobEffect[]{new MobEffect(MobEffects.INSTANT_DAMAGE, 1, 1)}));
    ...
    public static final Holder<PotionRegistry> STRENGTH = register("strength", new PotionRegistry("strength", new MobEffect[]{new MobEffect(MobEffects.STRENGTH, 3600)}));
    public static final Holder<PotionRegistry> LONG_STRENGTH = register("long_strength", new PotionRegistry("strength", new MobEffect[]{new MobEffect(MobEffects.STRENGTH, 9600)}));
    public static final Holder<PotionRegistry> STRONG_STRENGTH = register("strong_strength", new PotionRegistry("strength", new MobEffect[]{new MobEffect(MobEffects.STRENGTH, 1800, 1)}));
