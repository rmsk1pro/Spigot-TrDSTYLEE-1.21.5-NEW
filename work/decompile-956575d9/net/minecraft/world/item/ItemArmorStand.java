        ...
        if (enumdirection == EnumDirection.DOWN) {
            ...
            if (world.noCollision((Entity) null, axisalignedbb) && world.getEntities((Entity) null, axisalignedbb).isEmpty()) {
                if (world instanceof WorldServer) {
                    ...
                    Consumer<EntityArmorStand> consumer = EntityTypes.<EntityArmorStand>createDefaultStackConfig(worldserver, itemstack, itemactioncontext.getPlayer());
                    EntityArmorStand entityarmorstand = EntityTypes.ARMOR_STAND.create(worldserver, consumer, blockposition, EntitySpawnReason.SPAWN_ITEM_USE, true, true);
