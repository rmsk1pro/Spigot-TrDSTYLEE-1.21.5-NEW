...
public class WindChargeItem extends Item implements ProjectileItem {
    ...
    public EnumInteractionResult use(World world, EntityHuman entityhuman, EnumHand enumhand) {
        ...
        world.playSound((Entity) null, entityhuman.getX(), entityhuman.getY(), entityhuman.getZ(), SoundEffects.WIND_CHARGE_THROW, SoundCategory.NEUTRAL, 0.5F, 0.4F / (world.getRandom().nextFloat() * 0.4F + 0.8F));
