    ...
    public EnumInteractionResult useOn(ItemActionContext itemactioncontext) {
        ...
        if (world.isClientSide) {
            ...
            if (tileentity instanceof Spawner) {
                ...
                EntityTypes<?> entitytypes = this.getType(world.registryAccess(), itemstack);
                ...
                EntityTypes<?> entitytypes1 = this.getType(world.registryAccess(), itemstack);

                if (entitytypes1.spawn((WorldServer) world, itemstack, itemactioncontext.getPlayer(), blockposition1, EntitySpawnReason.SPAWN_ITEM_USE, true, !Objects.equals(blockposition, blockposition1) && enumdirection == EnumDirection.UP) != null) {
                    itemstack.shrink(1);
                    world.gameEvent(itemactioncontext.getPlayer(), (Holder) GameEvent.ENTITY_PLACE, blockposition);
                }
        ...
        if (movingobjectpositionblock.getType() != MovingObjectPosition.EnumMovingObjectType.BLOCK) {
            ...
            if (!(world.getBlockState(blockposition).getBlock() instanceof BlockFluids)) {
                ...
                if (entity == null) {
                    ...
                    world.gameEvent(entityhuman, (Holder) GameEvent.ENTITY_PLACE, entity.position());
                    return EnumInteractionResult.SUCCESS;
                }
            } else {
