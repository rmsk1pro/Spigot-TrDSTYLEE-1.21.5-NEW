...
public interface SlotDisplay {
    ...
    public static class c implements SlotDisplay {
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, SlotDisplay.c> STREAM_CODEC = StreamCodec.<RegistryFriendlyByteBuf, SlotDisplay.c>unit(SlotDisplay.c.INSTANCE);
        public static final SlotDisplay.i<SlotDisplay.c> TYPE = new SlotDisplay.i<SlotDisplay.c>(SlotDisplay.c.MAP_CODEC, SlotDisplay.c.STREAM_CODEC);
    ...
    public static class a implements SlotDisplay {
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, SlotDisplay.a> STREAM_CODEC = StreamCodec.<RegistryFriendlyByteBuf, SlotDisplay.a>unit(SlotDisplay.a.INSTANCE);
        public static final SlotDisplay.i<SlotDisplay.a> TYPE = new SlotDisplay.i<SlotDisplay.a>(SlotDisplay.a.MAP_CODEC, SlotDisplay.a.STREAM_CODEC);
    ...
    public static record g(SlotDisplay base, SlotDisplay material, Holder<TrimPattern> pattern) implements SlotDisplay {

        public static final MapCodec<SlotDisplay.g> MAP_CODEC = RecordCodecBuilder.mapCodec((instance) -> {
            return instance.group(SlotDisplay.CODEC.fieldOf("base").forGetter(SlotDisplay.g::base), SlotDisplay.CODEC.fieldOf("material").forGetter(SlotDisplay.g::material), TrimPattern.CODEC.fieldOf("pattern").forGetter(SlotDisplay.g::pattern)).apply(instance, SlotDisplay.g::new);
        });
        public static final StreamCodec<RegistryFriendlyByteBuf, SlotDisplay.g> STREAM_CODEC = StreamCodec.composite(SlotDisplay.STREAM_CODEC, SlotDisplay.g::base, SlotDisplay.STREAM_CODEC, SlotDisplay.g::material, TrimPattern.STREAM_CODEC, SlotDisplay.g::pattern, SlotDisplay.g::new);
        public static final SlotDisplay.i<SlotDisplay.g> TYPE = new SlotDisplay.i<SlotDisplay.g>(SlotDisplay.g.MAP_CODEC, SlotDisplay.g.STREAM_CODEC);
            ...
            if (displaycontentsfactory instanceof DisplayContentsFactory.b<T> displaycontentsfactory_b) {
                ...
                if (holderlookup_a != null) {
                    ...
                    Stream stream = Stream.generate(() -> {
                        ...
                        return SmithingTrimRecipe.applyTrim(holderlookup_a, itemstack, itemstack1, this.pattern);
    ...
    public static record d(Holder<Item> item) implements SlotDisplay {
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, SlotDisplay.d> STREAM_CODEC = StreamCodec.composite(Item.STREAM_CODEC, SlotDisplay.d::item, SlotDisplay.d::new);
        public static final SlotDisplay.i<SlotDisplay.d> TYPE = new SlotDisplay.i<SlotDisplay.d>(SlotDisplay.d.MAP_CODEC, SlotDisplay.d.STREAM_CODEC);
    ...
    public static record f(ItemStack stack) implements SlotDisplay {
        ...
        public static final SlotDisplay.i<SlotDisplay.f> TYPE = new SlotDisplay.i<SlotDisplay.f>(SlotDisplay.f.MAP_CODEC, SlotDisplay.f.STREAM_CODEC);
    ...
    public static record h(TagKey<Item> tag) implements SlotDisplay {
        ...
        public static final SlotDisplay.i<SlotDisplay.h> TYPE = new SlotDisplay.i<SlotDisplay.h>(SlotDisplay.h.MAP_CODEC, SlotDisplay.h.STREAM_CODEC);
    ...
    public static record b(List<SlotDisplay> contents) implements SlotDisplay {
        ...
        public static final SlotDisplay.i<SlotDisplay.b> TYPE = new SlotDisplay.i<SlotDisplay.b>(SlotDisplay.b.MAP_CODEC, SlotDisplay.b.STREAM_CODEC);
    ...
    public static record j(SlotDisplay input, SlotDisplay remainder) implements SlotDisplay {
        ...
        public static final SlotDisplay.i<SlotDisplay.j> TYPE = new SlotDisplay.i<SlotDisplay.j>(SlotDisplay.j.MAP_CODEC, SlotDisplay.j.STREAM_CODEC);
        ...
        public <T> Stream<T> resolve(ContextMap contextmap, DisplayContentsFactory<T> displaycontentsfactory) {
            if (displaycontentsfactory instanceof DisplayContentsFactory.a<T> displaycontentsfactory_a) {
                ...
                return this.input.<T>resolve(contextmap, displaycontentsfactory);
            }
        }
