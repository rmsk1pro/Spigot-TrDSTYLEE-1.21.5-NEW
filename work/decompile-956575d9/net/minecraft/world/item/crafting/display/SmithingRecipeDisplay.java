...
public record SmithingRecipeDisplay(SlotDisplay template, SlotDisplay base, SlotDisplay addition, SlotDisplay result, SlotDisplay craftingStation) implements RecipeDisplay {
    ...
    public static final RecipeDisplay.a<SmithingRecipeDisplay> TYPE = new RecipeDisplay.a<SmithingRecipeDisplay>(SmithingRecipeDisplay.MAP_CODEC, SmithingRecipeDisplay.STREAM_CODEC);

    @Override
    public RecipeDisplay.a<SmithingRecipeDisplay> type() {
