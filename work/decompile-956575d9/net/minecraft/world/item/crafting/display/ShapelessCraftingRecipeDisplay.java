...
public record ShapelessCraftingRecipeDisplay(List<SlotDisplay> ingredients, SlotDisplay result, SlotDisplay craftingStation) implements RecipeDisplay {
    ...
    public static final RecipeDisplay.a<ShapelessCraftingRecipeDisplay> TYPE = new RecipeDisplay.a<ShapelessCraftingRecipeDisplay>(ShapelessCraftingRecipeDisplay.MAP_CODEC, ShapelessCraftingRecipeDisplay.STREAM_CODEC);
