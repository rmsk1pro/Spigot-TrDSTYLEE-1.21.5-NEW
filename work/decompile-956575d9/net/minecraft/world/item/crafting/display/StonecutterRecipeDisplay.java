...
public record StonecutterRecipeDisplay(SlotDisplay input, SlotDisplay result, SlotDisplay craftingStation) implements RecipeDisplay {
    ...
    public static final RecipeDisplay.a<StonecutterRecipeDisplay> TYPE = new RecipeDisplay.a<StonecutterRecipeDisplay>(StonecutterRecipeDisplay.MAP_CODEC, StonecutterRecipeDisplay.STREAM_CODEC);
