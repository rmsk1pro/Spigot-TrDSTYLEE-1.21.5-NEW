...
public record ShapedCraftingRecipeDisplay(int width, int height, List<SlotDisplay> ingredients, SlotDisplay result, SlotDisplay craftingStation) implements RecipeDisplay {
    ...
    public static final RecipeDisplay.a<ShapedCraftingRecipeDisplay> TYPE = new RecipeDisplay.a<ShapedCraftingRecipeDisplay>(ShapedCraftingRecipeDisplay.MAP_CODEC, ShapedCraftingRecipeDisplay.STREAM_CODEC);
