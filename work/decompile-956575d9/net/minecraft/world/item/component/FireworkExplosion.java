...
public record FireworkExplosion(FireworkExplosion.a shape, IntList colors, IntList fadeColors, boolean hasTrail, boolean hasTwinkle) implements TooltipProvider {
    ...
    public static enum a implements INamable {
        ...
        private static final IntFunction<FireworkExplosion.a> BY_ID = ByIdMap.<FireworkExplosion.a>continuous(FireworkExplosion.a::getId, values(), ByIdMap.a.ZERO);
        ...
        public static final Codec<FireworkExplosion.a> CODEC = INamable.<FireworkExplosion.a>fromValues(FireworkExplosion.a::values);
