...
public class Consumables {
    ...
    public static final Consumable ENCHANTED_GOLDEN_APPLE = defaultFood().onConsume(new ApplyStatusEffectsConsumeEffect(List.of(new MobEffect(MobEffects.REGENERATION, 400, 1), new MobEffect(MobEffects.RESISTANCE, 6000, 0), new MobEffect(MobEffects.FIRE_RESISTANCE, 6000, 0), new MobEffect(MobEffects.ABSORPTION, 2400, 3)))).build();
    ...
    public static final Consumable PUFFERFISH = defaultFood().onConsume(new ApplyStatusEffectsConsumeEffect(List.of(new MobEffect(MobEffects.POISON, 1200, 1), new MobEffect(MobEffects.HUNGER, 300, 2), new MobEffect(MobEffects.NAUSEA, 300, 0)))).build();
