...
public class Items {
    ...
    public static final Item LIGHT = registerBlock(Blocks.LIGHT, (item_info) -> {
        return item_info.rarity(EnumItemRarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(LightBlock.LEVEL, 15));
    });
    ...
    public static final Item REDSTONE = registerItem("redstone", createBlockItemWithCustomItemName(Blocks.REDSTONE_WIRE), (new Item.Info()).trimMaterial(TrimMaterials.REDSTONE));
    ...
    public static final Item SADDLE = registerItem("saddle", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.saddle()));
    ...
    public static final Item TEST_BLOCK = registerBlock(Blocks.TEST_BLOCK, ItemRestricted::new, (new Item.Info()).rarity(EnumItemRarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(TestBlock.MODE, TestBlockMode.START)));
    public static final Item TEST_INSTANCE_BLOCK = registerBlock(Blocks.TEST_INSTANCE_BLOCK, ItemRestricted::new, (new Item.Info()).rarity(EnumItemRarity.EPIC));
    public static final Item TURTLE_HELMET = registerItem("turtle_helmet", (new Item.Info()).humanoidArmor(ArmorMaterials.TURTLE_SCUTE, ArmorType.HELMET));
    ...
    public static final Item WOLF_ARMOR = registerItem("wolf_armor", (new Item.Info()).wolfArmor(ArmorMaterials.ARMADILLO_SCUTE));
    ...
    public static final Item DIAMOND = registerItem("diamond", (new Item.Info()).trimMaterial(TrimMaterials.DIAMOND));
    public static final Item EMERALD = registerItem("emerald", (new Item.Info()).trimMaterial(TrimMaterials.EMERALD));
    public static final Item LAPIS_LAZULI = registerItem("lapis_lazuli", (new Item.Info()).trimMaterial(TrimMaterials.LAPIS));
    public static final Item QUARTZ = registerItem("quartz", (new Item.Info()).trimMaterial(TrimMaterials.QUARTZ));
    public static final Item AMETHYST_SHARD = registerItem("amethyst_shard", (new Item.Info()).trimMaterial(TrimMaterials.AMETHYST));
    public static final Item RAW_IRON = registerItem("raw_iron");
    public static final Item IRON_INGOT = registerItem("iron_ingot", (new Item.Info()).trimMaterial(TrimMaterials.IRON));
    public static final Item RAW_COPPER = registerItem("raw_copper");
    public static final Item COPPER_INGOT = registerItem("copper_ingot", (new Item.Info()).trimMaterial(TrimMaterials.COPPER));
    public static final Item RAW_GOLD = registerItem("raw_gold");
    public static final Item GOLD_INGOT = registerItem("gold_ingot", (new Item.Info()).trimMaterial(TrimMaterials.GOLD));
    public static final Item NETHERITE_INGOT = registerItem("netherite_ingot", (new Item.Info()).fireResistant().trimMaterial(TrimMaterials.NETHERITE));
    public static final Item NETHERITE_SCRAP = registerItem("netherite_scrap", (new Item.Info()).fireResistant());
    public static final Item WOODEN_SWORD = registerItem("wooden_sword", (new Item.Info()).sword(ToolMaterial.WOOD, 3.0F, -2.4F));
    ...
    public static final Item WOODEN_PICKAXE = registerItem("wooden_pickaxe", (new Item.Info()).pickaxe(ToolMaterial.WOOD, 1.0F, -2.8F));
    ...
    public static final Item STONE_SWORD = registerItem("stone_sword", (new Item.Info()).sword(ToolMaterial.STONE, 3.0F, -2.4F));
    ...
    public static final Item STONE_PICKAXE = registerItem("stone_pickaxe", (new Item.Info()).pickaxe(ToolMaterial.STONE, 1.0F, -2.8F));
    ...
    public static final Item GOLDEN_SWORD = registerItem("golden_sword", (new Item.Info()).sword(ToolMaterial.GOLD, 3.0F, -2.4F));
    ...
    public static final Item GOLDEN_PICKAXE = registerItem("golden_pickaxe", (new Item.Info()).pickaxe(ToolMaterial.GOLD, 1.0F, -2.8F));
    ...
    public static final Item IRON_SWORD = registerItem("iron_sword", (new Item.Info()).sword(ToolMaterial.IRON, 3.0F, -2.4F));
    ...
    public static final Item IRON_PICKAXE = registerItem("iron_pickaxe", (new Item.Info()).pickaxe(ToolMaterial.IRON, 1.0F, -2.8F));
    ...
    public static final Item DIAMOND_SWORD = registerItem("diamond_sword", (new Item.Info()).sword(ToolMaterial.DIAMOND, 3.0F, -2.4F));
    ...
    public static final Item DIAMOND_PICKAXE = registerItem("diamond_pickaxe", (new Item.Info()).pickaxe(ToolMaterial.DIAMOND, 1.0F, -2.8F));
    ...
    public static final Item NETHERITE_SWORD = registerItem("netherite_sword", (new Item.Info()).sword(ToolMaterial.NETHERITE, 3.0F, -2.4F).fireResistant());
    ...
    public static final Item NETHERITE_PICKAXE = registerItem("netherite_pickaxe", (new Item.Info()).pickaxe(ToolMaterial.NETHERITE, 1.0F, -2.8F).fireResistant());
    ...
    public static final Item LEATHER_HELMET = registerItem("leather_helmet", (new Item.Info()).humanoidArmor(ArmorMaterials.LEATHER, ArmorType.HELMET));
    public static final Item LEATHER_CHESTPLATE = registerItem("leather_chestplate", (new Item.Info()).humanoidArmor(ArmorMaterials.LEATHER, ArmorType.CHESTPLATE));
    public static final Item LEATHER_LEGGINGS = registerItem("leather_leggings", (new Item.Info()).humanoidArmor(ArmorMaterials.LEATHER, ArmorType.LEGGINGS));
    public static final Item LEATHER_BOOTS = registerItem("leather_boots", (new Item.Info()).humanoidArmor(ArmorMaterials.LEATHER, ArmorType.BOOTS));
    public static final Item CHAINMAIL_HELMET = registerItem("chainmail_helmet", (new Item.Info()).humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.HELMET).rarity(EnumItemRarity.UNCOMMON));
    public static final Item CHAINMAIL_CHESTPLATE = registerItem("chainmail_chestplate", (new Item.Info()).humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.CHESTPLATE).rarity(EnumItemRarity.UNCOMMON));
    public static final Item CHAINMAIL_LEGGINGS = registerItem("chainmail_leggings", (new Item.Info()).humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.LEGGINGS).rarity(EnumItemRarity.UNCOMMON));
    public static final Item CHAINMAIL_BOOTS = registerItem("chainmail_boots", (new Item.Info()).humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.BOOTS).rarity(EnumItemRarity.UNCOMMON));
    public static final Item IRON_HELMET = registerItem("iron_helmet", (new Item.Info()).humanoidArmor(ArmorMaterials.IRON, ArmorType.HELMET));
    public static final Item IRON_CHESTPLATE = registerItem("iron_chestplate", (new Item.Info()).humanoidArmor(ArmorMaterials.IRON, ArmorType.CHESTPLATE));
    public static final Item IRON_LEGGINGS = registerItem("iron_leggings", (new Item.Info()).humanoidArmor(ArmorMaterials.IRON, ArmorType.LEGGINGS));
    public static final Item IRON_BOOTS = registerItem("iron_boots", (new Item.Info()).humanoidArmor(ArmorMaterials.IRON, ArmorType.BOOTS));
    public static final Item DIAMOND_HELMET = registerItem("diamond_helmet", (new Item.Info()).humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.HELMET));
    public static final Item DIAMOND_CHESTPLATE = registerItem("diamond_chestplate", (new Item.Info()).humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.CHESTPLATE));
    public static final Item DIAMOND_LEGGINGS = registerItem("diamond_leggings", (new Item.Info()).humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.LEGGINGS));
    public static final Item DIAMOND_BOOTS = registerItem("diamond_boots", (new Item.Info()).humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.BOOTS));
    public static final Item GOLDEN_HELMET = registerItem("golden_helmet", (new Item.Info()).humanoidArmor(ArmorMaterials.GOLD, ArmorType.HELMET));
    public static final Item GOLDEN_CHESTPLATE = registerItem("golden_chestplate", (new Item.Info()).humanoidArmor(ArmorMaterials.GOLD, ArmorType.CHESTPLATE));
    public static final Item GOLDEN_LEGGINGS = registerItem("golden_leggings", (new Item.Info()).humanoidArmor(ArmorMaterials.GOLD, ArmorType.LEGGINGS));
    public static final Item GOLDEN_BOOTS = registerItem("golden_boots", (new Item.Info()).humanoidArmor(ArmorMaterials.GOLD, ArmorType.BOOTS));
    public static final Item NETHERITE_HELMET = registerItem("netherite_helmet", (new Item.Info()).humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.HELMET).fireResistant());
    public static final Item NETHERITE_CHESTPLATE = registerItem("netherite_chestplate", (new Item.Info()).humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.CHESTPLATE).fireResistant());
    public static final Item NETHERITE_LEGGINGS = registerItem("netherite_leggings", (new Item.Info()).humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.LEGGINGS).fireResistant());
    public static final Item NETHERITE_BOOTS = registerItem("netherite_boots", (new Item.Info()).humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.BOOTS).fireResistant());
    ...
    public static final Item EGG = registerItem("egg", ItemEgg::new, (new Item.Info()).stacksTo(16).component(DataComponents.CHICKEN_VARIANT, new EitherHolder(ChickenVariants.TEMPERATE)));
    public static final Item BLUE_EGG = registerItem("blue_egg", ItemEgg::new, (new Item.Info()).stacksTo(16).component(DataComponents.CHICKEN_VARIANT, new EitherHolder(ChickenVariants.COLD)));
    public static final Item BROWN_EGG = registerItem("brown_egg", ItemEgg::new, (new Item.Info()).stacksTo(16).component(DataComponents.CHICKEN_VARIANT, new EitherHolder(ChickenVariants.WARM)));
    ...
    public static final Item MACE = registerItem("mace", MaceItem::new, (new Item.Info()).rarity(EnumItemRarity.EPIC).durability(500).component(DataComponents.TOOL, MaceItem.createToolProperties()).repairable(Items.BREEZE_ROD).attributes(MaceItem.createAttributes()).enchantable(15).component(DataComponents.WEAPON, new Weapon(1)));
    ...
    public static final Item RESIN_BRICK = registerItem("resin_brick", (new Item.Info()).trimMaterial(TrimMaterials.RESIN));
    ...
    public static final Item IRON_HORSE_ARMOR = registerItem("iron_horse_armor", (new Item.Info()).horseArmor(ArmorMaterials.IRON));
    public static final Item GOLDEN_HORSE_ARMOR = registerItem("golden_horse_armor", (new Item.Info()).horseArmor(ArmorMaterials.GOLD));
    public static final Item DIAMOND_HORSE_ARMOR = registerItem("diamond_horse_armor", (new Item.Info()).horseArmor(ArmorMaterials.DIAMOND));
    public static final Item LEATHER_HORSE_ARMOR = registerItem("leather_horse_armor", (new Item.Info()).horseArmor(ArmorMaterials.LEATHER));
    ...
    public static final Item TIPPED_ARROW = registerItem("tipped_arrow", ItemTippedArrow::new, (new Item.Info()).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.POTION_DURATION_SCALE, 0.125F));
    public static final Item LINGERING_POTION = registerItem("lingering_potion", ItemLingeringPotion::new, (new Item.Info()).stacksTo(1).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.POTION_DURATION_SCALE, 0.25F));
    public static final Item SHIELD = registerItem("shield", ItemShield::new, (new Item.Info()).durability(336).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY).repairable(TagsItem.WOODEN_TOOL_MATERIALS).equippableUnswappable(EnumItemSlot.OFFHAND).component(DataComponents.BLOCKS_ATTACKS, new BlocksAttacks(0.25F, 1.0F, List.of(new BlocksAttacks.a(90.0F, Optional.empty(), 0.0F, 1.0F)), new BlocksAttacks.b(3.0F, 1.0F, 1.0F), Optional.of(DamageTypeTags.BYPASSES_SHIELD), Optional.of(SoundEffects.SHIELD_BLOCK), Optional.of(SoundEffects.SHIELD_BREAK))).component(DataComponents.BREAK_SOUND, SoundEffects.SHIELD_BREAK));
    ...
    public static final Item TRIDENT = registerItem("trident", ItemTrident::new, (new Item.Info()).rarity(EnumItemRarity.RARE).durability(250).attributes(ItemTrident.createAttributes()).component(DataComponents.TOOL, ItemTrident.createToolProperties()).enchantable(1).component(DataComponents.WEAPON, new Weapon(1)));
    ...
    public static final Item FLOWER_BANNER_PATTERN = registerItem("flower_banner_pattern", (new Item.Info()).stacksTo(1).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_FLOWER));
    public static final Item CREEPER_BANNER_PATTERN = registerItem("creeper_banner_pattern", (new Item.Info()).stacksTo(1).rarity(EnumItemRarity.UNCOMMON).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_CREEPER));
    public static final Item SKULL_BANNER_PATTERN = registerItem("skull_banner_pattern", (new Item.Info()).stacksTo(1).rarity(EnumItemRarity.RARE).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_SKULL));
    public static final Item MOJANG_BANNER_PATTERN = registerItem("mojang_banner_pattern", (new Item.Info()).stacksTo(1).rarity(EnumItemRarity.RARE).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_MOJANG));
    public static final Item GLOBE_BANNER_PATTERN = registerItem("globe_banner_pattern", (new Item.Info()).stacksTo(1).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_GLOBE));
    public static final Item PIGLIN_BANNER_PATTERN = registerItem("piglin_banner_pattern", (new Item.Info()).stacksTo(1).rarity(EnumItemRarity.UNCOMMON).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_PIGLIN));
    public static final Item FLOW_BANNER_PATTERN = registerItem("flow_banner_pattern", (new Item.Info()).stacksTo(1).rarity(EnumItemRarity.RARE).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_FLOW));
    public static final Item GUSTER_BANNER_PATTERN = registerItem("guster_banner_pattern", (new Item.Info()).stacksTo(1).rarity(EnumItemRarity.RARE).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_GUSTER));
    public static final Item FIELD_MASONED_BANNER_PATTERN = registerItem("field_masoned_banner_pattern", (new Item.Info()).stacksTo(1).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_FIELD_MASONED));
    public static final Item BORDURE_INDENTED_BANNER_PATTERN = registerItem("bordure_indented_banner_pattern", (new Item.Info()).stacksTo(1).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_BORDURE_INDENTED));
    public static final Item GOAT_HORN = registerItem("goat_horn", InstrumentItem::new, (new Item.Info()).rarity(EnumItemRarity.UNCOMMON).stacksTo(1).component(DataComponents.INSTRUMENT, new InstrumentComponent(Instruments.PONDER_GOAT_HORN)));
    ...
    public static final Item BEE_NEST = registerBlock(Blocks.BEE_NEST, (new Item.Info()).component(DataComponents.BEES, Bees.EMPTY).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(BlockBeehive.HONEY_LEVEL, 0)));
    public static final Item BEEHIVE = registerBlock(Blocks.BEEHIVE, (new Item.Info()).component(DataComponents.BEES, Bees.EMPTY).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(BlockBeehive.HONEY_LEVEL, 0)));
