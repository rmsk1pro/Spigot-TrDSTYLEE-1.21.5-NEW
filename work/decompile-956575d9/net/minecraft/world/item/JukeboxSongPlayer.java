...
public class JukeboxSongPlayer {
    ...
    public void play(GeneratorAccess generatoraccess, Holder<JukeboxSong> holder) {
        ...
        int i = generatoraccess.registryAccess().lookupOrThrow(Registries.JUKEBOX_SONG).getId(this.song.value());

        generatoraccess.levelEvent((Entity) null, 1010, this.blockPos, i);
    ...
    public void stop(GeneratorAccess generatoraccess, @Nullable IBlockData iblockdata) {
        if (this.song != null) {
            this.song = null;
            this.ticksSinceSongStarted = 0L;
            generatoraccess.gameEvent(GameEvent.JUKEBOX_STOP_PLAY, this.blockPos, GameEvent.a.of(iblockdata));
        ...
        if (this.song != null) {
            if (((JukeboxSong) this.song.value()).hasFinished(this.ticksSinceSongStarted)) {
                ...
                if (this.shouldEmitJukeboxPlayingEvent()) {
                    generatoraccess.gameEvent(GameEvent.JUKEBOX_PLAY, this.blockPos, GameEvent.a.of(iblockdata));
    ...
    private static void spawnMusicParticles(GeneratorAccess generatoraccess, BlockPosition blockposition) {
        if (generatoraccess instanceof WorldServer worldserver) {
            Vec3D vec3d = Vec3D.atBottomCenterOf(blockposition).add(0.0D, (double) 1.2F, 0.0D);
