...
public enum ItemDisplayContext implements INamable {
    ...
    public static final Codec<ItemDisplayContext> CODEC = INamable.<ItemDisplayContext>fromEnum(ItemDisplayContext::values);
    public static final IntFunction<ItemDisplayContext> BY_ID = ByIdMap.<ItemDisplayContext>continuous(ItemDisplayContext::getId, values(), ByIdMap.a.ZERO);
    private final byte id;
    private final String name;

    private ItemDisplayContext(final int i, final String s) {
        this.name = s;
        this.id = (byte) i;
    }
