...
public abstract class VoxelShapeDiscrete {
    ...
    public VoxelShapeDiscrete rotate(PointGroupO pointgroupo) {
        if (pointgroupo == PointGroupO.IDENTITY) {
            ...
            int i = enumdirection_enumaxis.choose(this.xSize, this.ySize, this.zSize);
            int j = enumdirection_enumaxis1.choose(this.xSize, this.ySize, this.zSize);
            int k = enumdirection_enumaxis2.choose(this.xSize, this.ySize, this.zSize);
            ...
            VoxelShapeDiscrete voxelshapediscrete = new VoxelShapeBitSet(i, j, k);

            for (int l = 0; l < this.xSize; ++l) {
                for (int i1 = 0; i1 < this.ySize; ++i1) {
                    for (int j1 = 0; j1 < this.zSize; ++j1) {
                        if (this.isFull(l, i1, j1)) {
                            int k1 = enumdirection_enumaxis.choose(l, i1, j1);
                            int l1 = enumdirection_enumaxis1.choose(l, i1, j1);
                            int i2 = enumdirection_enumaxis2.choose(l, i1, j1);

                            voxelshapediscrete.fill(flag3 ? i - 1 - k1 : k1, flag4 ? j - 1 - l1 : l1, flag5 ? k - 1 - i2 : i2);
                        }
                    }
                }
            }
    ...
    public boolean isEmpty() {
        for (EnumDirection.EnumAxis enumdirection_enumaxis : VoxelShapeDiscrete.AXIS_VALUES) {
