...
public class SlotRanges {
    ...
    private static final List<SlotRange> SLOTS = (List) SystemUtils.make(new ArrayList(), (arraylist) -> {
        ...
        addSingleSlot(arraylist, "saddle", EnumItemSlot.SADDLE.getIndex(106));
    ...
    public static final Codec<SlotRange> CODEC = INamable.<SlotRange>fromValues(() -> {
